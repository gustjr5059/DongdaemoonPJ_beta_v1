...
// 로그인 함수
  ...
  Widget build(BuildContext context) {
    ...
    // ----- Positioned, Align에 의해 화면 스크롤 시, 배경 제외한 빈 화면이 나오는 이슈 해결한 이전 로직 시작 부분
    // ---  갤럭시 Z플립 화면 분할 케이스(화면 세로 길이가 줄어드는 형태) 고려한 사이즈 시작 부분
    // 비율을 기반으로 동적으로 크기와 위치 설정
    ...
    // 화면 제목 부분 수치
    final double screenTitleTop = 70; // 위쪽 여백 비율
    final double screenLoginText1FontSize = 20;
    final double screenTitleTextFontSize = 20;

    // 화면 서브제목 부분 수치
    final double screenSubTitleTop = 30; // 위쪽 여백 비율
    final double screenSubTitleTextFontSize = 16;
    ...
    final double insertFieldX = screenSize.width * (10 / referenceWidth);
    final double insertFieldY = 5;
    final double emailFieldTop = 30; // 위쪽 여백 비율
    final double passwordFieldTop = 5; // 위쪽 여백 비율

    // 자동로그인 부분 수치
    final double autoLoginCheckboxLeft = 56; // 왼쪽 여백 비율
    final double autoLoginCheckboxWidth = 16; // 너비 비율
    final double autoLoginCheckboxHeight = 16; // 높이 비율
    final double autoLoginTextLeft = 5; // 왼쪽 여백 비율
    final double autoLoginTextTop = 10; // 위쪽 여백 비율
    final double autoLoginCheckboxTextFontSize = 12;

    // 로그인 개인정보 처리방침 안내 텍스트1 부분 수치
    final double guidelineText1Top = 20; // 위쪽 여백 비율
    final double guidelineText1FontSize = 10; // 텍스트 크기

    // 로그인 개인정보 처리방침 안내 텍스트2 부분 수치
    final double guidelineText2Top = 10; // 위쪽 여백 비율
    final double guidelineText2FontSize = 10; // 텍스트 크기

    // 로그인 버튼 부분 수치
    final double loginBtnTop = 30; // 위쪽 여백 비율
    final double loginBtnWidth =
        screenSize.width * (313 / referenceWidth); // 너비 비율
    final double loginBtnHeight = 42; // 높이 비율
    final double loginBtnTextFontSize = 16;
    ...
    // 로그인 에러 메세지 바 부분 수치
    final double loginErrorMessageBarTop = 10; // 위쪽 여백 비율
    final double loginErrorMessageBarWidth =
        screenSize.width * (313 / referenceWidth); // 너비 비율
    final double loginErrorMessageBarHeight = 24; // 높이 비율
    final double loginErrorMessageBarTextFontSize = 12;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: emailFieldTop),

                    // 이메일 입력 필드
                    // 상태바, 하단 제스처 영역 침범을 방지
                    Center(
                      child: Container(
                        width: insertFieldWidth,
                        height: insertFieldHeight,
                    ...
                    SizedBox(height: passwordFieldTop),
                    ...
                    SizedBox(height: autoLoginTextTop),

                    Row(
                      children: [
                        SizedBox(width: autoLoginCheckboxLeft),
                        // 자동 로그인 체크박스
                        // 상태바, 하단 제스처 영역 침범을 방지
                        Container(
                          width: autoLoginCheckboxWidth, // Figma에서 지정한 너비
                        ...
                        SizedBox(width: autoLoginTextLeft),
                    ...
                    SizedBox(height: loginErrorMessageBarTop),
                    ...
                    SizedBox(height: guidelineText2Top),
    ...
    // ----- Positioned, Align에 의해 화면 스크롤 시, 배경 제외한 빈 화면이 나오는 이슈 해결한 로직 끝 부분
  }
}
