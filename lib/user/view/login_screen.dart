...
// 로그인 함수
  ...
  Widget build(BuildContext context) {
    ...
    // final double circleImageTop = screenSize.height * (250 / referenceHeight);
    // final double circleImageWidth = screenSize.width * (100 / referenceWidth);
    ...
    // final double personImageLeft = screenSize.width * (0 / referenceWidth);
    // final double personImageTop = screenSize.height * (640 / referenceHeight);
    ...
    //     screenSize.height * (590 / referenceHeight); // 위쪽 여백 비율
    ...
    //     screenSize.height * (620 / referenceHeight); // 위쪽 여백 비율
    ...
    final double emailFieldTop = 300; // 위쪽 여백 비율
    final double passwordFieldTop = 350; // 위쪽 여백 비율

    // 자동로그인 부분 수치
    final double autoLoginCheckboxLeft =
        screenSize.width * (56 / referenceWidth); // 왼쪽 여백 비율
    final double autoLoginCheckboxTop = 404; // 위쪽 여백 비율
    final double autoLoginCheckboxWidth = 16; // 너비 비율
    final double autoLoginCheckboxHeight = 16; // 높이 비율
    final double autoLoginTextLeft =
        screenSize.width * (80 / referenceWidth); // 왼쪽 여백 비율
    final double autoLoginTextTop = 406; // 위쪽 여백 비율
    final double autoLoginCheckboxTextFontSize = 12;

    // 로그인 개인정보 처리방침 안내 텍스트1 부분 수치
    final double guidelineText1Top = 550; // 위쪽 여백 비율
    final double guidelineText1FontSize = 13; // 텍스트 크기

    // 로그인 개인정보 처리방침 안내 텍스트2 부분 수치
    final double guidelineText2Top = 580; // 위쪽 여백 비율
    final double guidelineText2FontSize = 13; // 텍스트 크기

    // 로그인 버튼 부분 수치
    final double loginBtnTop = 457; // 위쪽 여백 비율
    final double loginBtnWidth =
        screenSize.width * (313 / referenceWidth); // 너비 비율
    ...
    final double loginErrorMessageBarLeft =
        screenSize.width * (40 / referenceWidth); // 왼쪽 여백 비율
    final double loginErrorMessageBarTop = 426; // 위쪽 여백 비율
    final double loginErrorMessageBarWidth =
        screenSize.width * (313 / referenceWidth); // 너비 비율
            ...
            SliverFillRemaining(
              ...
              child: Stack(
                children: [
                  ...
                  //     child: Image.asset(
                  //       'asset/img/misc/login_image/login_title_image1.png',
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Theme.of(context)
                                .scaffoldBackgroundColor, // Figma에서 지정한 투명도 반영
                            borderRadius:
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Theme.of(context)
                                .scaffoldBackgroundColor, // Figma에서 지정한 색상
                          ...
                          child: Checkbox(
                            ...
                            checkColor: Theme.of(context)
                                .scaffoldBackgroundColor, // 체크 표시 색상
                          ),
                        ),
                      ),
                    ),
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: GestureDetector(
                          ...
                          onTap: () async {
                            const url =
                                'https://pf.kakao.com/_xjVrbG'; // 열려는 URL
                            try {
