...
class _ProfileMainScreenState extends ConsumerState<ProfileMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController profileScreenPointScrollController = ref.read(profileScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController profileTopBarPointAutoScrollController = ScrollController();
