...
// manager 폴더 - message 폴더 - message_all_provider.dart 내의 User 클래스와 FirebaseAuth 관련 User 클래스가 충돌나서 구분지음
...
import '../provider/user_info_modify_and_secession_state_provider.dart'; // 별칭 설정 (profanity_filter 패키지 임포트)
...
class _UserInfoModifyAndSecessionScreenState
  ...
  // FirebaseAuthUser.User로 사용한 이유:
  // manager 폴더 - message 폴더 - message_all_provider.dart 내의 User 클래스와 FirebaseAuth 관련 User 클래스가 충돌나서 구분지음
  StreamSubscription<FirebaseAuthUser.User?>? authStateChangesSubscription;
  ...
  void initState() {
    ...
    FirebaseAuthUser.FirebaseAuth.instance.authStateChanges().listen((user) {
      // FirebaseAuthUser.를 사용한 이유:
      // manager 폴더 - message 폴더 - message_all_provider.dart 내의 User 클래스와 FirebaseAuth 관련 User 클래스가 충돌나서 구분지음
      final user = FirebaseAuthUser.FirebaseAuth.instance.currentUser;
      final userEmail = user?.email ?? user?.uid ?? '';
                                    ...
                                    children: [
                                      ...
                                      ClipRRect(
                                        ...
                                        child: Container(
                                          ...
                                          color: ORANGE_BEIGE_COLOR, // 배경색 설정
        ...
        TextButton(
          onPressed: () async {
            ...
            try {
              ...
              await FirebaseAuthUser.FirebaseAuth.instance
                  .signOut();
