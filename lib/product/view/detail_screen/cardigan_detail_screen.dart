...
class CardiganDetailProductScreen extends ConsumerStatefulWidget {
  ...
  const CardiganDetailProductScreen({Key? key, required this.fullPath}) : super(key: key);
  @override
  _CardiganDetailProductScreenState createState() => _CardiganDetailProductScreenState();
}
...
class _CardiganDetailProductScreenState extends ConsumerState<CardiganDetailProductScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (cardiganDetailProductScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = ref.read(cardiganDetailScrollPositionProvider);
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(cardiganDetailScrollPositionProvider.notifier).state = 0;
      }
    });
  ...
  Widget build(BuildContext context) {
    ...
    final productContent = ref.watch(cardiganDetailProdFirestoreDataProvider(widget.fullPath));
    ...
    return Scaffold(
      body: Stack(
        children: [
          CustomScrollView(
            controller: cardiganDetailProductScreenPointScrollController, // 스크롤 컨트롤러 연결
            slivers: <Widget>[
              ...
              SliverAppBar(
                ...
                title: buildCommonAppBar( // 공통 AppBar 빌드
                  ...
                  ref: ref, // 참조(ref) 전달
                  title: '가디건 상세', // AppBar의 제목을 '가디건 상세'로 설정
          ...
          buildTopButton(context, cardiganDetailProductScreenPointScrollController),
        ],
      ),
    );
    // ------ 화면구성 끝
