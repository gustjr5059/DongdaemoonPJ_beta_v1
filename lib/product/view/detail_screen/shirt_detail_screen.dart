...
//   const ShirtDetailProductScreen({Key? key, required this.docId}) : super(key: key); // 생성자 수정
//
...
//       // 공통 AppBar 구성 함수 호출
//       appBar: buildCommonAppBar(context: context, title: '티셔츠 상세', pageBackButton: true),// common_parts.dart의 AppBar 재사용
//       // body에 카테고리 리스트 포함
