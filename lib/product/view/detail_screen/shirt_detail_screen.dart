...
class ShirtDetailProductScreen extends ConsumerStatefulWidget {
  ...
  const ShirtDetailProductScreen({
  ...
  @override
  _ShirtDetailProductScreenState createState() =>
      _ShirtDetailProductScreenState();
}

// _ShirtDetailProductScreenState 클래스 시작
// _ShirtDetailProductScreenState 클래스는 ShirtDetailProductScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _ShirtDetailProductScreenState
    extends ConsumerState<ShirtDetailProductScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (shirtDetailProductScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(shirtDetailScrollPositionProvider);
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(shirtDetailScrollPositionProvider.notifier).state =
  ...
  Widget build(BuildContext context) {
    ...
    print(
        "ShirtDetailProductScreen: 제품 경로에 대한 화면 로드 중: ${widget.fullPath}"); // 디버깅 메시지 추가
