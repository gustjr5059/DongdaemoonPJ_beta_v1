...
class _SkirtDetailProductScreenState
  ...
  Widget build(BuildContext context) {
    ...
    print("SkirtDetailProductScreen: 제품 경로에 대한 화면 로드 중: ${widget.fullPath}"); // 디버깅 메시지 추가
                  ...
                  delegate: SliverChildBuilderDelegate(
                      ...
                      return Column(
                        children: [
                          productContent.when(
                            data: (product) {
                              print("SkirtDetailProductScreen: 제품 데이터 로드 완료"); // 디버깅 메시지 추가
                              return Column(
                                children: [
                                  ...
                                  productReviews.when(
                                    data: (reviewsContent) {
                                      print("SkirtDetailProductScreen: ${reviewsContent.length} reviews가 로드됨"); // 디버깅 메시지 추가
