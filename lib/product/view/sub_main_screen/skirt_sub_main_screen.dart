...
class SkirtSubMainScreen extends ConsumerStatefulWidget {
  const SkirtSubMainScreen({Key? key}) : super(key: key);
  @override
  _SkirtSubMainScreenState createState() => _SkirtSubMainScreenState();
}

// _SkirtMainScreenState 클래스 시작
// _SkirtMainScreenState 클래스는 SkirtMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _SkirtSubMainScreenState extends ConsumerState<SkirtSubMainScreen> with WidgetsBindingObserver {
