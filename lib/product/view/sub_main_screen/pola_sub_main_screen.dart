...
class PolaSubMainScreen extends ConsumerStatefulWidget {
  const PolaSubMainScreen({Key? key}) : super(key: key);
  @override
  _PolaSubMainScreenState createState() => _PolaSubMainScreenState();
}

// _PolaMainScreenState 클래스 시작
// _PolaMainScreenState 클래스는 PolaMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _PolaSubMainScreenState extends ConsumerState<PolaSubMainScreen> with WidgetsBindingObserver {
