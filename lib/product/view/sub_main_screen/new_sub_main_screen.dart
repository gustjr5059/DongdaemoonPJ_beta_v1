...
class _NewSubMainScreenState extends ConsumerState<NewSubMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController newSubMainScreenPointScrollController = ref.read(newSubMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController newSubMainTopBarPointAutoScrollController = ScrollController();
