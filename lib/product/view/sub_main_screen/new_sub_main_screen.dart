...
class _NewSubMainScreenState extends ConsumerState<NewSubMainScreen> with WidgetsBindingObserver {
  ...
  void _updateScrollPosition() {
    ...
    ref.read(newSubMainScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    _largeBannerPageController = PageController(initialPage: ref.read(newSubMainLargeBannerPageProvider));
    ...
    _small1BannerPageController = PageController(initialPage: ref.read(newSubMainSmall1BannerPageProvider));
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(newSubMainLargeBannerPageProvider.notifier).state = 0; // 대배너 페이지 초기화
        ref.read(newSubMainSmall1BannerPageProvider.notifier).state = 0; // 소배너 페이지 초기화
            ...
            slivers: <Widget>[
              ...
              SliverAppBar(
                ...
                title: buildCommonAppBar( // 공통 AppBar 빌드
                  ...
                  ref: ref, // 참조(ref) 전달
                  title: '신상 섹션 더보기', // AppBar의 제목을 '신상 섹션 더보기'로 설정
                        ...
                        child: Column(
                          children: [
                            ...
                            PriceAndDiscountPercentSortButtons<SectionMoreProductListNotifier>(
                              productListProvider: newSubMainProductListProvider, // 신상 제품 리스트 프로바이더 전달
                              sortButtonProvider: newSubMainSortButtonProvider, // 신상 정렬 버튼 프로바이더 전달
                            ), // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: 3),
                            ...
                            GeneralProductList<SectionMoreProductListNotifier>(
                              ...
                              productListProvider: newSubMainProductListProvider,
                              // 카테고리를 '신상'으로 설정
                              category: '신상',
                            ),
                            SizedBox(height: 3), // 3의 높이를 가진 간격 추가
