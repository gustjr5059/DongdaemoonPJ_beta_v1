...
class _SummerSubMainScreenState extends ConsumerState<SummerSubMainScreen> with WidgetsBindingObserver {
  ...
  void _updateScrollPosition() {
    ...
    double currentScrollPosition = summerSubMainScreenPointScrollController.offset;
    ...
    ref.read(summerSubMainScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (summerSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = ref.read(summerSubMainScrollPositionProvider);
    ...
    _largeBannerPageController = PageController(initialPage: ref.read(summerSubMainLargeBannerPageProvider));
    ...
    _small1BannerPageController = PageController(initialPage: ref.read(summerSubMainSmall1BannerPageProvider));
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(summerSubMainLargeBannerPageProvider.notifier).state = 0; // 대배너 페이지 초기화
        ref.read(summerSubMainSmall1BannerPageProvider.notifier).state = 0; // 소배너 페이지 초기화
  ...
  void dispose() {
    ...
    summerSubMainScreenPointScrollController.removeListener(_updateScrollPosition);
            ...
            slivers: <Widget>[
              ...
              SliverAppBar(
                ...
                title: buildCommonAppBar( // 공통 AppBar 빌드
                  ...
                  ref: ref, // 참조(ref) 전달
                  title: '여름 섹션 더보기', // AppBar의 제목을 '여름 섹션 더보기'로 설정
                        ...
                        child: Column(
                          children: [
                            ...
                            PriceAndDiscountPercentSortButtons<SectionMoreProductListNotifier>(
                              productListProvider: summerSubMainProductListProvider, // 여름 제품 리스트 프로바이더 전달
                              sortButtonProvider: summerSubMainSortButtonProvider, // 여름 정렬 버튼 프로바이더 전달
                            ), // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: 3),
                            ...
                            GeneralProductList<SectionMoreProductListNotifier>(
                              ...
                              scrollController: summerSubMainScreenPointScrollController,
                              // 상품 리스트 프로바이더를 설정 (여름 섹션의 상품 리스트 프로바이더)
                              productListProvider: summerSubMainProductListProvider,
                              // 카테고리를 '여름'으로 설정
                              category: '여름',
                            ),
                            SizedBox(height: 3), // 3의 높이를 가진 간격 추가
