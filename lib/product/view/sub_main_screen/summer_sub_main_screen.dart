...
class _SummerSubMainScreenState extends ConsumerState<SummerSubMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController summerSubMainScreenPointScrollController = ref.read(summerSubMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController summerSubMainTopBarPointAutoScrollController = ScrollController();
