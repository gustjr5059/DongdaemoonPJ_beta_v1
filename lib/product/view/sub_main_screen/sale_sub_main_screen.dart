...
class _SaleSubMainScreenState extends ConsumerState<SaleSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double saleSubMainScreenLargeBannerHeight = screenSize.height * (378 / referenceHeight); // 대배너 이미지 높이
    ...
    final double saleSubMainScreenSmallBannerHeight = screenSize.height * (90 / referenceHeight); // 소배너 이미지 높이
    ...
    final double sectionPlusAppBarTitleX = screenSize.height * (70 / referenceHeight);
