...
class _SaleSubMainScreenState extends ConsumerState<SaleSubMainScreen> with WidgetsBindingObserver {
  ...
  void _updateScrollPosition() {
    ...
    double currentScrollPosition = saleSubMainScreenPointScrollController.offset;
    ...
    ref.read(saleSubMainScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (saleSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = ref.read(saleSubMainScrollPositionProvider);
    ...
    _largeBannerPageController = PageController(initialPage: ref.read(saleSubMainLargeBannerPageProvider));
    ...
    _small1BannerPageController = PageController(initialPage: ref.read(saleSubMainSmall1BannerPageProvider));
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(saleSubMainLargeBannerPageProvider.notifier).state = 0; // 대배너 페이지 초기화
        ref.read(saleSubMainSmall1BannerPageProvider.notifier).state = 0; // 소배너 페이지 초기화
  ...
  void dispose() {
    ...
    saleSubMainScreenPointScrollController.removeListener(_updateScrollPosition);
            ...
            slivers: <Widget>[
              ...
              SliverAppBar(
                ...
                title: buildCommonAppBar( // 공통 AppBar 빌드
                  ...
                  ref: ref, // 참조(ref) 전달
                  title: '할인 섹션 더보기', // AppBar의 제목을 '할인 섹션 더보기'로 설정
                        ...
                        child: Column(
                          children: [
                            ...
                            PriceAndDiscountPercentSortButtons<SectionMoreProductListNotifier>(
                              productListProvider: saleSubMainProductListProvider, // 할인 제품 리스트 프로바이더 전달
                              sortButtonProvider: saleSubMainSortButtonProvider, // 할인 정렬 버튼 프로바이더 전달
                            ), // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: 3),
                            ...
                            GeneralProductList<SectionMoreProductListNotifier>(
                              ...
                              productListProvider: saleSubMainProductListProvider,
                              // 카테고리를 '할인'으로 설정
                              category: '할인',
                            ),
                            SizedBox(height: 3), // 3의 높이를 가진 간격 추가
