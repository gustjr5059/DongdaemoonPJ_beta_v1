...
class _BestSubMainScreenState extends ConsumerState<BestSubMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController bestSubMainScreenPointScrollController = ref.read(bestSubMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController bestSubMainTopBarPointAutoScrollController = ScrollController();
