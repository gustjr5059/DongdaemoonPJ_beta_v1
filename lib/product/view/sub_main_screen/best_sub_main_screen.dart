...
class _BestSubMainScreenState extends ConsumerState<BestSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double bestSubMainScreenLargeBannerHeight = screenSize.height * (378 / referenceHeight); // 대배너 이미지 높이
    ...
    final double bestSubMainScreenSmallBannerHeight = screenSize.height * (90 / referenceHeight); // 소배너 이미지 높이
