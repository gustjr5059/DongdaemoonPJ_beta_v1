...
class _BestSubMainScreenState extends ConsumerState<BestSubMainScreen>
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'bestSubMainScrollPositionProvider'의 notifier를 읽어옴.
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (bestSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(bestSubMainScrollPositionProvider);
    ...
    _largeBannerPageController = PageController(
        initialPage: ref.read(bestSubMainLargeBannerPageProvider));

    // 큰 배너를 자동으로 스크롤하는 기능 초기화
    _largeBannerAutoScroll = BannerAutoScrollClass(
      pageController: _largeBannerPageController,
      currentPageProvider: bestSubMainLargeBannerPageProvider,
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: bestSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(bestSubMainSmall1BannerImagesProvider).value ?? [], ref),
    ...
    return Scaffold(
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    currentPageProvider:
                                    bestSubMainLargeBannerPageProvider, // 큰 배너 페이지의 상태 제공자를 전달함
                                    ...
                                    width: bestSubMainScreenLargeBannerWidth, // 큰 배너 섹션의 너비를 설정함
                                    height: bestSubMainScreenLargeBannerHeight, // 큰 배너 섹션의 높이를 설정함
                            ...
                            //         ref: ref, // 상태 관리를 위한 참조를 전달함
                            //         currentPageProvider:
                            //         bestSubMainSmall1BannerPageProvider, // 작은 배너 페이지의 상태 제공자를 전달함
                            ...
                            //         bannerImagesProvider:
                            //         bestSubMainSmall1BannerImagesProvider, // 작은 배너 이미지의 상태 제공자를 전달함
                            //         // 배너를 탭했을 때 실행할 함수를 전달
                            //         onPageTap: (context, index) =>
                            ...
                            //             context, // 현재 화면의 컨텍스트를 전달함
                            //             index, // 클릭된 배너의 인덱스를 전달함
                            //             // bestSubMainSmall1BannerImagesProvider에서 대배너 이미지 리스트를 가져옴. 값이 없으면 빈 리스트를 사용함
                            //             ref.watch(bestSubMainSmall1BannerImagesProvider).value ?? [],
                            //             ref // Provider의 참조를 전달함
                            //         ),
                            //         width: bestSubMainScreenSmallBannerWidth, // 작은 배너 섹션의 너비를 설정함
                            //         height: bestSubMainScreenSmallBannerHeight, // 작은 배너 섹션의 높이를 설정함
      ...
      bottomNavigationBar: buildCommonBottomNavigationBar(
          ref.watch(tabIndexProvider), ref, context, 5, 1, scrollController: bestSubMainScreenPointScrollController),
