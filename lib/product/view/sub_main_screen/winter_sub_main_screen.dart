...
class _WinterSubMainScreenState extends ConsumerState<WinterSubMainScreen>
  ...
  // winterSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(winterSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // winterSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void initState() {
    ...
    _largeBannerAutoScroll = BannerAutoScrollClass(
      ...
      currentPageProvider: winterSubMainLargeBannerPageProvider,
    ...
    _small1BannerAutoScroll = BannerAutoScrollClass(
      ...
      currentPageProvider: winterSubMainSmall1BannerPageProvider,
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: winterSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(winterSubMainSmall1BannerImagesProvider).value ?? [], ref),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: buildCommonBottomNavigationBar(
          ...
          ref,
          context,
          5, 1, scrollController: winterSubMainScreenPointScrollController), // 공통으로 사용되는 하단 네비게이션 바를 가져옴.
    );
    // ------ 화면구성 끝
  }
