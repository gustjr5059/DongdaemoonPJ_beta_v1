...
class _SpringSubMainScreenState extends ConsumerState<SpringSubMainScreen> with WidgetsBindingObserver {
  ...
  void _updateScrollPosition() {
    ...
    double currentScrollPosition = springSubMainScreenPointScrollController.offset;
    ...
    ref.read(springSubMainScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (springSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = ref.read(springSubMainScrollPositionProvider);
    ...
    _largeBannerPageController = PageController(initialPage: ref.read(springSubMainLargeBannerPageProvider));
    ...
    _small1BannerPageController = PageController(initialPage: ref.read(springSubMainSmall1BannerPageProvider));
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(springSubMainLargeBannerPageProvider.notifier).state = 0; // 대배너 페이지 초기화
        ref.read(springSubMainSmall1BannerPageProvider.notifier).state = 0; // 소배너 페이지 초기화
  ...
  void dispose() {
    ...
    springSubMainScreenPointScrollController.removeListener(_updateScrollPosition);
            ...
            slivers: <Widget>[
              ...
              SliverAppBar(
                ...
                title: buildCommonAppBar( // 공통 AppBar 빌드
                  ...
                  ref: ref, // 참조(ref) 전달
                  title: '봄 섹션 더보기', // AppBar의 제목을 '봄 섹션 더보기'로 설정
                        ...
                        child: Column(
                          children: [
                            ...
                            PriceAndDiscountPercentSortButtons<SectionMoreProductListNotifier>(
                              productListProvider: springSubMainProductListProvider, // 봄 제품 리스트 프로바이더 전달
                              sortButtonProvider: springSubMainSortButtonProvider, // 봄 정렬 버튼 프로바이더 전달
                            ), // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: 3),
                            ...
                            GeneralProductList<SectionMoreProductListNotifier>(
                              ...
                              productListProvider: springSubMainProductListProvider,
                              // 카테고리를 '봄'으로 설정
                              category: '봄',
                            ),
                            SizedBox(height: 3), // 3의 높이를 가진 간격 추가
