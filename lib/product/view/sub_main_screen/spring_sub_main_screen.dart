...
class _SpringSubMainScreenState extends ConsumerState<SpringSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double springSubMainScreenLargeBannerHeight = screenSize.height * (268 / referenceHeight); // 대배너 이미지 높이
                            ...
                            CommonCardView(
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                      SpringSubMainSmall1BannerImage>(
                                    context: context, // 위젯 트리를 위한 빌드 컨텍스트 전달함
                                    ref: ref, // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
