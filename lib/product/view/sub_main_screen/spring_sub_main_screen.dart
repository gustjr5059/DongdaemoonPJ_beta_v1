...
class _SpringSubMainScreenState extends ConsumerState<SpringSubMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController springSubMainScreenPointScrollController = ref.read(springSubMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController springSubMainTopBarPointAutoScrollController = ScrollController();
