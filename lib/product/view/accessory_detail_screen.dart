...
class AccessoryDetailProductScreen extends ConsumerWidget {
  final String docId; // 문서 ID를 저장할 변수 선언
  const AccessoryDetailProductScreen({Key? key, required this.docId}) : super(key: key); // 생성자 수정
...
// 해당 URL 리스트를 사용하여 이미지 슬라이더를 구성함.
    ...
    return Scaffold(
      ...
      // 공통 AppBar 구성 함수 호출
      appBar: buildCommonAppBar('악세서리 상세', context),// common_parts.dart의 AppBar 재사용
      // body에 카테고리 리스트 포함
