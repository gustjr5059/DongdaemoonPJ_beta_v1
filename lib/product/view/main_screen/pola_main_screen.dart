...
class _PolaMainScreenState extends ConsumerState<PolaMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(polaMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, polaCurrentTabProvider, topBarAutoScrollController);
