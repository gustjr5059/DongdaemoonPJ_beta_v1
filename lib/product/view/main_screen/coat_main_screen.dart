...
class _CoatMainScreenState extends ConsumerState<CoatMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(coatMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, coatCurrentTabProvider, topBarAutoScrollController);
