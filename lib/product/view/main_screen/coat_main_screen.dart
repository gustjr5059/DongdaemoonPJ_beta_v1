...
class _CoatMainScreenState extends ConsumerState<CoatMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController coatMainScreenPointScrollController = ref.read(coatMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController coatMainTopBarPointAutoScrollController = ScrollController();
  ...
  void _updateScrollPosition() {
    ...
    ref.read(coatMainScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (coatMainScreenPointScrollController.hasClients) {
        ...
        if (savedTabIndex >= 6) {
          double offset = coatMainTopBarPointAutoScrollController.position.maxScrollExtent;
    ...
    _largeBannerPageController = PageController(initialPage: ref.read(coatMainLargeBannerPageProvider));
    ...
    _small1BannerPageController = PageController(initialPage: ref.read(coatMainSmall1BannerPageProvider));
  ...
  Widget build(BuildContext context) {
    ...
    void onTopBarTap(int index) {
      ...
      Future.delayed(Duration.zero,() {
        ...
        ref.read(coatMainProductListProvider.notifier).fetchInitialProducts(_getCategory(index)); // 선택한 탭에 해당하는 초기 제품 가져오기 호출
      });
    }
    // 상단 탭 바를 구성하는 리스트 뷰를 가져오는 위젯
    // (common_parts.dart의 buildTopBarList 재사용 후 topBarList 위젯으로 재정의)
    Widget topBarList = buildTopBarList(context, onTopBarTap, coatCurrentTabProvider, coatMainTopBarPointAutoScrollController);
                          ...
                          children: [
                            ...
                            CommonCardView(
                              content: SizedBox(
                                ...
                                height: 30,
                                // 카드뷰 내용으로 buildCommonBannerPageViewSection 재사용하여 구현함.
                                child: buildCommonBannerPageViewSection<CoatMainSmall1BannerImage>(
                                  context: context,
                                  ref: ref,
                                  currentPageProvider: coatMainSmall1BannerPageProvider,
                                  pageController: _small1BannerPageController,
                            ...
                            Consumer(
                              ...
                              builder: (context, ref, child) {
                                ...
                                final currentTab = ref.watch(coatCurrentTabProvider);
                                // 현재 탭: coatCurrentTabProvider를 구독하고 현재 선택된 탭 정보를 가져옴.
                                final productListProvider = coatMainProductListProvider;
                                ...
                                return GeneralProductList(
                                  ...
                                  scrollController: coatMainScreenPointScrollController,
