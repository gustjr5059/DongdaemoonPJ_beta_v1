...
class _JeanMainScreenState extends ConsumerState<JeanMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(jeanMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, jeanCurrentTabProvider, topBarAutoScrollController);
