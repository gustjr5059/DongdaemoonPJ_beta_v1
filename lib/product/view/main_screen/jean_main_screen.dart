...
class _JeanMainScreenState extends ConsumerState<JeanMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController jeanMainScreenPointScrollController = ref.read(jeanMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController jeanMainTopBarPointAutoScrollController = ScrollController();
