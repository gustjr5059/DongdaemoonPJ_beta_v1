...
class _ShirtMainScreenState extends ConsumerState<ShirtMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(shirtMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, shirtCurrentTabProvider, topBarAutoScrollController);
