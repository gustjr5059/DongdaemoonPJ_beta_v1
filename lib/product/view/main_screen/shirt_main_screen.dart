...
class _ShirtMainScreenState extends ConsumerState<ShirtMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController shirtMainScreenPointScrollController = ref.read(shirtMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController shirtMainTopBarPointAutoScrollController = ScrollController();
