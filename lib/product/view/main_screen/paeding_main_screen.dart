...
class _PaedingMainScreenState extends ConsumerState<PaedingMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(paedingMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, paedingCurrentTabProvider, topBarAutoScrollController);
