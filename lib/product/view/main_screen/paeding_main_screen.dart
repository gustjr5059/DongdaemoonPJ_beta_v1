...
class _PaedingMainScreenState extends ConsumerState<PaedingMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController paedingMainScreenPointScrollController = ref.read(paedingMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController paedingMainTopBarPointAutoScrollController = ScrollController();
