...
class _CardiganMainScreenState extends ConsumerState<CardiganMainScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (cardiganMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(cardiganMainScrollPositionProvider);
    ...
    _largeBannerPageController = PageController(
        initialPage: ref.read(cardiganMainLargeBannerPageProvider));
    ...
    _small1BannerPageController = PageController(
        initialPage: ref.read(cardiganMainSmall1BannerPageProvider));
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(cardiganMainScrollPositionProvider.notifier).state =
            0.0; // 로그아웃 시 cardiganMainScrollPositionProvider가 초기화되므로, 재로그인 시 초기 스크롤 위치에서 시작됨. 하지만 상품 데이터는 유지됨.
  ...
  Widget build(BuildContext context) {
    ...
    void onTopBarTap(int index) {
      ...
      Future.delayed(Duration.zero, () {
        ...
        ref.read(cardiganMainProductListProvider.notifier).fetchInitialProducts(
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(cardiganMainSmall1BannerImagesProvider).value ?? [], ref),
                        ...
                        child: Column(
                          children: [
                            ...
                            PriceAndDiscountPercentSortButtons<
                              ...
                              productListProvider:
                                  cardiganMainProductListProvider,
                            ...
                            Consumer(
                              ...
                              builder: (context, ref, child) {
                                ...
                                final currentTab =
                                    ref.watch(cardiganCurrentTabProvider);
