...
class _CardiganMainScreenState extends ConsumerState<CardiganMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController cardiganMainScreenPointScrollController = ref.read(cardiganMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController cardiganMainTopBarPointAutoScrollController = ScrollController();
