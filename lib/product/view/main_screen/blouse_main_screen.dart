...
class _BlouseMainScreenState extends ConsumerState<BlouseMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController blouseMainScreenPointScrollController = ref.read(blouseMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController blouseMainTopBarPointAutoScrollController = ScrollController();
