...
class _OnepieceMainScreenState extends ConsumerState<OnepieceMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController onepieceMainScreenPointScrollController = ref.read(onepieceMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController onepieceMainTopBarPointAutoScrollController = ScrollController();
