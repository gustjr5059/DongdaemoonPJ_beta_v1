...
class _OnepieceMainScreenState extends ConsumerState<OnepieceMainScreen> with WidgetsBindingObserver {
  ...
  void _updateScrollPosition() {
    ...
    double currentScrollPosition = onepieceMainScreenPointScrollController.offset;
    ...
    ref.read(onepieceMainScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (onepieceMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = ref.read(onepieceMainScrollPositionProvider);
    ...
    _largeBannerPageController = PageController(initialPage: ref.read(onepieceMainLargeBannerPageProvider));
    ...
    _small1BannerPageController = PageController(initialPage: ref.read(onepieceMainSmall1BannerPageProvider));
  ...
  void dispose() {
    ...
    onepieceMainScreenPointScrollController.removeListener(_updateScrollPosition);

    onepieceMainScreenPointScrollController.dispose(); // ScrollController 해제

    onepieceMainTopBarPointAutoScrollController.dispose(); // ScrollController 해제
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, onepieceCurrentTabProvider, onepieceMainTopBarPointAutoScrollController);
                          ...
                          children: [
                            ...
                            CommonCardView(
                              content: SizedBox(
                                ...
                                height: 30,
                                // 카드뷰 내용으로 buildCommonBannerPageViewSection 재사용하여 구현함.
                                child: buildCommonBannerPageViewSection<OnepieceMainSmall1BannerImage>(
                                  context: context,
                                  ref: ref,
                                  currentPageProvider: onepieceMainSmall1BannerPageProvider,
                                  pageController: _small1BannerPageController,
                            ...
                            PriceAndDiscountPercentSortButtons(
                              productListProvider: onepieceMainProductListProvider, // 원피스 제품 리스트 정렬 프로바이더 전달
                              sortButtonProvider: onepieceMainSortButtonProvider, // 원피스 정렬 버튼 프로바이더 전달
                            ), // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: 3), // 3의 높이를 가진 간격 추가
                            Consumer(
