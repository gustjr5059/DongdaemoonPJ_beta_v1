...
class _OnepieceMainScreenState extends ConsumerState<OnepieceMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(onepieceMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, onepieceCurrentTabProvider, topBarAutoScrollController);
