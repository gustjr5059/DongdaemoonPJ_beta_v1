...
class _SkirtMainScreenState extends ConsumerState<SkirtMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(skirtMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, skirtCurrentTabProvider, topBarAutoScrollController);
