...
class _SkirtMainScreenState extends ConsumerState<SkirtMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController skirtMainScreenPointScrollController = ref.read(skirtMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController skirtMainTopBarPointAutoScrollController = ScrollController();
