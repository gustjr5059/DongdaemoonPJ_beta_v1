...
class _MtmMainScreenState extends ConsumerState<MtmMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController mtmMainScreenPointScrollController = ref.read(mtmMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController mtmMainTopBarPointAutoScrollController = ScrollController();
