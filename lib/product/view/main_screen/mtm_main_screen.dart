...
class _MtmMainScreenState extends ConsumerState<MtmMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(mtmMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, mtmCurrentTabProvider, topBarAutoScrollController);
