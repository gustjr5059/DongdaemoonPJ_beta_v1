...
class _PantsMainScreenState extends ConsumerState<PantsMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController pantsMainScreenPointScrollController = ref.read(pantsMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController pantsMainTopBarPointAutoScrollController = ScrollController();
