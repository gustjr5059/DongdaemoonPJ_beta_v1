...
class _NeatMainScreenState extends ConsumerState<NeatMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController neatMainScreenPointScrollController = ref.read(neatMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController neatMainTopBarPointAutoScrollController = ScrollController();
