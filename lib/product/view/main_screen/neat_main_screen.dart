...
class _NeatMainScreenState extends ConsumerState<NeatMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController scrollController = ref.read(neatMainScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap, neatCurrentTabProvider, topBarAutoScrollController);
