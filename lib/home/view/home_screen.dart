...
// '가을'이나 '겨울' 탭이 활성화될 때 자동 스크롤
  ...
  void initState() {
    ...
    _largeBannerPageController =
        PageController(initialPage: ref.read(homeLargeBannerPageProvider));
    ...
    _small1BannerPageController =
        PageController(initialPage: ref.read(homeSmall1BannerPageProvider));
    ...
    _small2BannerPageController =
        PageController(initialPage: ref.read(homeSmall2BannerPageProvider));
    ...
    _small3BannerPageController =
        PageController(initialPage: ref.read(homeSmall3BannerPageProvider));
  ...
  Widget build(BuildContext context) {
    ...
    double calculateScrollOffset(BuildContext context, String sectionTitle) {
      ...
      switch (sectionTitle) {
        case '신상': //260  360
          return screenHeight * 0.97; // '신상품 섹션'의 스크롤 위치
        case '스테디 셀러':
          return screenHeight * 1.37; // '스테디 셀러 제품 섹션'의 스크롤 위치
        case '특가 상품':
          return screenHeight * 1.75; // '특가 상품 섹션'의 스크롤 위치
        case '봄':
          return screenHeight * 2.32; // '봄 제품 섹션'의 스크롤 위치
        case '여름':
          return screenHeight * 2.70; // '여름 제품 섹션'의 스크롤 위치
        case '가을':
          return screenHeight * 3.30; // '가을 제품 섹션'의 스크롤 위치
        case '겨울':
          return screenHeight * 3.69; // '겨울 제품 섹션'의 스크롤 위치
        default:
    ...
    return Scaffold(
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 5), // 높이 10으로 간격 설정
                            ...
                            _buildSectionCard(
                                ...
                                WinterSubMainScreen()),
                            SizedBox(height: 350), // 높이 15로 간격 설정
                          ],
                        ),
                      );
                    },
      ...
      bottomNavigationBar: buildCommonBottomNavigationBar(
          ref.watch(tabIndexProvider), ref, context, 1, 1, scrollController: homeScreenPointScrollController,),
