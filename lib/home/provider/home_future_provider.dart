...
final homeSmall1BannerRepositoryProvider = Provider<HomeSmall1BannerRepository>((ref) {
...
final homeSmall1BannerImagesProvider = FutureProvider<List<HomeSmall1BannerImage>>((ref) async {
...
final homeSmall2BannerRepositoryProvider = Provider<HomeSmall2BannerRepository>((ref) {
...
// 이 프로바이더는 앱에서 사용되는 여러 배너 이미지들을 Firestore로부터 받아와서 리스트 형태로 제공함.
final homeSmall2BannerImagesProvider = FutureProvider<List<HomeSmall2BannerImage>>((ref) async {
  // 위에서 정의한 homeSmall1BannerImagesProvider를 사용하여 리포지토리 인스턴스를 가져옴.
...
final homeSmall3BannerRepositoryProvider = Provider<HomeSmall3BannerRepository>((ref) {
...
// 이 프로바이더는 앱에서 사용되는 여러 배너 이미지들을 Firestore로부터 받아와서 리스트 형태로 제공함.
final homeSmall3BannerImagesProvider = FutureProvider<List<HomeSmall3BannerImage>>((ref) async {
