import 'package:flutter/cupertino.dart'; // iOS 스타일의 디자인 위젯을 사용하기 위한 패키지
...
class NewLayout extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: buildCommonAppBar('NEW', context), // 'NEW' 제목의 AppBar, common_parts.dart에서 재사용
      body: Column(
        children: [
          Container(
          ...
          Expanded(
            // 'NEW 옷 내용'을 표시하는 부분. 실제 애플리케이션에서는 여기에 컨텐츠를 동적으로 로드하여 표시
            child: Center(child: Text('NEW 옷 내용')),
          ),
        ],
      ),
