...
class _WishlistMainScreenState extends ConsumerState<WishlistMainScreen> with WidgetsBindingObserver {
  ...
  void _updateScrollPosition() {
    ...
    ref.read(wishlistScrollPositionProvider.notifier).state = currentScrollPosition;
  }
