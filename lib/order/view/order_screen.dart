...
class _OrderMainScreenState extends ConsumerState<OrderMainScreen> with WidgetsBindingObserver {
  ...
  late ScrollController orderScreenPointScrollController = ref.read(orderScrollControllerProvider); // 스크롤 컨트롤러 선언
  ...
  late ScrollController orderTopBarPointAutoScrollController = ScrollController();
