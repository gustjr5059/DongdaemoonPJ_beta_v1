...
// 찜 목록 관리 화면에서 화면 자체 스크롤로 이동한 위치를 저장하는 StateProvider
final managerWishlistScrollPositionProvider = StateProvider<double>((ref) => 0);

// -------- wishlist_screen.dart 관련 ScrollControllerProvider 시작
// ScrollController를 프로바이더로 추가하는 코드
// 이 코드는 managerWishlistScrollControllerProvider라는 이름의 Provider를 정의함.
final managerWishlistScrollControllerProvider = Provider<ScrollController>((ref) {
