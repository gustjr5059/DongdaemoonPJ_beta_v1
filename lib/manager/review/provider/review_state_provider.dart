...
final managerReviewScrollPositionProvider = StateProvider<double>((ref) => 0);

// -------- wishlist_screen.dart 관련 ScrollControllerProvider 시작
// ScrollController를 프로바이더로 추가하는 코드
// 이 코드는 managerReviewScrollControllerProvider라는 이름의 Provider를 정의함.
final managerReviewScrollControllerProvider = Provider<ScrollController>((ref) {
