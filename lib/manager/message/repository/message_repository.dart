...
class AdminMessageRepository {
  ...
  Future<void> sendMessage({
    ...
    } else if (contents == '해당 발주 건은 결제가 완료 되었습니다.') { // 메시지 내용이 상품 준비임을 나타내는 경우
      newStatus = '상품 준비'; // 새로운 상태를 '상품 준비'로 설정
    } else if (contents == '해당 발주 건은 현장에서 수령 가능합니다.') { // 메시지 내용이 준비 완료임을 나타내는 경우
      newStatus = '준비 완료'; // 새로운 상태를 '준비 완료'로 설정
    } else if (contents == '해당 발주 건은 수령 완료되었습니다.') { // 메시지 내용이 수령 완료임을 나타내는 경우
      newStatus = '수령 완료'; // 새로운 상태를 '수령 완료'로 설정
    } else {
