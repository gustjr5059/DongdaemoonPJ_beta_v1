...
import '../../product/layout/aac_product_body_parts_layout.dart';
import '../../product/provider/aac_product_all_providers.dart';
import '../../product/view/main_screen/aac_blouse_main_screen.dart';
import '../../product/view/main_screen/aac_cardigan_main_screen.dart';
import '../../product/view/main_screen/aac_coat_main_screen.dart';
import '../../product/view/main_screen/aac_jean_main_screen.dart';
import '../../product/view/main_screen/aac_mtm_main_screen.dart';
import '../../product/view/main_screen/aac_neat_main_screen.dart';
import '../../product/view/main_screen/aac_onepiece_main_screen.dart';
import '../../product/view/main_screen/aac_paeding_main_screen.dart';
import '../../product/view/main_screen/aac_pants_main_screen.dart';
import '../../product/view/main_screen/aac_pola_main_screen.dart';
import '../../product/view/main_screen/aac_shirt_main_screen.dart';
import '../../product/view/main_screen/aac_skirt_main_screen.dart';
import '../provider/aac_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aacOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AacNeatMainScreen(),
    AacPolaMainScreen(),
    AacOnepieceMainScreen(),
    AacPantsMainScreen(),
    AacJeanMainScreen(),
    AacSkirtMainScreen(),
    AacPaedingMainScreen(),
    AacCoatMainScreen(),
    AacCardiganMainScreen(),
  ];
...
Widget aacBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AacProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aacNewProductRepositoryProvider); // aacNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aacBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AacProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aacBestProductRepositoryProvider); // aacBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aacBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AacProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aacSaleProductRepositoryProvider); // aacSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aacBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AacProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aacSpringProductRepositoryProvider); // aacSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aacBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AacProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aacSummerProductRepositoryProvider); // aacSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aacBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AacProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aacAutumnProductRepositoryProvider); // aacAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aacBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AacProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aacWinterProductRepositoryProvider); // aacWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AacEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AacEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AacEventPosterImgSectionList();

  @override
  _AacEventPosterImgSectionListState createState() =>
      _AacEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AacEventPosterImgSectionListState
    extends ConsumerState<AacEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aacEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aacEventPosterScrollPositionProvider.notifier).state =
...
Widget aacBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AacEventPosterImgSectionList(), // AacEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
