...
// ------ AacHomeSmall1BannerRepository 클래스 시작
// 'AacHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AacHomeSmall1BannerRepository {
  ...
  AacHomeSmall1BannerRepository(this.firestore);
...
// ------ AacHomeSmall1BannerRepository 클래스 끝

// ------ AacHomeSmall2BannerRepository 클래스 시작
// 'AacHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AacHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AacHomeSmall2BannerRepository(this.firestore);
...
// ------ AacHomeSmall2BannerRepository 클래스 끝

// ------ AacHomeSmall3BannerRepository 클래스 시작
// 'AacHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AacHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AacHomeSmall3BannerRepository(this.firestore);
...
// ------ AacHomeSmall3BannerRepository 클래스 끝