...
class _AacOnepieceMainScreenState extends ConsumerState<AacOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aacOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aacOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
