...
class _AacSpringSubMainScreenState extends ConsumerState<AacSpringSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double springSubMainScreenLargeBannerHeight = 378; // 대배너 이미지 높이
    final double springSubMainLargeBannerViewHeight = 378; // 대배너 화면 세로 비율

    // 소배너 부분 관련 수치
    final double springSubMainScreenSmallBannerWidth = screenSize.width * (361 / referenceWidth); // 소배너 이미지 너비
    final double springSubMainScreenSmallBannerHeight = 90; // 소배너 이미지 높이
    final double springSubMainScreenSmallBannerViewHeight = 90; // 소배너 화면 세로 비율
