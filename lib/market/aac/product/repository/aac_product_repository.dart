...
class AacNewProductRepository {
  ...
  List<String> collections = [
    'Aac1B1', 'Aac2B1', 'Aac3B1', 'Aac4B1', 'Aac5B1', 'Aac6B1',
    'Aac7B1', 'Aac8B1', 'Aac9B1', 'Aac10B1', 'Aac11B1', 'Aac12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aac10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aac10B1', 'Aac2B1' 등)
...
class AacBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aac1B2', 'Aac2B2', 'Aac3B2', 'Aac4B2', 'Aac5B2', 'Aac6B2',
    'Aac7B2', 'Aac8B2', 'Aac9B2', 'Aac10B2', 'Aac11B2', 'Aac12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacBestProductRepository(this.firestore); // 생성자
...
class AacSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aac1B3', 'Aac2B3', 'Aac3B3', 'Aac4B3', 'Aac5B3', 'Aac6B3',
    'Aac7B3', 'Aac8B3', 'Aac9B3', 'Aac10B3', 'Aac11B3', 'Aac12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacSaleProductRepository(this.firestore); // 생성자
...
class AacSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aac1B4', 'Aac2B4', 'Aac3B4', 'Aac4B4', 'Aac5B4', 'Aac6B4',
    'Aac7B4', 'Aac8B4', 'Aac9B4', 'Aac10B4', 'Aac11B4', 'Aac12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacSpringProductRepository(this.firestore); // 생성자
...
class AacSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aac1B5', 'Aac2B5', 'Aac3B5', 'Aac4B5', 'Aac5B5', 'Aac6B5',
    'Aac7B5', 'Aac8B5', 'Aac9B5', 'Aac10B5', 'Aac11B5', 'Aac12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacSummerProductRepository(this.firestore); // 생성자
...
class AacAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aac1B6', 'Aac2B6', 'Aac3B6', 'Aac4B6', 'Aac5B6', 'Aac6B6',
    'Aac7B6', 'Aac8B6', 'Aac9B6', 'Aac10B6', 'Aac11B6', 'Aac12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacAutumnProductRepository(this.firestore); // 생성자
...
class AacWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aac1B7', 'Aac2B7', 'Aac3B7', 'Aac4B7', 'Aac5B7', 'Aac6B7',
    'Aac7B7', 'Aac8B7', 'Aac9B7', 'Aac10B7', 'Aac11B7', 'Aac12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AacMainCategoryProductsRepository 시작 부분
class AacMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_3')
        .doc(mainCollection) // 'Aac10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aac10B1', 'Aac2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AacSectionCategoryProductsRepository 시작 부분
class AacSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AacSectionCategoryProductsRepository(this.firestore);
