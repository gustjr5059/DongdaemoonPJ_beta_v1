...
// ------ AauHomeSmall1BannerRepository 클래스 시작
// 'AauHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AauHomeSmall1BannerRepository {
  ...
  AauHomeSmall1BannerRepository(this.firestore);
...
// ------ AauHomeSmall1BannerRepository 클래스 끝

// ------ AauHomeSmall2BannerRepository 클래스 시작
// 'AauHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AauHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AauHomeSmall2BannerRepository(this.firestore);
...
// ------ AauHomeSmall2BannerRepository 클래스 끝

// ------ AauHomeSmall3BannerRepository 클래스 시작
// 'AauHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AauHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AauHomeSmall3BannerRepository(this.firestore);
...
// ------ AauHomeSmall3BannerRepository 클래스 끝