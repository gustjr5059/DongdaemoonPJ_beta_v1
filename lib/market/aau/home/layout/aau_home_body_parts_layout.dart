...
import '../../product/layout/aau_product_body_parts_layout.dart';
import '../../product/provider/aau_product_all_providers.dart';
import '../../product/view/main_screen/aau_blouse_main_screen.dart';
import '../../product/view/main_screen/aau_cardigan_main_screen.dart';
import '../../product/view/main_screen/aau_coat_main_screen.dart';
import '../../product/view/main_screen/aau_jean_main_screen.dart';
import '../../product/view/main_screen/aau_mtm_main_screen.dart';
import '../../product/view/main_screen/aau_neat_main_screen.dart';
import '../../product/view/main_screen/aau_onepiece_main_screen.dart';
import '../../product/view/main_screen/aau_paeding_main_screen.dart';
import '../../product/view/main_screen/aau_pants_main_screen.dart';
import '../../product/view/main_screen/aau_pola_main_screen.dart';
import '../../product/view/main_screen/aau_shirt_main_screen.dart';
import '../../product/view/main_screen/aau_skirt_main_screen.dart';
import '../provider/aau_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aauOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AauNeatMainScreen(),
    AauPolaMainScreen(),
    AauOnepieceMainScreen(),
    AauPantsMainScreen(),
    AauJeanMainScreen(),
    AauSkirtMainScreen(),
    AauPaedingMainScreen(),
    AauCoatMainScreen(),
    AauCardiganMainScreen(),
  ];
...
Widget aauBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AauProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aauNewProductRepositoryProvider); // aauNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aauBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AauProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aauBestProductRepositoryProvider); // aauBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aauBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AauProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aauSaleProductRepositoryProvider); // aauSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aauBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AauProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aauSpringProductRepositoryProvider); // aauSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aauBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AauProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aauSummerProductRepositoryProvider); // aauSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aauBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AauProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aauAutumnProductRepositoryProvider); // aauAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aauBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AauProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aauWinterProductRepositoryProvider); // aauWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AauEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AauEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AauEventPosterImgSectionList();

  @override
  _AauEventPosterImgSectionListState createState() =>
      _AauEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AauEventPosterImgSectionListState
    extends ConsumerState<AauEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aauEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aauEventPosterScrollPositionProvider.notifier).state =
...
Widget aauBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AauEventPosterImgSectionList(), // AauEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
