...
class AauNewProductRepository {
  ...
  List<String> collections = [
    'Aau1B1', 'Aau2B1', 'Aau3B1', 'Aau4B1', 'Aau5B1', 'Aau6B1',
    'Aau7B1', 'Aau8B1', 'Aau9B1', 'Aau10B1', 'Aau11B1', 'Aau12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_21')
          .doc(mainCollection) // 'Aau10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aau10B1', 'Aau2B1' 등)
...
class AauBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aau1B2', 'Aau2B2', 'Aau3B2', 'Aau4B2', 'Aau5B2', 'Aau6B2',
    'Aau7B2', 'Aau8B2', 'Aau9B2', 'Aau10B2', 'Aau11B2', 'Aau12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauBestProductRepository(this.firestore); // 생성자
...
class AauSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aau1B3', 'Aau2B3', 'Aau3B3', 'Aau4B3', 'Aau5B3', 'Aau6B3',
    'Aau7B3', 'Aau8B3', 'Aau9B3', 'Aau10B3', 'Aau11B3', 'Aau12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauSaleProductRepository(this.firestore); // 생성자
...
class AauSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aau1B4', 'Aau2B4', 'Aau3B4', 'Aau4B4', 'Aau5B4', 'Aau6B4',
    'Aau7B4', 'Aau8B4', 'Aau9B4', 'Aau10B4', 'Aau11B4', 'Aau12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauSpringProductRepository(this.firestore); // 생성자
...
class AauSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aau1B5', 'Aau2B5', 'Aau3B5', 'Aau4B5', 'Aau5B5', 'Aau6B5',
    'Aau7B5', 'Aau8B5', 'Aau9B5', 'Aau10B5', 'Aau11B5', 'Aau12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauSummerProductRepository(this.firestore); // 생성자
...
class AauAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aau1B6', 'Aau2B6', 'Aau3B6', 'Aau4B6', 'Aau5B6', 'Aau6B6',
    'Aau7B6', 'Aau8B6', 'Aau9B6', 'Aau10B6', 'Aau11B6', 'Aau12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauAutumnProductRepository(this.firestore); // 생성자
...
class AauWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aau1B7', 'Aau2B7', 'Aau3B7', 'Aau4B7', 'Aau5B7', 'Aau6B7',
    'Aau7B7', 'Aau8B7', 'Aau9B7', 'Aau10B7', 'Aau11B7', 'Aau12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AauMainCategoryProductsRepository 시작 부분
class AauMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_21')
        .doc(mainCollection) // 'Aau10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aau10B1', 'Aau2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AauSectionCategoryProductsRepository 시작 부분
class AauSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AauSectionCategoryProductsRepository(this.firestore);
