...
class _AajPolaMainScreenState extends ConsumerState<AajPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aajPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aajPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AajCardiganMainScreenState 클래스 끝// _AajCardiganMainScreenState 클래스 끝