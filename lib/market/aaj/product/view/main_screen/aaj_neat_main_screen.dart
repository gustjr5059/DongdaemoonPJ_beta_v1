...
class _AajNeatMainScreenState extends ConsumerState<AajNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      bannerImagesProvider: aajAllLargeBannerImagesProvider,
      onPageTap: (context, index) =>
          onLargeBannerTap(context, index, ref.watch(aajAllLargeBannerImagesProvider).value ?? [], ref),
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aajNeatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aajNeatMainSmall1BannerImagesProvider).value ?? [], ref),
