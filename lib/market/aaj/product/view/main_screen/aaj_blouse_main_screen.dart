...
class _AajBlouseMainScreenState extends ConsumerState<AajBlouseMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aajBlouseMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aajBlouseMainSmall1BannerImagesProvider).value ?? [], ref),
