...
class _AajAutumnSubMainScreenState extends ConsumerState<AajAutumnSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aajAutumnSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aajAutumnSubMainSmall1BannerImagesProvider).value ?? [], ref),
