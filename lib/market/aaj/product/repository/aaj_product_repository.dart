...
class AajNewProductRepository {
  ...
  List<String> collections = [
    'Aaj1B1', 'Aaj2B1', 'Aaj3B1', 'Aaj4B1', 'Aaj5B1', 'Aaj6B1',
    'Aaj7B1', 'Aaj8B1', 'Aaj9B1', 'Aaj10B1', 'Aaj11B1', 'Aaj12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aaj10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aaj10B1', 'Aaj2B1' 등)
...
class AajBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaj1B2', 'Aaj2B2', 'Aaj3B2', 'Aaj4B2', 'Aaj5B2', 'Aaj6B2',
    'Aaj7B2', 'Aaj8B2', 'Aaj9B2', 'Aaj10B2', 'Aaj11B2', 'Aaj12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajBestProductRepository(this.firestore); // 생성자
...
class AajSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaj1B3', 'Aaj2B3', 'Aaj3B3', 'Aaj4B3', 'Aaj5B3', 'Aaj6B3',
    'Aaj7B3', 'Aaj8B3', 'Aaj9B3', 'Aaj10B3', 'Aaj11B3', 'Aaj12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajSaleProductRepository(this.firestore); // 생성자
...
class AajSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaj1B4', 'Aaj2B4', 'Aaj3B4', 'Aaj4B4', 'Aaj5B4', 'Aaj6B4',
    'Aaj7B4', 'Aaj8B4', 'Aaj9B4', 'Aaj10B4', 'Aaj11B4', 'Aaj12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajSpringProductRepository(this.firestore); // 생성자
...
class AajSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaj1B5', 'Aaj2B5', 'Aaj3B5', 'Aaj4B5', 'Aaj5B5', 'Aaj6B5',
    'Aaj7B5', 'Aaj8B5', 'Aaj9B5', 'Aaj10B5', 'Aaj11B5', 'Aaj12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajSummerProductRepository(this.firestore); // 생성자
...
class AajAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaj1B6', 'Aaj2B6', 'Aaj3B6', 'Aaj4B6', 'Aaj5B6', 'Aaj6B6',
    'Aaj7B6', 'Aaj8B6', 'Aaj9B6', 'Aaj10B6', 'Aaj11B6', 'Aaj12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajAutumnProductRepository(this.firestore); // 생성자
...
class AajWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaj1B7', 'Aaj2B7', 'Aaj3B7', 'Aaj4B7', 'Aaj5B7', 'Aaj6B7',
    'Aaj7B7', 'Aaj8B7', 'Aaj9B7', 'Aaj10B7', 'Aaj11B7', 'Aaj12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AajMainCategoryProductsRepository 시작 부분
class AajMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_10')
        .doc(mainCollection) // 'Aaj10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aaj10B1', 'Aaj2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AajSectionCategoryProductsRepository 시작 부분
class AajSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AajSectionCategoryProductsRepository(this.firestore);
