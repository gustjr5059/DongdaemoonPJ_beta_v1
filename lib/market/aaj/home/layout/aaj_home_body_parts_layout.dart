...
import '../../product/layout/aaj_product_body_parts_layout.dart';
import '../../product/provider/aaj_product_all_providers.dart';
import '../../product/view/main_screen/aaj_blouse_main_screen.dart';
import '../../product/view/main_screen/aaj_cardigan_main_screen.dart';
import '../../product/view/main_screen/aaj_coat_main_screen.dart';
import '../../product/view/main_screen/aaj_jean_main_screen.dart';
import '../../product/view/main_screen/aaj_mtm_main_screen.dart';
import '../../product/view/main_screen/aaj_neat_main_screen.dart';
import '../../product/view/main_screen/aaj_onepiece_main_screen.dart';
import '../../product/view/main_screen/aaj_paeding_main_screen.dart';
import '../../product/view/main_screen/aaj_pants_main_screen.dart';
import '../../product/view/main_screen/aaj_pola_main_screen.dart';
import '../../product/view/main_screen/aaj_shirt_main_screen.dart';
import '../../product/view/main_screen/aaj_skirt_main_screen.dart';
import '../provider/aaj_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aajOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AajNeatMainScreen(),
    AajPolaMainScreen(),
    AajOnepieceMainScreen(),
    AajPantsMainScreen(),
    AajJeanMainScreen(),
    AajSkirtMainScreen(),
    AajPaedingMainScreen(),
    AajCoatMainScreen(),
    AajCardiganMainScreen(),
  ];
...
Widget aajBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AajProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aajNewProductRepositoryProvider); // aajNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aajBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AajProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aajBestProductRepositoryProvider); // aajBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aajBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AajProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aajSaleProductRepositoryProvider); // aajSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aajBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AajProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aajSpringProductRepositoryProvider); // aajSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aajBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AajProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aajSummerProductRepositoryProvider); // aajSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aajBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AajProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aajAutumnProductRepositoryProvider); // aajAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aajBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AajProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aajWinterProductRepositoryProvider); // aajWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AajEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AajEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AajEventPosterImgSectionList();

  @override
  _AajEventPosterImgSectionListState createState() =>
      _AajEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AajEventPosterImgSectionListState
    extends ConsumerState<AajEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aajEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aajEventPosterScrollPositionProvider.notifier).state =
...
Widget aajBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AajEventPosterImgSectionList(), // AajEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
