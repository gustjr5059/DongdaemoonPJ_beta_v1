...
// ------ AajHomeSmall1BannerRepository 클래스 시작
// 'AajHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AajHomeSmall1BannerRepository {
  ...
  AajHomeSmall1BannerRepository(this.firestore);
...
// ------ AajHomeSmall1BannerRepository 클래스 끝

// ------ AajHomeSmall2BannerRepository 클래스 시작
// 'AajHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AajHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AajHomeSmall2BannerRepository(this.firestore);
...
// ------ AajHomeSmall2BannerRepository 클래스 끝

// ------ AajHomeSmall3BannerRepository 클래스 시작
// 'AajHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AajHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AajHomeSmall3BannerRepository(this.firestore);
...
// ------ AajHomeSmall3BannerRepository 클래스 끝