...
class AagNewProductRepository {
  ...
  List<String> collections = [
    'Aag1B1', 'Aag2B1', 'Aag3B1', 'Aag4B1', 'Aag5B1', 'Aag6B1',
    'Aag7B1', 'Aag8B1', 'Aag9B1', 'Aag10B1', 'Aag11B1', 'Aag12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aag10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aag10B1', 'Aag2B1' 등)
...
class AagBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aag1B2', 'Aag2B2', 'Aag3B2', 'Aag4B2', 'Aag5B2', 'Aag6B2',
    'Aag7B2', 'Aag8B2', 'Aag9B2', 'Aag10B2', 'Aag11B2', 'Aag12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagBestProductRepository(this.firestore); // 생성자
...
class AagSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aag1B3', 'Aag2B3', 'Aag3B3', 'Aag4B3', 'Aag5B3', 'Aag6B3',
    'Aag7B3', 'Aag8B3', 'Aag9B3', 'Aag10B3', 'Aag11B3', 'Aag12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagSaleProductRepository(this.firestore); // 생성자
...
class AagSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aag1B4', 'Aag2B4', 'Aag3B4', 'Aag4B4', 'Aag5B4', 'Aag6B4',
    'Aag7B4', 'Aag8B4', 'Aag9B4', 'Aag10B4', 'Aag11B4', 'Aag12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagSpringProductRepository(this.firestore); // 생성자
...
class AagSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aag1B5', 'Aag2B5', 'Aag3B5', 'Aag4B5', 'Aag5B5', 'Aag6B5',
    'Aag7B5', 'Aag8B5', 'Aag9B5', 'Aag10B5', 'Aag11B5', 'Aag12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagSummerProductRepository(this.firestore); // 생성자
...
class AagAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aag1B6', 'Aag2B6', 'Aag3B6', 'Aag4B6', 'Aag5B6', 'Aag6B6',
    'Aag7B6', 'Aag8B6', 'Aag9B6', 'Aag10B6', 'Aag11B6', 'Aag12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagAutumnProductRepository(this.firestore); // 생성자
...
class AagWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aag1B7', 'Aag2B7', 'Aag3B7', 'Aag4B7', 'Aag5B7', 'Aag6B7',
    'Aag7B7', 'Aag8B7', 'Aag9B7', 'Aag10B7', 'Aag11B7', 'Aag12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AagMainCategoryProductsRepository 시작 부분
class AagMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_7')
        .doc(mainCollection) // 'Aag10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aag10B1', 'Aag2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AagSectionCategoryProductsRepository 시작 부분
class AagSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AagSectionCategoryProductsRepository(this.firestore);
