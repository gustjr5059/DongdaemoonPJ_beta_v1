...
class _AagNeatMainScreenState extends ConsumerState<AagNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      bannerImagesProvider: aagAllLargeBannerImagesProvider,
      onPageTap: (context, index) =>
          onLargeBannerTap(context, index, ref.watch(aagAllLargeBannerImagesProvider).value ?? [], ref),
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aagNeatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aagNeatMainSmall1BannerImagesProvider).value ?? [], ref),
