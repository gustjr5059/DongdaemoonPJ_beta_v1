...
class _AagBlouseMainScreenState extends ConsumerState<AagBlouseMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // 대배너 부분 관련 수치
    final double blouseMainScreenLargeBannerWidth = screenSize.width * (393 / referenceWidth); // 대배너 이미지 너비
    final double blouseMainScreenLargeBannerHeight = 378; // 대배너 이미지 높이
    final double blouseMainLargeBannerViewHeight = 378; // 대배너 화면 세로 비율

    // 소배너 부분 관련 수치
    final double blouseMainScreenSmallBannerWidth = screenSize.width * (361 / referenceWidth); // 소배너 이미지 너비
    final double blouseMainScreenSmallBannerHeight = 90; // 소배너 이미지 높이
    final double blouseMainScreenSmallBannerViewHeight = 90; // 소배너 화면 세로 비율
