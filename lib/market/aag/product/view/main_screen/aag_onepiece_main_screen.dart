...
class _AagOnepieceMainScreenState extends ConsumerState<AagOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aagOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aagOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
