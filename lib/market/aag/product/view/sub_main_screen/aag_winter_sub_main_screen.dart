...
class _AagWinterSubMainScreenState extends ConsumerState<AagWinterSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aagWinterSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aagWinterSubMainSmall1BannerImagesProvider).value ?? [], ref),
