...
// AagSaleSubMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AagSaleSubMainScreen extends ConsumerStatefulWidget {
  const AagSaleSubMainScreen({Key? key}) : super(key: key);

  @override
  _AagSaleSubMainScreenState createState() => _AagSaleSubMainScreenState();
}

// _AagSaleSubMainScreenState 클래스 시작
// _AagSaleSubMainScreenState 클래스는 AagSaleSubMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AagSaleSubMainScreenState extends ConsumerState<AagSaleSubMainScreen>
  ...
  // aagSaleSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(aagSaleSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // aagSaleSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aagSaleSubMainScrollPositionProvider'의 notifier를 읽어옴.
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (saleSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(aagSaleSubMainScrollPositionProvider);
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aagSaleSubMainLargeBannerPageProvider,
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aagSaleSubMainSmall1BannerPageProvider,
                                    ...
                                    bannerImagesProvider:
                                        aagSaleSubMainSmall1BannerImagesProvider,
                                    ...
                                    onPageTap: (context, index) =>
                                        ...
                                        aagOnSmallBannerTap(
                                            ...
                                            ref
                                                    .watch(
                                                        aagCardiganMainSmall1BannerImagesProvider)
                                                    .value ??
                                                [],
                                            ref // Provider의 참조를 전달함
                                            ),
                            ...
                            AagPriceAndDiscountPercentSortButtons<
                              ...
                              productListProvider:
                                  aagSaleSubMainProductListProvider,
                              // 특가 상품 제품 리스트 프로바이더 전달
                              sortButtonProvider:
                                  aagSaleSubMainSortButtonProvider, // 할인 정렬 버튼 프로바이더 전달
                            ),
                            // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: interval1Y),
