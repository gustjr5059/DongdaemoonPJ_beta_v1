...
class _AagSaleSubMainScreenState extends ConsumerState<AagSaleSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aagSaleSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aagSaleSubMainSmall1BannerImagesProvider).value ?? [], ref),
