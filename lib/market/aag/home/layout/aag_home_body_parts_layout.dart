...
import '../../product/layout/aag_product_body_parts_layout.dart';
import '../../product/provider/aag_product_all_providers.dart';
import '../../product/view/main_screen/aag_blouse_main_screen.dart';
import '../../product/view/main_screen/aag_cardigan_main_screen.dart';
import '../../product/view/main_screen/aag_coat_main_screen.dart';
import '../../product/view/main_screen/aag_jean_main_screen.dart';
import '../../product/view/main_screen/aag_mtm_main_screen.dart';
import '../../product/view/main_screen/aag_neat_main_screen.dart';
import '../../product/view/main_screen/aag_onepiece_main_screen.dart';
import '../../product/view/main_screen/aag_paeding_main_screen.dart';
import '../../product/view/main_screen/aag_pants_main_screen.dart';
import '../../product/view/main_screen/aag_pola_main_screen.dart';
import '../../product/view/main_screen/aag_shirt_main_screen.dart';
import '../../product/view/main_screen/aag_skirt_main_screen.dart';
import '../provider/aag_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aagOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AagNeatMainScreen(),
    AagPolaMainScreen(),
    AagOnepieceMainScreen(),
    AagPantsMainScreen(),
    AagJeanMainScreen(),
    AagSkirtMainScreen(),
    AagPaedingMainScreen(),
    AagCoatMainScreen(),
    AagCardiganMainScreen(),
  ];
...
Widget aagBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AagProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aagNewProductRepositoryProvider); // aagNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aagBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AagProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aagBestProductRepositoryProvider); // aagBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aagBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AagProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aagSaleProductRepositoryProvider); // aagSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aagBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AagProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aagSpringProductRepositoryProvider); // aagSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aagBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AagProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aagSummerProductRepositoryProvider); // aagSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aagBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AagProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aagAutumnProductRepositoryProvider); // aagAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aagBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AagProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aagWinterProductRepositoryProvider); // aagWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AagEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AagEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AagEventPosterImgSectionList();

  @override
  _AagEventPosterImgSectionListState createState() =>
      _AagEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AagEventPosterImgSectionListState
    extends ConsumerState<AagEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aagEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aagEventPosterScrollPositionProvider.notifier).state =
...
Widget aagBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AagEventPosterImgSectionList(), // AagEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
