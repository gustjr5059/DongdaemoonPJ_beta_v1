...
// ------ AagHomeSmall1BannerRepository 클래스 시작
// 'AagHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AagHomeSmall1BannerRepository {
  ...
  AagHomeSmall1BannerRepository(this.firestore);
...
// ------ AagHomeSmall1BannerRepository 클래스 끝

// ------ AagHomeSmall2BannerRepository 클래스 시작
// 'AagHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AagHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AagHomeSmall2BannerRepository(this.firestore);
...
// ------ AagHomeSmall2BannerRepository 클래스 끝

// ------ AagHomeSmall3BannerRepository 클래스 시작
// 'AagHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AagHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AagHomeSmall3BannerRepository(this.firestore);
...
// ------ AagHomeSmall3BannerRepository 클래스 끝