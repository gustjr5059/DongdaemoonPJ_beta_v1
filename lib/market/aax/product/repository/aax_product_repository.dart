...
class AaxNewProductRepository {
  ...
  List<String> collections = [
    'Aax1B1', 'Aax2B1', 'Aax3B1', 'Aax4B1', 'Aax5B1', 'Aax6B1',
    'Aax7B1', 'Aax8B1', 'Aax9B1', 'Aax10B1', 'Aax11B1', 'Aax12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_24')
          .doc(mainCollection) // 'Aax10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aax10B1', 'Aax2B1' 등)
...
class AaxBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aax1B2', 'Aax2B2', 'Aax3B2', 'Aax4B2', 'Aax5B2', 'Aax6B2',
    'Aax7B2', 'Aax8B2', 'Aax9B2', 'Aax10B2', 'Aax11B2', 'Aax12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxBestProductRepository(this.firestore); // 생성자
...
class AaxSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aax1B3', 'Aax2B3', 'Aax3B3', 'Aax4B3', 'Aax5B3', 'Aax6B3',
    'Aax7B3', 'Aax8B3', 'Aax9B3', 'Aax10B3', 'Aax11B3', 'Aax12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxSaleProductRepository(this.firestore); // 생성자
...
class AaxSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aax1B4', 'Aax2B4', 'Aax3B4', 'Aax4B4', 'Aax5B4', 'Aax6B4',
    'Aax7B4', 'Aax8B4', 'Aax9B4', 'Aax10B4', 'Aax11B4', 'Aax12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxSpringProductRepository(this.firestore); // 생성자
...
class AaxSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aax1B5', 'Aax2B5', 'Aax3B5', 'Aax4B5', 'Aax5B5', 'Aax6B5',
    'Aax7B5', 'Aax8B5', 'Aax9B5', 'Aax10B5', 'Aax11B5', 'Aax12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxSummerProductRepository(this.firestore); // 생성자
...
class AaxAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aax1B6', 'Aax2B6', 'Aax3B6', 'Aax4B6', 'Aax5B6', 'Aax6B6',
    'Aax7B6', 'Aax8B6', 'Aax9B6', 'Aax10B6', 'Aax11B6', 'Aax12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxAutumnProductRepository(this.firestore); // 생성자
...
class AaxWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aax1B7', 'Aax2B7', 'Aax3B7', 'Aax4B7', 'Aax5B7', 'Aax6B7',
    'Aax7B7', 'Aax8B7', 'Aax9B7', 'Aax10B7', 'Aax11B7', 'Aax12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AaxMainCategoryProductsRepository 시작 부분
class AaxMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_24')
        .doc(mainCollection) // 'Aax10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aax10B1', 'Aax2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AaxSectionCategoryProductsRepository 시작 부분
class AaxSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaxSectionCategoryProductsRepository(this.firestore);
