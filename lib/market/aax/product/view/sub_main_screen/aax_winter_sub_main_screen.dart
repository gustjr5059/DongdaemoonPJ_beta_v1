...
class _AaxWinterSubMainScreenState extends ConsumerState<AaxWinterSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      height: winterSubMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaxWinterSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaxWinterSubMainSmall1BannerImagesProvider).value ?? [], ref),
      width: winterSubMainScreenSmallBannerWidth,
      height: winterSubMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
