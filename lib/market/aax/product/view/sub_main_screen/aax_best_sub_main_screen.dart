...
class _AaxBestSubMainScreenState extends ConsumerState<AaxBestSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaxBestSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaxBestSubMainSmall1BannerImagesProvider).value ?? [], ref),
