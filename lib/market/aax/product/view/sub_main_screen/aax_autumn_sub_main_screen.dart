...
class _AaxAutumnSubMainScreenState extends ConsumerState<AaxAutumnSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaxAutumnSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaxAutumnSubMainSmall1BannerImagesProvider).value ?? [], ref),
