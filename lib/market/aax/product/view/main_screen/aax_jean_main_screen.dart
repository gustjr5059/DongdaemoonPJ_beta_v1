...
class _AaxJeanMainScreenState extends ConsumerState<AaxJeanMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaxJeanMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaxJeanMainSmall1BannerImagesProvider).value ?? [], ref),
