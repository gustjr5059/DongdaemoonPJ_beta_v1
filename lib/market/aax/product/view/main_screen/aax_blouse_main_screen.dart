...
class _AaxBlouseMainScreenState extends ConsumerState<AaxBlouseMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaxBlouseMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaxBlouseMainSmall1BannerImagesProvider).value ?? [], ref),
