...
class _AaxPaedingMainScreenState extends ConsumerState<AaxPaedingMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaxPaedingMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaxPaedingMainSmall1BannerImagesProvider).value ?? [], ref),
