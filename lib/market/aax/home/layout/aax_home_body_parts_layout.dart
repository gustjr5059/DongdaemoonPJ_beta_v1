...
import '../../product/layout/aax_product_body_parts_layout.dart';
import '../../product/provider/aax_product_all_providers.dart';
import '../../product/view/main_screen/aax_blouse_main_screen.dart';
import '../../product/view/main_screen/aax_cardigan_main_screen.dart';
import '../../product/view/main_screen/aax_coat_main_screen.dart';
import '../../product/view/main_screen/aax_jean_main_screen.dart';
import '../../product/view/main_screen/aax_mtm_main_screen.dart';
import '../../product/view/main_screen/aax_neat_main_screen.dart';
import '../../product/view/main_screen/aax_onepiece_main_screen.dart';
import '../../product/view/main_screen/aax_paeding_main_screen.dart';
import '../../product/view/main_screen/aax_pants_main_screen.dart';
import '../../product/view/main_screen/aax_pola_main_screen.dart';
import '../../product/view/main_screen/aax_shirt_main_screen.dart';
import '../../product/view/main_screen/aax_skirt_main_screen.dart';
import '../provider/aax_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aaxOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AaxNeatMainScreen(),
    AaxPolaMainScreen(),
    AaxOnepieceMainScreen(),
    AaxPantsMainScreen(),
    AaxJeanMainScreen(),
    AaxSkirtMainScreen(),
    AaxPaedingMainScreen(),
    AaxCoatMainScreen(),
    AaxCardiganMainScreen(),
  ];
...
Widget aaxBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AaxProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aaxNewProductRepositoryProvider); // aaxNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaxBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaxProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaxBestProductRepositoryProvider); // aaxBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaxBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaxProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaxSaleProductRepositoryProvider); // aaxSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaxBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaxProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaxSpringProductRepositoryProvider); // aaxSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaxBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaxProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaxSummerProductRepositoryProvider); // aaxSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaxBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaxProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaxAutumnProductRepositoryProvider); // aaxAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaxBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaxProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaxWinterProductRepositoryProvider); // aaxWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AaxEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AaxEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AaxEventPosterImgSectionList();

  @override
  _AaxEventPosterImgSectionListState createState() =>
      _AaxEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AaxEventPosterImgSectionListState
    extends ConsumerState<AaxEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aaxEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aaxEventPosterScrollPositionProvider.notifier).state =
...
Widget aaxBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
