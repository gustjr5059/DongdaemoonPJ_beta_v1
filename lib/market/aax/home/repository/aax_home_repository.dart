...
// ------ AaxHomeSmall1BannerRepository 클래스 시작
// 'AaxHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaxHomeSmall1BannerRepository {
  ...
  AaxHomeSmall1BannerRepository(this.firestore);
...
// ------ AaxHomeSmall1BannerRepository 클래스 끝

// ------ AaxHomeSmall2BannerRepository 클래스 시작
// 'AaxHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaxHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaxHomeSmall2BannerRepository(this.firestore);
...
// ------ AaxHomeSmall2BannerRepository 클래스 끝

// ------ AaxHomeSmall3BannerRepository 클래스 시작
// 'AaxHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaxHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaxHomeSmall3BannerRepository(this.firestore);
...
// ------ AaxHomeSmall3BannerRepository 클래스 끝