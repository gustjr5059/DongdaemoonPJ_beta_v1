...
class AawNewProductRepository {
  ...
  List<String> collections = [
    'Aaw1B1', 'Aaw2B1', 'Aaw3B1', 'Aaw4B1', 'Aaw5B1', 'Aaw6B1',
    'Aaw7B1', 'Aaw8B1', 'Aaw9B1', 'Aaw10B1', 'Aaw11B1', 'Aaw12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_23')
          .doc(mainCollection) // 'Aaw10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aaw10B1', 'Aaw2B1' 등)
...
class AawBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaw1B2', 'Aaw2B2', 'Aaw3B2', 'Aaw4B2', 'Aaw5B2', 'Aaw6B2',
    'Aaw7B2', 'Aaw8B2', 'Aaw9B2', 'Aaw10B2', 'Aaw11B2', 'Aaw12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawBestProductRepository(this.firestore); // 생성자
...
class AawSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaw1B3', 'Aaw2B3', 'Aaw3B3', 'Aaw4B3', 'Aaw5B3', 'Aaw6B3',
    'Aaw7B3', 'Aaw8B3', 'Aaw9B3', 'Aaw10B3', 'Aaw11B3', 'Aaw12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawSaleProductRepository(this.firestore); // 생성자
...
class AawSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaw1B4', 'Aaw2B4', 'Aaw3B4', 'Aaw4B4', 'Aaw5B4', 'Aaw6B4',
    'Aaw7B4', 'Aaw8B4', 'Aaw9B4', 'Aaw10B4', 'Aaw11B4', 'Aaw12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawSpringProductRepository(this.firestore); // 생성자
...
class AawSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaw1B5', 'Aaw2B5', 'Aaw3B5', 'Aaw4B5', 'Aaw5B5', 'Aaw6B5',
    'Aaw7B5', 'Aaw8B5', 'Aaw9B5', 'Aaw10B5', 'Aaw11B5', 'Aaw12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawSummerProductRepository(this.firestore); // 생성자
...
class AawAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaw1B6', 'Aaw2B6', 'Aaw3B6', 'Aaw4B6', 'Aaw5B6', 'Aaw6B6',
    'Aaw7B6', 'Aaw8B6', 'Aaw9B6', 'Aaw10B6', 'Aaw11B6', 'Aaw12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawAutumnProductRepository(this.firestore); // 생성자
...
class AawWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaw1B7', 'Aaw2B7', 'Aaw3B7', 'Aaw4B7', 'Aaw5B7', 'Aaw6B7',
    'Aaw7B7', 'Aaw8B7', 'Aaw9B7', 'Aaw10B7', 'Aaw11B7', 'Aaw12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AawMainCategoryProductsRepository 시작 부분
class AawMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_23')
        .doc(mainCollection) // 'Aaw10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aaw10B1', 'Aaw2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AawSectionCategoryProductsRepository 시작 부분
class AawSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AawSectionCategoryProductsRepository(this.firestore);
