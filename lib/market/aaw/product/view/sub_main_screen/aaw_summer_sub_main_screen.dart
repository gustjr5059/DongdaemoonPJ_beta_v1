...
class _AawSummerSubMainScreenState extends ConsumerState<AawSummerSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      height: summerSubMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aawSummerSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aawSummerSubMainSmall1BannerImagesProvider).value ?? [], ref),
      width: summerSubMainScreenSmallBannerWidth,
      height: summerSubMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
                            ...
                            if (small1BannerWidget is! SizedBox) ...[
                              ...
                              CommonCardView(
                                content: Container(
                                  ...
                                  child: SizedBox(
                                    height: summerSubMainScreenSmallBannerViewHeight,
