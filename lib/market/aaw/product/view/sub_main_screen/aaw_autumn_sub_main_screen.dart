...
class _AawAutumnSubMainScreenState extends ConsumerState<AawAutumnSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      height: autumnSubMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aawAutumnSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aawAutumnSubMainSmall1BannerImagesProvider).value ?? [], ref),
      width: autumnSubMainScreenSmallBannerWidth,
      height: autumnSubMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
                            ...
                            if (small1BannerWidget is! SizedBox) ...[
                              ...
                              CommonCardView(
                                content: Container(
                                  ...
                                  child: SizedBox(
                                    height: autumnSubMainScreenSmallBannerViewHeight,
