...
class _AawBlouseMainScreenState extends ConsumerState<AawBlouseMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aawBlouseMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aawBlouseMainSmall1BannerImagesProvider).value ?? [], ref),
