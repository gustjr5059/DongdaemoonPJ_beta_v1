...
class _AawMtmMainScreenState extends ConsumerState<AawMtmMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: mtmMainScreenLargeBannerWidth,
      height: mtmMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aawMtmMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aawMtmMainSmall1BannerImagesProvider).value ?? [], ref),
      width: mtmMainScreenSmallBannerWidth,
      height: mtmMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
