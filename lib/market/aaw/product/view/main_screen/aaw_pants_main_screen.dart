...
class _AawPantsMainScreenState extends ConsumerState<AawPantsMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: pantsMainScreenLargeBannerWidth,
      height: pantsMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aawPantsMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aawPantsMainSmall1BannerImagesProvider).value ?? [], ref),
      width: pantsMainScreenSmallBannerWidth,
      height: pantsMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
