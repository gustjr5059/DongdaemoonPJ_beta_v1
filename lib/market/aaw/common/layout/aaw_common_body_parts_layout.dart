...
import '../../product/provider/aaw_product_state_provider.dart';
...
void aawOnLargeBannerTap(BuildContext context, int index,
...
void aawOnSmallBannerTap(BuildContext context, int index,
...
class AawStoreInitializer {
  final WidgetRef ref;

  AawStoreInitializer(this.ref);
