...
// ------ AawHomeSmall1BannerRepository 클래스 시작
// 'AawHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AawHomeSmall1BannerRepository {
  ...
  AawHomeSmall1BannerRepository(this.firestore);
...
// ------ AawHomeSmall1BannerRepository 클래스 끝

// ------ AawHomeSmall2BannerRepository 클래스 시작
// 'AawHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AawHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AawHomeSmall2BannerRepository(this.firestore);
...
// ------ AawHomeSmall2BannerRepository 클래스 끝

// ------ AawHomeSmall3BannerRepository 클래스 시작
// 'AawHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AawHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AawHomeSmall3BannerRepository(this.firestore);
...
// ------ AawHomeSmall3BannerRepository 클래스 끝