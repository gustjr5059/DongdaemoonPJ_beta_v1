...
import '../../product/layout/aaw_product_body_parts_layout.dart';
import '../../product/provider/aaw_product_all_providers.dart';
import '../../product/view/main_screen/aaw_blouse_main_screen.dart';
import '../../product/view/main_screen/aaw_cardigan_main_screen.dart';
import '../../product/view/main_screen/aaw_coat_main_screen.dart';
import '../../product/view/main_screen/aaw_jean_main_screen.dart';
import '../../product/view/main_screen/aaw_mtm_main_screen.dart';
import '../../product/view/main_screen/aaw_neat_main_screen.dart';
import '../../product/view/main_screen/aaw_onepiece_main_screen.dart';
import '../../product/view/main_screen/aaw_paeding_main_screen.dart';
import '../../product/view/main_screen/aaw_pants_main_screen.dart';
import '../../product/view/main_screen/aaw_pola_main_screen.dart';
import '../../product/view/main_screen/aaw_shirt_main_screen.dart';
import '../../product/view/main_screen/aaw_skirt_main_screen.dart';
import '../provider/aaw_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aawOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AawNeatMainScreen(),
    AawPolaMainScreen(),
    AawOnepieceMainScreen(),
    AawPantsMainScreen(),
    AawJeanMainScreen(),
    AawSkirtMainScreen(),
    AawPaedingMainScreen(),
    AawCoatMainScreen(),
    AawCardiganMainScreen(),
  ];
...
Widget aawBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AawProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aawNewProductRepositoryProvider); // aawNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aawBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AawProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aawBestProductRepositoryProvider); // aawBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aawBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AawProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aawSaleProductRepositoryProvider); // aawSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aawBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AawProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aawSpringProductRepositoryProvider); // aawSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aawBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AawProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aawSummerProductRepositoryProvider); // aawSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aawBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AawProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aawAutumnProductRepositoryProvider); // aawAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aawBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AawProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aawWinterProductRepositoryProvider); // aawWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AawEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AawEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AawEventPosterImgSectionList();

  @override
  _AawEventPosterImgSectionListState createState() =>
      _AawEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AawEventPosterImgSectionListState
    extends ConsumerState<AawEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aawEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aawEventPosterScrollPositionProvider.notifier).state =
...
Widget aawBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AawEventPosterImgSectionList(), // AawEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
