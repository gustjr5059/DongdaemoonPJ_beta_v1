...
class _AbbOnepieceMainScreenState extends ConsumerState<AbbOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abbOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abbOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
