...
class _AbbNeatMainScreenState extends ConsumerState<AbbNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      bannerImagesProvider: abbAllLargeBannerImagesProvider,
      onPageTap: (context, index) =>
          onLargeBannerTap(context, index, ref.watch(abbAllLargeBannerImagesProvider).value ?? [], ref),
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abbNeatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abbNeatMainSmall1BannerImagesProvider).value ?? [], ref),
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: buildCommonAppBar(
                    ...
                    titleImageFieldName: 'title_img_28',
