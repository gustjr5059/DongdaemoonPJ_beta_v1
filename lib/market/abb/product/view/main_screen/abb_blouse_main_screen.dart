...
class _AbbBlouseMainScreenState extends ConsumerState<AbbBlouseMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abbBlouseMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abbBlouseMainSmall1BannerImagesProvider).value ?? [], ref),
