...
// AbbWinterSubMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AbbWinterSubMainScreen extends ConsumerStatefulWidget {
  const AbbWinterSubMainScreen({Key? key}) : super(key: key);

  @override
  _AbbWinterSubMainScreenState createState() => _AbbWinterSubMainScreenState();
}

// _AbbWinterSubMainScreenState 클래스 시작
// _AbbWinterSubMainScreenState 클래스는 AbbWinterSubMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AbbWinterSubMainScreenState extends ConsumerState<AbbWinterSubMainScreen>
  ...
  // abbWinterSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(abbWinterSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // abbWinterSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'abbWinterSubMainScrollPositionProvider'의 notifier를 읽어옴.
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (winterSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(abbWinterSubMainScrollPositionProvider);
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        abbWinterSubMainLargeBannerPageProvider,
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        abbWinterSubMainSmall1BannerPageProvider,
                                    ...
                                    bannerImagesProvider:
                                        abbWinterSubMainSmall1BannerImagesProvider,
                            ...
                            AbbPriceAndDiscountPercentSortButtons<
                              ...
                              productListProvider:
                                  abbWinterSubMainProductListProvider,
                              // 겨울 제품 리스트 프로바이더 전달
                              sortButtonProvider:
                                  abbWinterSubMainSortButtonProvider, // 겨울 정렬 버튼 프로바이더 전달
                            ),
                            // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: interval1Y),
...
// _AbbWinterSubMainScreenState 클래스 끝
