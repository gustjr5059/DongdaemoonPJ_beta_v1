...
class _AbbSummerSubMainScreenState extends ConsumerState<AbbSummerSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abbSummerSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abbSummerSubMainSmall1BannerImagesProvider).value ?? [], ref),
