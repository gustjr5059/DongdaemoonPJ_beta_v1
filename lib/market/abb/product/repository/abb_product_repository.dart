...
class AbbNewProductRepository {
  ...
  List<String> collections = [
    'Abb1B1', 'Abb2B1', 'Abb3B1', 'Abb4B1', 'Abb5B1', 'Abb6B1',
    'Abb7B1', 'Abb8B1', 'Abb9B1', 'Abb10B1', 'Abb11B1', 'Abb12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_28')
          .doc(mainCollection) // 'Abb10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Abb10B1', 'Abb2B1' 등)
...
class AbbBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abb1B2', 'Abb2B2', 'Abb3B2', 'Abb4B2', 'Abb5B2', 'Abb6B2',
    'Abb7B2', 'Abb8B2', 'Abb9B2', 'Abb10B2', 'Abb11B2', 'Abb12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbBestProductRepository(this.firestore); // 생성자
...
class AbbSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abb1B3', 'Abb2B3', 'Abb3B3', 'Abb4B3', 'Abb5B3', 'Abb6B3',
    'Abb7B3', 'Abb8B3', 'Abb9B3', 'Abb10B3', 'Abb11B3', 'Abb12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbSaleProductRepository(this.firestore); // 생성자
...
class AbbSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abb1B4', 'Abb2B4', 'Abb3B4', 'Abb4B4', 'Abb5B4', 'Abb6B4',
    'Abb7B4', 'Abb8B4', 'Abb9B4', 'Abb10B4', 'Abb11B4', 'Abb12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbSpringProductRepository(this.firestore); // 생성자
...
class AbbSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abb1B5', 'Abb2B5', 'Abb3B5', 'Abb4B5', 'Abb5B5', 'Abb6B5',
    'Abb7B5', 'Abb8B5', 'Abb9B5', 'Abb10B5', 'Abb11B5', 'Abb12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbSummerProductRepository(this.firestore); // 생성자
...
class AbbAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abb1B6', 'Abb2B6', 'Abb3B6', 'Abb4B6', 'Abb5B6', 'Abb6B6',
    'Abb7B6', 'Abb8B6', 'Abb9B6', 'Abb10B6', 'Abb11B6', 'Abb12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbAutumnProductRepository(this.firestore); // 생성자
...
class AbbWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abb1B7', 'Abb2B7', 'Abb3B7', 'Abb4B7', 'Abb5B7', 'Abb6B7',
    'Abb7B7', 'Abb8B7', 'Abb9B7', 'Abb10B7', 'Abb11B7', 'Abb12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AbbMainCategoryProductsRepository 시작 부분
class AbbMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_28')
        .doc(mainCollection) // 'Abb10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Abb10B1', 'Abb2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AbbSectionCategoryProductsRepository 시작 부분
class AbbSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbbSectionCategoryProductsRepository(this.firestore);
