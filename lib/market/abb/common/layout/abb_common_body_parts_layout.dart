...
import '../../product/provider/abb_product_state_provider.dart';
...
void abbOnLargeBannerTap(BuildContext context, int index,
...
void abbOnSmallBannerTap(BuildContext context, int index,
...
class AbbStoreInitializer {
  final WidgetRef ref;

  AbbStoreInitializer(this.ref);
