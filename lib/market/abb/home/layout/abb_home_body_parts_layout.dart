...
import '../../product/layout/abb_product_body_parts_layout.dart';
import '../../product/provider/abb_product_all_providers.dart';
import '../../product/view/main_screen/abb_blouse_main_screen.dart';
import '../../product/view/main_screen/abb_cardigan_main_screen.dart';
import '../../product/view/main_screen/abb_coat_main_screen.dart';
import '../../product/view/main_screen/abb_jean_main_screen.dart';
import '../../product/view/main_screen/abb_mtm_main_screen.dart';
import '../../product/view/main_screen/abb_neat_main_screen.dart';
import '../../product/view/main_screen/abb_onepiece_main_screen.dart';
import '../../product/view/main_screen/abb_paeding_main_screen.dart';
import '../../product/view/main_screen/abb_pants_main_screen.dart';
import '../../product/view/main_screen/abb_pola_main_screen.dart';
import '../../product/view/main_screen/abb_shirt_main_screen.dart';
import '../../product/view/main_screen/abb_skirt_main_screen.dart';
import '../provider/abb_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void abbOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AbbNeatMainScreen(),
    AbbPolaMainScreen(),
    AbbOnepieceMainScreen(),
    AbbPantsMainScreen(),
    AbbJeanMainScreen(),
    AbbSkirtMainScreen(),
    AbbPaedingMainScreen(),
    AbbCoatMainScreen(),
    AbbCardiganMainScreen(),
  ];
...
Widget abbBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbbProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    abbNewProductRepositoryProvider); // abbNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abbBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbbProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abbBestProductRepositoryProvider); // abbBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abbBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbbProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abbSaleProductRepositoryProvider); // abbSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abbBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbbProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abbSpringProductRepositoryProvider); // abbSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abbBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbbProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abbSummerProductRepositoryProvider); // abbSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abbBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbbProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abbAutumnProductRepositoryProvider); // abbAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abbBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbbProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abbWinterProductRepositoryProvider); // abbWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AbbEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AbbEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AbbEventPosterImgSectionList();

  @override
  _AbbEventPosterImgSectionListState createState() =>
      _AbbEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AbbEventPosterImgSectionListState
    extends ConsumerState<AbbEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(abbEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(abbEventPosterScrollPositionProvider.notifier).state =
...
Widget abbBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbbEventPosterImgSectionList(), // AbbEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
