...
class AasNewProductRepository {
  ...
  List<String> collections = [
    'Aas1B1', 'Aas2B1', 'Aas3B1', 'Aas4B1', 'Aas5B1', 'Aas6B1',
    'Aas7B1', 'Aas8B1', 'Aas9B1', 'Aas10B1', 'Aas11B1', 'Aas12B1'
  ];
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_19')
          .doc(mainCollection) // 'Aas10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aas10B1', 'Aas2B1' 등)
...
class AasBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aas1B2', 'Aas2B2', 'Aas3B2', 'Aas4B2', 'Aas5B2', 'Aas6B2',
    'Aas7B2', 'Aas8B2', 'Aas9B2', 'Aas10B2', 'Aas11B2', 'Aas12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장
...
class AasSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aas1B3', 'Aas2B3', 'Aas3B3', 'Aas4B3', 'Aas5B3', 'Aas6B3',
    'Aas7B3', 'Aas8B3', 'Aas9B3', 'Aas10B3', 'Aas11B3', 'Aas12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장
...
class AasSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aas1B4', 'Aas2B4', 'Aas3B4', 'Aas4B4', 'Aas5B4', 'Aas6B4',
    'Aas7B4', 'Aas8B4', 'Aas9B4', 'Aas10B4', 'Aas11B4', 'Aas12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장
...
class AasSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aas1B5', 'Aas2B5', 'Aas3B5', 'Aas4B5', 'Aas5B5', 'Aas6B5',
    'Aas7B5', 'Aas8B5', 'Aas9B5', 'Aas10B5', 'Aas11B5', 'Aas12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장
...
class AasAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aas1B6', 'Aas2B6', 'Aas3B6', 'Aas4B6', 'Aas5B6', 'Aas6B6',
    'Aas7B6', 'Aas8B6', 'Aas9B6', 'Aas10B6', 'Aas11B6', 'Aas12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장
...
class AasWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aas1B7', 'Aas2B7', 'Aas3B7', 'Aas4B7', 'Aas5B7', 'Aas6B7',
    'Aas7B7', 'Aas8B7', 'Aas9B7', 'Aas10B7', 'Aas11B7', 'Aas12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AasMainCategoryProductsRepository 시작 부분
class AasMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AasMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_19')
        .doc(mainCollection) // 'Aas10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aas10B1', 'Aas2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AasSectionCategoryProductsRepository 시작 부분
class AasSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AasSectionCategoryProductsRepository(this.firestore);
