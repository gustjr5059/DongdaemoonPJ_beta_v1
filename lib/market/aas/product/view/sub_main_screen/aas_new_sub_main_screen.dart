...
class _AasNewSubMainScreenState extends ConsumerState<AasNewSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aasNewSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aasNewSubMainSmall1BannerImagesProvider).value ?? [], ref),
