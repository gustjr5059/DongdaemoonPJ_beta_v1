...
class _AasPolaMainScreenState extends ConsumerState<AasPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aasPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aasPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AasCardiganMainScreenState 클래스 끝// _AasCardiganMainScreenState 클래스 끝