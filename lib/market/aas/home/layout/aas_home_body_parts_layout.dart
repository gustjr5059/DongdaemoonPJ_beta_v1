...
import '../../product/layout/aas_product_body_parts_layout.dart';
import '../../product/provider/aas_product_all_providers.dart';
import '../../product/view/main_screen/aas_blouse_main_screen.dart';
import '../../product/view/main_screen/aas_cardigan_main_screen.dart';
import '../../product/view/main_screen/aas_coat_main_screen.dart';
import '../../product/view/main_screen/aas_jean_main_screen.dart';
import '../../product/view/main_screen/aas_mtm_main_screen.dart';
import '../../product/view/main_screen/aas_neat_main_screen.dart';
import '../../product/view/main_screen/aas_onepiece_main_screen.dart';
import '../../product/view/main_screen/aas_paeding_main_screen.dart';
import '../../product/view/main_screen/aas_pants_main_screen.dart';
import '../../product/view/main_screen/aas_pola_main_screen.dart';
import '../../product/view/main_screen/aas_shirt_main_screen.dart';
import '../../product/view/main_screen/aas_skirt_main_screen.dart';
import '../provider/aas_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aasOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AasNeatMainScreen(),
    AasPolaMainScreen(),
    AasOnepieceMainScreen(),
    AasPantsMainScreen(),
    AasJeanMainScreen(),
    AasSkirtMainScreen(),
    AasPaedingMainScreen(),
    AasCoatMainScreen(),
    AasCardiganMainScreen(),
  ];
...
Widget aasBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AasProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aasNewProductRepositoryProvider); // aasNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aasBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AasProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aasBestProductRepositoryProvider); // aasBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aasBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AasProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aasSaleProductRepositoryProvider); // aasSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aasBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AasProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aasSpringProductRepositoryProvider); // aasSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aasBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AasProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aasSummerProductRepositoryProvider); // aasSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aasBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AasProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aasAutumnProductRepositoryProvider); // aasAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aasBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AasProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aasWinterProductRepositoryProvider); // aasWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AasEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AasEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AasEventPosterImgSectionList();

  @override
  _AasEventPosterImgSectionListState createState() =>
      _AasEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AasEventPosterImgSectionListState
    extends ConsumerState<AasEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aasEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aasEventPosterScrollPositionProvider.notifier).state =
...
Widget aasBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AasEventPosterImgSectionList(), // AasEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
