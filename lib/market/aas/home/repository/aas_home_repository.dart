...
// ------ AasHomeSmall1BannerRepository 클래스 시작
// 'AasHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AasHomeSmall1BannerRepository {
  ...
  AasHomeSmall1BannerRepository(this.firestore);
...
// ------ AasHomeSmall1BannerRepository 클래스 끝

// ------ AasHomeSmall2BannerRepository 클래스 시작
// 'AasHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AasHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AasHomeSmall2BannerRepository(this.firestore);
...
// ------ AasHomeSmall2BannerRepository 클래스 끝

// ------ AasHomeSmall3BannerRepository 클래스 시작
// 'AasHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AasHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AasHomeSmall3BannerRepository(this.firestore);
...
// ------ AasHomeSmall3BannerRepository 클래스 끝