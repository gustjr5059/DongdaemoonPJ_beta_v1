...
// ------ AamHomeSmall1BannerRepository 클래스 시작
// 'AamHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AamHomeSmall1BannerRepository {
  ...
  AamHomeSmall1BannerRepository(this.firestore);
...
// ------ AamHomeSmall1BannerRepository 클래스 끝

// ------ AamHomeSmall2BannerRepository 클래스 시작
// 'AamHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AamHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AamHomeSmall2BannerRepository(this.firestore);
...
// ------ AamHomeSmall2BannerRepository 클래스 끝

// ------ AamHomeSmall3BannerRepository 클래스 시작
// 'AamHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AamHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AamHomeSmall3BannerRepository(this.firestore);
...
// ------ AamHomeSmall3BannerRepository 클래스 끝