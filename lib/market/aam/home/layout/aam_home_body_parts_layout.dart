...
import '../../product/layout/aam_product_body_parts_layout.dart';
import '../../product/provider/aam_product_all_providers.dart';
import '../../product/view/main_screen/aam_blouse_main_screen.dart';
import '../../product/view/main_screen/aam_cardigan_main_screen.dart';
import '../../product/view/main_screen/aam_coat_main_screen.dart';
import '../../product/view/main_screen/aam_jean_main_screen.dart';
import '../../product/view/main_screen/aam_mtm_main_screen.dart';
import '../../product/view/main_screen/aam_neat_main_screen.dart';
import '../../product/view/main_screen/aam_onepiece_main_screen.dart';
import '../../product/view/main_screen/aam_paeding_main_screen.dart';
import '../../product/view/main_screen/aam_pants_main_screen.dart';
import '../../product/view/main_screen/aam_pola_main_screen.dart';
import '../../product/view/main_screen/aam_shirt_main_screen.dart';
import '../../product/view/main_screen/aam_skirt_main_screen.dart';
import '../provider/aam_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aamOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AamNeatMainScreen(),
    AamPolaMainScreen(),
    AamOnepieceMainScreen(),
    AamPantsMainScreen(),
    AamJeanMainScreen(),
    AamSkirtMainScreen(),
    AamPaedingMainScreen(),
    AamCoatMainScreen(),
    AamCardiganMainScreen(),
  ];
...
Widget aamBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AamProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aamNewProductRepositoryProvider); // aamNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aamBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AamProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aamBestProductRepositoryProvider); // aamBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aamBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AamProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aamSaleProductRepositoryProvider); // aamSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aamBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AamProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aamSpringProductRepositoryProvider); // aamSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aamBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AamProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aamSummerProductRepositoryProvider); // aamSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aamBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AamProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aamAutumnProductRepositoryProvider); // aamAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aamBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AamProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aamWinterProductRepositoryProvider); // aamWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AamEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AamEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AamEventPosterImgSectionList();

  @override
  _AamEventPosterImgSectionListState createState() =>
      _AamEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AamEventPosterImgSectionListState
    extends ConsumerState<AamEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aamEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aamEventPosterScrollPositionProvider.notifier).state =
...
Widget aamBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AamEventPosterImgSectionList(), // AamEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
