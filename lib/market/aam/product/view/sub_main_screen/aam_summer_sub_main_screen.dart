...
class _AamSummerSubMainScreenState extends ConsumerState<AamSummerSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aamSummerSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aamSummerSubMainSmall1BannerImagesProvider).value ?? [], ref),
