...
class _AamPolaMainScreenState extends ConsumerState<AamPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aamPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aamPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AamCardiganMainScreenState 클래스 끝_AamCardiganMainScreenState 클래스 끝