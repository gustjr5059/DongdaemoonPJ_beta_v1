...
class _AamPaedingMainScreenState extends ConsumerState<AamPaedingMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aamPaedingMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aamPaedingMainSmall1BannerImagesProvider).value ?? [], ref),
