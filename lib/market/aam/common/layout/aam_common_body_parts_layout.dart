...
import '../../product/provider/aam_product_state_provider.dart';
...
void aamOnLargeBannerTap(BuildContext context, int index,
...
void aamOnSmallBannerTap(BuildContext context, int index,
...
class AamStoreInitializer {
  final WidgetRef ref;

  AamStoreInitializer(this.ref);
