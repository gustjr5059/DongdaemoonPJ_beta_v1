...
class _AazNeatMainScreenState extends ConsumerState<AazNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      bannerImagesProvider: aazAllLargeBannerImagesProvider,
      onPageTap: (context, index) =>
          onLargeBannerTap(context, index, ref.watch(aazAllLargeBannerImagesProvider).value ?? [], ref),
      width: neatMainScreenLargeBannerWidth,
      height: neatMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aazNeatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aazNeatMainSmall1BannerImagesProvider).value ?? [], ref),
      width: neatMainScreenSmallBannerWidth,
      height: neatMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: buildCommonAppBar(
                    ...
                    titleImageFieldName: 'title_img_26',
