...
class _AazNeatMainScreenState extends ConsumerState<AazNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double neatMainScreenLargeBannerHeight = screenSize.height * (378 / referenceHeight); // 대배너 이미지 높이
    final double neatMainLargeBannerViewHeight =
    ...
    final double neatMainScreenSmallBannerHeight = screenSize.height * (90 / referenceHeight); // 소배너 이미지 높이
    final double neatMainScreenSmallBannerViewHeight =
