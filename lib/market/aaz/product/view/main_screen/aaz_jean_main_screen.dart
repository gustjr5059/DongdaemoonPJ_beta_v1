...
class _AazJeanMainScreenState extends ConsumerState<AazJeanMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aazJeanMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aazJeanMainSmall1BannerImagesProvider).value ?? [], ref),
