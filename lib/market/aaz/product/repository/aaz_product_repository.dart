...
class AazNewProductRepository {
  ...
  List<String> collections = [
    'Aaz1B1', 'Aaz2B1', 'Aaz3B1', 'Aaz4B1', 'Aaz5B1', 'Aaz6B1',
    'Aaz7B1', 'Aaz8B1', 'Aaz9B1', 'Aaz10B1', 'Aaz11B1', 'Aaz12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_26')
          .doc(mainCollection) // 'Aaz10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aaz10B1', 'Aaz2B1' 등)
...
class AazBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaz1B2', 'Aaz2B2', 'Aaz3B2', 'Aaz4B2', 'Aaz5B2', 'Aaz6B2',
    'Aaz7B2', 'Aaz8B2', 'Aaz9B2', 'Aaz10B2', 'Aaz11B2', 'Aaz12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazBestProductRepository(this.firestore); // 생성자
...
class AazSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaz1B3', 'Aaz2B3', 'Aaz3B3', 'Aaz4B3', 'Aaz5B3', 'Aaz6B3',
    'Aaz7B3', 'Aaz8B3', 'Aaz9B3', 'Aaz10B3', 'Aaz11B3', 'Aaz12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazSaleProductRepository(this.firestore); // 생성자
...
class AazSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaz1B4', 'Aaz2B4', 'Aaz3B4', 'Aaz4B4', 'Aaz5B4', 'Aaz6B4',
    'Aaz7B4', 'Aaz8B4', 'Aaz9B4', 'Aaz10B4', 'Aaz11B4', 'Aaz12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazSpringProductRepository(this.firestore); // 생성자
...
class AazSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaz1B5', 'Aaz2B5', 'Aaz3B5', 'Aaz4B5', 'Aaz5B5', 'Aaz6B5',
    'Aaz7B5', 'Aaz8B5', 'Aaz9B5', 'Aaz10B5', 'Aaz11B5', 'Aaz12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazSummerProductRepository(this.firestore); // 생성자
...
class AazAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaz1B6', 'Aaz2B6', 'Aaz3B6', 'Aaz4B6', 'Aaz5B6', 'Aaz6B6',
    'Aaz7B6', 'Aaz8B6', 'Aaz9B6', 'Aaz10B6', 'Aaz11B6', 'Aaz12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazAutumnProductRepository(this.firestore); // 생성자
...
class AazWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aaz1B7', 'Aaz2B7', 'Aaz3B7', 'Aaz4B7', 'Aaz5B7', 'Aaz6B7',
    'Aaz7B7', 'Aaz8B7', 'Aaz9B7', 'Aaz10B7', 'Aaz11B7', 'Aaz12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AazMainCategoryProductsRepository 시작 부분
class AazMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_26')
        .doc(mainCollection) // 'Aaz10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aaz10B1', 'Aaz2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AazSectionCategoryProductsRepository 시작 부분
class AazSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AazSectionCategoryProductsRepository(this.firestore);
