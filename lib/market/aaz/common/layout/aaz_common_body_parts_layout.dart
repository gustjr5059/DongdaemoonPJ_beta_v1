...
import '../../product/provider/aaz_product_state_provider.dart';
...
void aazOnLargeBannerTap(BuildContext context, int index,
...
void aazOnSmallBannerTap(BuildContext context, int index,
...
class AazStoreInitializer {
  final WidgetRef ref;

  AazStoreInitializer(this.ref);
