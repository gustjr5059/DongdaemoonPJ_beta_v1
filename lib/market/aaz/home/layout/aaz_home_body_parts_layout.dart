...
import '../../product/layout/aaz_product_body_parts_layout.dart';
import '../../product/provider/aaz_product_all_providers.dart';
import '../../product/view/main_screen/aaz_blouse_main_screen.dart';
import '../../product/view/main_screen/aaz_cardigan_main_screen.dart';
import '../../product/view/main_screen/aaz_coat_main_screen.dart';
import '../../product/view/main_screen/aaz_jean_main_screen.dart';
import '../../product/view/main_screen/aaz_mtm_main_screen.dart';
import '../../product/view/main_screen/aaz_neat_main_screen.dart';
import '../../product/view/main_screen/aaz_onepiece_main_screen.dart';
import '../../product/view/main_screen/aaz_paeding_main_screen.dart';
import '../../product/view/main_screen/aaz_pants_main_screen.dart';
import '../../product/view/main_screen/aaz_pola_main_screen.dart';
import '../../product/view/main_screen/aaz_shirt_main_screen.dart';
import '../../product/view/main_screen/aaz_skirt_main_screen.dart';
import '../provider/aaz_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aazOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AazNeatMainScreen(),
    AazPolaMainScreen(),
    AazOnepieceMainScreen(),
    AazPantsMainScreen(),
    AazJeanMainScreen(),
    AazSkirtMainScreen(),
    AazPaedingMainScreen(),
    AazCoatMainScreen(),
    AazCardiganMainScreen(),
  ];
...
Widget aazBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AazProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aazNewProductRepositoryProvider); // aazNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aazBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AazProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aazBestProductRepositoryProvider); // aazBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aazBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AazProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aazSaleProductRepositoryProvider); // aazSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aazBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AazProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aazSpringProductRepositoryProvider); // aazSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aazBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AazProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aazSummerProductRepositoryProvider); // aazSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aazBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AazProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aazAutumnProductRepositoryProvider); // aazAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aazBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AazProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aazWinterProductRepositoryProvider); // aazWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AazEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AazEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AazEventPosterImgSectionList();

  @override
  _AazEventPosterImgSectionListState createState() =>
      _AazEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AazEventPosterImgSectionListState
    extends ConsumerState<AazEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aazEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aazEventPosterScrollPositionProvider.notifier).state =
...
Widget aazBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AazEventPosterImgSectionList(), // AazEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
