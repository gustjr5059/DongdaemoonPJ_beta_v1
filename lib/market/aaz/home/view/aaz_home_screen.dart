...
// 현재 디렉토리의 부모 디렉토리에 위치한 provider 폴더에서 aaz_home_all_providers.dart 파일을 가져옵니다.
...
class _AazHomeMainScreenState extends ConsumerState<AazHomeMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // ------ aaz_common_body_parts_layout.dart 내 buildTopBarList, onTopBarTap 재사용하여 TopBar 구현 내용 끝
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aazHomeSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aazHomeSmall1BannerImagesProvider).value ?? [], ref),
    ...
    final small2BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aazHomeSmall2BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aazHomeSmall2BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
    ...
    final small3BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aazHomeSmall3BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aazHomeSmall3BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
