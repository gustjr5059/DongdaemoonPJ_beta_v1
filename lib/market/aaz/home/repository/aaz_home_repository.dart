...
// ------ AazHomeSmall1BannerRepository 클래스 시작
// 'AazHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AazHomeSmall1BannerRepository {
  ...
  AazHomeSmall1BannerRepository(this.firestore);
...
// ------ AazHomeSmall1BannerRepository 클래스 끝

// ------ AazHomeSmall2BannerRepository 클래스 시작
// 'AazHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AazHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AazHomeSmall2BannerRepository(this.firestore);
...
// ------ AazHomeSmall2BannerRepository 클래스 끝

// ------ AazHomeSmall3BannerRepository 클래스 시작
// 'AazHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AazHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AazHomeSmall3BannerRepository(this.firestore);
...
// ------ AazHomeSmall3BannerRepository 클래스 끝