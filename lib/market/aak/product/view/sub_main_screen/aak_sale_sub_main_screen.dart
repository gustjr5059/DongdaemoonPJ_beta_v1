...
class _AakSaleSubMainScreenState extends ConsumerState<AakSaleSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aakSaleSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aakSaleSubMainSmall1BannerImagesProvider).value ?? [], ref),
