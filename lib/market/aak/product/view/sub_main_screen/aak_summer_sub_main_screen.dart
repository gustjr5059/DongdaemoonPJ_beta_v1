...
class _AakSummerSubMainScreenState extends ConsumerState<AakSummerSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aakSummerSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aakSummerSubMainSmall1BannerImagesProvider).value ?? [], ref),
