...
class _AakPaedingMainScreenState extends ConsumerState<AakPaedingMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aakPaedingMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aakPaedingMainSmall1BannerImagesProvider).value ?? [], ref),
