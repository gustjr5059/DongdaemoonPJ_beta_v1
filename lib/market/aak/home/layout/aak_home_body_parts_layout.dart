...
import '../../product/layout/aak_product_body_parts_layout.dart';
import '../../product/provider/aak_product_all_providers.dart';
import '../../product/view/main_screen/aak_blouse_main_screen.dart';
import '../../product/view/main_screen/aak_cardigan_main_screen.dart';
import '../../product/view/main_screen/aak_coat_main_screen.dart';
import '../../product/view/main_screen/aak_jean_main_screen.dart';
import '../../product/view/main_screen/aak_mtm_main_screen.dart';
import '../../product/view/main_screen/aak_neat_main_screen.dart';
import '../../product/view/main_screen/aak_onepiece_main_screen.dart';
import '../../product/view/main_screen/aak_paeding_main_screen.dart';
import '../../product/view/main_screen/aak_pants_main_screen.dart';
import '../../product/view/main_screen/aak_pola_main_screen.dart';
import '../../product/view/main_screen/aak_shirt_main_screen.dart';
import '../../product/view/main_screen/aak_skirt_main_screen.dart';
import '../provider/aak_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aakOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AakNeatMainScreen(),
    AakPolaMainScreen(),
    AakOnepieceMainScreen(),
    AakPantsMainScreen(),
    AakJeanMainScreen(),
    AakSkirtMainScreen(),
    AakPaedingMainScreen(),
    AakCoatMainScreen(),
    AakCardiganMainScreen(),
  ];
...
Widget aakBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AakProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aakNewProductRepositoryProvider); // aakNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aakBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AakProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aakBestProductRepositoryProvider); // aakBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aakBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AakProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aakSaleProductRepositoryProvider); // aakSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aakBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AakProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aakSpringProductRepositoryProvider); // aakSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aakBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AakProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aakSummerProductRepositoryProvider); // aakSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aakBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AakProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aakAutumnProductRepositoryProvider); // aakAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aakBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AakProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aakWinterProductRepositoryProvider); // aakWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AakEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AakEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AakEventPosterImgSectionList();

  @override
  _AakEventPosterImgSectionListState createState() =>
      _AakEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AakEventPosterImgSectionListState
    extends ConsumerState<AakEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aakEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aakEventPosterScrollPositionProvider.notifier).state =
...
Widget aakBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AakEventPosterImgSectionList(), // AakEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
