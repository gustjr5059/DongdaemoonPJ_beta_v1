...
// ------ AakHomeSmall1BannerRepository 클래스 시작
// 'AakHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AakHomeSmall1BannerRepository {
  ...
  AakHomeSmall1BannerRepository(this.firestore);
...
// ------ AakHomeSmall1BannerRepository 클래스 끝

// ------ AakHomeSmall2BannerRepository 클래스 시작
// 'AakHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AakHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AakHomeSmall2BannerRepository(this.firestore);
...
// ------ AakHomeSmall2BannerRepository 클래스 끝

// ------ AakHomeSmall3BannerRepository 클래스 시작
// 'AakHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AakHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AakHomeSmall3BannerRepository(this.firestore);
...
// ------ AakHomeSmall3BannerRepository 클래스 끝