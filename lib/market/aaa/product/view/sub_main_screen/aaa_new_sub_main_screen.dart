...
class _AaaNewSubMainScreenState extends ConsumerState<AaaNewSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaaNewSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaaNewSubMainSmall1BannerImagesProvider).value ?? [], ref),
