...
class _AaaNeatMainScreenState extends ConsumerState<AaaNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double productMainAppBarTitleX = screenSize.height * (0 / referenceHeight);
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaaNeatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaaNeatMainSmall1BannerImagesProvider).value ?? [], ref),
