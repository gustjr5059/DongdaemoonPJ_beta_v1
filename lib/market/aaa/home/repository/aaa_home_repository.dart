...
// ------ AaaHomeSmall1BannerRepository 클래스 시작
// 'AaaHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaaHomeSmall1BannerRepository {
  ...
  AaaHomeSmall1BannerRepository(this.firestore);
...
// ------ AaaHomeSmall1BannerRepository 클래스 끝

// ------ AaaHomeSmall2BannerRepository 클래스 시작
// 'AaaHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaaHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaaHomeSmall2BannerRepository(this.firestore);
...
// ------ AaaHomeSmall2BannerRepository 클래스 끝

// ------ AaaHomeSmall3BannerRepository 클래스 시작
// 'AaaHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaaHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaaHomeSmall3BannerRepository(this.firestore);
...
// ------ AaaHomeSmall3BannerRepository 클래스 끝