...
// ------ AadHomeSmall1BannerRepository 클래스 시작
// 'AadHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AadHomeSmall1BannerRepository {
  ...
  AadHomeSmall1BannerRepository(this.firestore);
...
// ------ AadHomeSmall1BannerRepository 클래스 끝

// ------ AadHomeSmall2BannerRepository 클래스 시작
// 'AadHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AadHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AadHomeSmall2BannerRepository(this.firestore);
...
// ------ AadHomeSmall2BannerRepository 클래스 끝

// ------ AadHomeSmall3BannerRepository 클래스 시작
// 'AadHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AadHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AadHomeSmall3BannerRepository(this.firestore);
...
// ------ AadHomeSmall3BannerRepository 클래스 끝