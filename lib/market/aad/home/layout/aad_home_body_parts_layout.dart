...
import '../../product/layout/aad_product_body_parts_layout.dart';
import '../../product/provider/aad_product_all_providers.dart';
import '../../product/view/main_screen/aad_blouse_main_screen.dart';
import '../../product/view/main_screen/aad_cardigan_main_screen.dart';
import '../../product/view/main_screen/aad_coat_main_screen.dart';
import '../../product/view/main_screen/aad_jean_main_screen.dart';
import '../../product/view/main_screen/aad_mtm_main_screen.dart';
import '../../product/view/main_screen/aad_neat_main_screen.dart';
import '../../product/view/main_screen/aad_onepiece_main_screen.dart';
import '../../product/view/main_screen/aad_paeding_main_screen.dart';
import '../../product/view/main_screen/aad_pants_main_screen.dart';
import '../../product/view/main_screen/aad_pola_main_screen.dart';
import '../../product/view/main_screen/aad_shirt_main_screen.dart';
import '../../product/view/main_screen/aad_skirt_main_screen.dart';
import '../provider/aad_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aadOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AadNeatMainScreen(),
    AadPolaMainScreen(),
    AadOnepieceMainScreen(),
    AadPantsMainScreen(),
    AadJeanMainScreen(),
    AadSkirtMainScreen(),
    AadPaedingMainScreen(),
    AadCoatMainScreen(),
    AadCardiganMainScreen(),
  ];
...
Widget aadBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AadProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aadNewProductRepositoryProvider); // aadNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aadBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AadProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aadBestProductRepositoryProvider); // aadBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aadBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AadProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aadSaleProductRepositoryProvider); // aadSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aadBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AadProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aadSpringProductRepositoryProvider); // aadSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aadBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AadProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aadSummerProductRepositoryProvider); // aadSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aadBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AadProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aadAutumnProductRepositoryProvider); // aadAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aadBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AadProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aadWinterProductRepositoryProvider); // aadWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AadEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AadEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AadEventPosterImgSectionList();

  @override
  _AadEventPosterImgSectionListState createState() =>
      _AadEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AadEventPosterImgSectionListState
    extends ConsumerState<AadEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aadEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aadEventPosterScrollPositionProvider.notifier).state =
...
Widget aadBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AadEventPosterImgSectionList(), // AadEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
