...
class AadNewProductRepository {
  ...
  List<String> collections = [
    'Aad1B1', 'Aad2B1', 'Aad3B1', 'Aad4B1', 'Aad5B1', 'Aad6B1',
    'Aad7B1', 'Aad8B1', 'Aad9B1', 'Aad10B1', 'Aad11B1', 'Aad12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aad10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aad10B1', 'Aad2B1' 등)
...
class AadBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aad1B2', 'Aad2B2', 'Aad3B2', 'Aad4B2', 'Aad5B2', 'Aad6B2',
    'Aad7B2', 'Aad8B2', 'Aad9B2', 'Aad10B2', 'Aad11B2', 'Aad12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadBestProductRepository(this.firestore); // 생성자
...
class AadSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aad1B3', 'Aad2B3', 'Aad3B3', 'Aad4B3', 'Aad5B3', 'Aad6B3',
    'Aad7B3', 'Aad8B3', 'Aad9B3', 'Aad10B3', 'Aad11B3', 'Aad12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadSaleProductRepository(this.firestore); // 생성자
...
class AadSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aad1B4', 'Aad2B4', 'Aad3B4', 'Aad4B4', 'Aad5B4', 'Aad6B4',
    'Aad7B4', 'Aad8B4', 'Aad9B4', 'Aad10B4', 'Aad11B4', 'Aad12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadSpringProductRepository(this.firestore); // 생성자
...
class AadSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aad1B5', 'Aad2B5', 'Aad3B5', 'Aad4B5', 'Aad5B5', 'Aad6B5',
    'Aad7B5', 'Aad8B5', 'Aad9B5', 'Aad10B5', 'Aad11B5', 'Aad12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadSummerProductRepository(this.firestore); // 생성자
...
class AadAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aad1B6', 'Aad2B6', 'Aad3B6', 'Aad4B6', 'Aad5B6', 'Aad6B6',
    'Aad7B6', 'Aad8B6', 'Aad9B6', 'Aad10B6', 'Aad11B6', 'Aad12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadAutumnProductRepository(this.firestore); // 생성자
...
class AadWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aad1B7', 'Aad2B7', 'Aad3B7', 'Aad4B7', 'Aad5B7', 'Aad6B7',
    'Aad7B7', 'Aad8B7', 'Aad9B7', 'Aad10B7', 'Aad11B7', 'Aad12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AadMainCategoryProductsRepository 시작 부분
class AadMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_4')
        .doc(mainCollection) // 'Aad10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aad10B1', 'Aad2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AadSectionCategoryProductsRepository 시작 부분
class AadSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AadSectionCategoryProductsRepository(this.firestore);
