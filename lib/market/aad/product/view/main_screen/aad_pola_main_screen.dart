...
class _AadPolaMainScreenState extends ConsumerState<AadPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aadPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aadPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AadCardiganMainScreenState 클래스 끝// _AadCardiganMainScreenState 클래스 끝