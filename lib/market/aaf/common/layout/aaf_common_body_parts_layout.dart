...
import '../../product/provider/aaf_product_state_provider.dart';
...
void aafOnLargeBannerTap(BuildContext context, int index,
...
void aafOnSmallBannerTap(BuildContext context, int index,
...
class AafStoreInitializer {
  final WidgetRef ref;

  AafStoreInitializer(this.ref);
