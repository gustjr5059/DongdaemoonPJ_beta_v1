...
// ------ AafHomeSmall1BannerRepository 클래스 시작
// 'AafHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AafHomeSmall1BannerRepository {
  ...
  AafHomeSmall1BannerRepository(this.firestore);
...
// ------ AafHomeSmall1BannerRepository 클래스 끝

// ------ AafHomeSmall2BannerRepository 클래스 시작
// 'AafHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AafHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AafHomeSmall2BannerRepository(this.firestore);
...
// ------ AafHomeSmall2BannerRepository 클래스 끝

// ------ AafHomeSmall3BannerRepository 클래스 시작
// 'AafHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AafHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AafHomeSmall3BannerRepository(this.firestore);
...
// ------ AafHomeSmall3BannerRepository 클래스 끝