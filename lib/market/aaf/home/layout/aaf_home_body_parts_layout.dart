...
import '../../product/layout/aaf_product_body_parts_layout.dart';
import '../../product/provider/aaf_product_all_providers.dart';
import '../../product/view/main_screen/aaf_blouse_main_screen.dart';
import '../../product/view/main_screen/aaf_cardigan_main_screen.dart';
import '../../product/view/main_screen/aaf_coat_main_screen.dart';
import '../../product/view/main_screen/aaf_jean_main_screen.dart';
import '../../product/view/main_screen/aaf_mtm_main_screen.dart';
import '../../product/view/main_screen/aaf_neat_main_screen.dart';
import '../../product/view/main_screen/aaf_onepiece_main_screen.dart';
import '../../product/view/main_screen/aaf_paeding_main_screen.dart';
import '../../product/view/main_screen/aaf_pants_main_screen.dart';
import '../../product/view/main_screen/aaf_pola_main_screen.dart';
import '../../product/view/main_screen/aaf_shirt_main_screen.dart';
import '../../product/view/main_screen/aaf_skirt_main_screen.dart';
import '../provider/aaf_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aafOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AafNeatMainScreen(),
    AafPolaMainScreen(),
    AafOnepieceMainScreen(),
    AafPantsMainScreen(),
    AafJeanMainScreen(),
    AafSkirtMainScreen(),
    AafPaedingMainScreen(),
    AafCoatMainScreen(),
    AafCardiganMainScreen(),
  ];
...
Widget aafBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AafProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aafNewProductRepositoryProvider); // aafNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aafBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AafProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aafBestProductRepositoryProvider); // aafBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aafBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AafProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aafSaleProductRepositoryProvider); // aafSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aafBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AafProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aafSpringProductRepositoryProvider); // aafSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aafBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AafProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aafSummerProductRepositoryProvider); // aafSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aafBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AafProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aafAutumnProductRepositoryProvider); // aafAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aafBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AafProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aafWinterProductRepositoryProvider); // aafWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AafEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AafEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AafEventPosterImgSectionList();

  @override
  _AafEventPosterImgSectionListState createState() =>
      _AafEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AafEventPosterImgSectionListState
    extends ConsumerState<AafEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aafEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aafEventPosterScrollPositionProvider.notifier).state =
...
Widget aafBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AafEventPosterImgSectionList(), // AafEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
