...
class _AafJeanMainScreenState extends ConsumerState<AafJeanMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aafJeanMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aafJeanMainSmall1BannerImagesProvider).value ?? [], ref),
