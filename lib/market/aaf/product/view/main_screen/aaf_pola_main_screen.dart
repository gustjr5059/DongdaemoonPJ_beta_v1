...
class _AafPolaMainScreenState extends ConsumerState<AafPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aafPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aafPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AafCardiganMainScreenState 클래스 끝// _AafCardiganMainScreenState 클래스 끝