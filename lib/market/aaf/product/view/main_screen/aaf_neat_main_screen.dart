...
class _AafNeatMainScreenState extends ConsumerState<AafNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      bannerImagesProvider: aafAllLargeBannerImagesProvider,
      onPageTap: (context, index) =>
          onLargeBannerTap(context, index, ref.watch(aafAllLargeBannerImagesProvider).value ?? [], ref),
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aafNeatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aafNeatMainSmall1BannerImagesProvider).value ?? [], ref),
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: buildCommonAppBar(
                    ...
                    titleImageFieldName: 'title_img_6',
