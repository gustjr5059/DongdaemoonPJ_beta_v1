...
// AafNewSubMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AafNewSubMainScreen extends ConsumerStatefulWidget {
  const AafNewSubMainScreen({Key? key}) : super(key: key);

  @override
  _AafNewSubMainScreenState createState() => _AafNewSubMainScreenState();
}

// _AafNewSubMainScreenState 클래스 시작
// _AafNewSubMainScreenState 클래스는 AafNewSubMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AafNewSubMainScreenState extends ConsumerState<AafNewSubMainScreen>
  ...
  // aafNewSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(aafNewSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // aafNewSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aafNewSubMainScrollPositionProvider'의 notifier를 읽어옴.
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (newSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = ref.read(aafNewSubMainScrollPositionProvider);
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aafNewSubMainLargeBannerPageProvider,
                                    ...
                                    aafAllLargeBannerImagesProvider,
                                    // 배너 이미지의 상태 제공자를 전달함
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aafNewSubMainSmall1BannerPageProvider,
                                    ...
                                    bannerImagesProvider:
                                        aafNewSubMainSmall1BannerImagesProvider,
                                    ...
                                    onPageTap: (context, index) =>
                                        ...
                                        aafOnSmallBannerTap(
                                            context, // 현재 화면의 컨텍스트를 전달함
                                            index, // 클릭된 배너의 인덱스를 전달함
                                            // aafNewSubMainSmall1BannerImagesProvider에서 대배너 이미지 리스트를 가져옴. 값이 없으면 빈 리스트를 사용함
                                            ref
                                                    .watch(
                                                        aafNewSubMainSmall1BannerImagesProvider)
                                                    .value ??
                            ...
                            AafPriceAndDiscountPercentSortButtons<
                                AafSectionMoreProductListNotifier>(
                              productListProvider:
                                  aafNewSubMainProductListProvider,
                              // 신상 제품 리스트 프로바이더 전달
                              sortButtonProvider:
                                  aafNewSubMainSortButtonProvider, // 신상 정렬 버튼 프로바이더 전달
                            ),
                            // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: interval1Y),
                            // AafGeneralProductList 위젯을 생성, AafSectionMoreProductListNotifier를 사용
                            AafGeneralProductList<AafSectionMoreProductListNotifier>(
