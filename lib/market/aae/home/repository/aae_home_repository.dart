...
// ------ AaeHomeSmall1BannerRepository 클래스 시작
// 'AaeHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaeHomeSmall1BannerRepository {
  ...
  AaeHomeSmall1BannerRepository(this.firestore);
...
// ------ AaeHomeSmall1BannerRepository 클래스 끝

// ------ AaeHomeSmall2BannerRepository 클래스 시작
// 'AaeHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaeHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaeHomeSmall2BannerRepository(this.firestore);
...
// ------ AaeHomeSmall2BannerRepository 클래스 끝

// ------ AaeHomeSmall3BannerRepository 클래스 시작
// 'AaeHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaeHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaeHomeSmall3BannerRepository(this.firestore);
...
// ------ AaeHomeSmall3BannerRepository 클래스 끝