...
class AaeNewProductRepository {
  ...
  List<String> collections = [
    'Aae1B1', 'Aae2B1', 'Aae3B1', 'Aae4B1', 'Aae5B1', 'Aae6B1',
    'Aae7B1', 'Aae8B1', 'Aae9B1', 'Aae10B1', 'Aae11B1', 'Aae12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aae10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aae10B1', 'Aae2B1' 등)
...
class AaeBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aae1B2', 'Aae2B2', 'Aae3B2', 'Aae4B2', 'Aae5B2', 'Aae6B2',
    'Aae7B2', 'Aae8B2', 'Aae9B2', 'Aae10B2', 'Aae11B2', 'Aae12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeBestProductRepository(this.firestore); // 생성자
...
class AaeSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aae1B3', 'Aae2B3', 'Aae3B3', 'Aae4B3', 'Aae5B3', 'Aae6B3',
    'Aae7B3', 'Aae8B3', 'Aae9B3', 'Aae10B3', 'Aae11B3', 'Aae12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeSaleProductRepository(this.firestore); // 생성자
...
class AaeSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aae1B4', 'Aae2B4', 'Aae3B4', 'Aae4B4', 'Aae5B4', 'Aae6B4',
    'Aae7B4', 'Aae8B4', 'Aae9B4', 'Aae10B4', 'Aae11B4', 'Aae12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeSpringProductRepository(this.firestore); // 생성자
...
class AaeSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aae1B5', 'Aae2B5', 'Aae3B5', 'Aae4B5', 'Aae5B5', 'Aae6B5',
    'Aae7B5', 'Aae8B5', 'Aae9B5', 'Aae10B5', 'Aae11B5', 'Aae12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeSummerProductRepository(this.firestore); // 생성자
...
class AaeAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aae1B6', 'Aae2B6', 'Aae3B6', 'Aae4B6', 'Aae5B6', 'Aae6B6',
    'Aae7B6', 'Aae8B6', 'Aae9B6', 'Aae10B6', 'Aae11B6', 'Aae12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeAutumnProductRepository(this.firestore); // 생성자
...
class AaeWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aae1B7', 'Aae2B7', 'Aae3B7', 'Aae4B7', 'Aae5B7', 'Aae6B7',
    'Aae7B7', 'Aae8B7', 'Aae9B7', 'Aae10B7', 'Aae11B7', 'Aae12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AaeMainCategoryProductsRepository 시작 부분
class AaeMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_5')
        .doc(mainCollection) // 'Aae10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aae10B1', 'Aae2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AaeSectionCategoryProductsRepository 시작 부분
class AaeSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AaeSectionCategoryProductsRepository(this.firestore);
