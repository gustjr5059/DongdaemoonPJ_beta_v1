...
class _AaeNeatMainScreenState extends ConsumerState<AaeNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double neatMainScreenLargeBannerHeight = 378; // 대배너 이미지 높이
    final double neatMainLargeBannerViewHeight = 378; // 대배너 화면 세로 비율

    // 소배너 부분 관련 수치
    final double neatMainScreenSmallBannerWidth = screenSize.width * (361 / referenceWidth); // 소배너 이미지 너비
    final double neatMainScreenSmallBannerHeight = 90; // 소배너 이미지 높이
    final double neatMainScreenSmallBannerViewHeight = 90; // 소배너 화면 세로 비율
