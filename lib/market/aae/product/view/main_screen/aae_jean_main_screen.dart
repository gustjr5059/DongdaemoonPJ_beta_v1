...
class _AaeJeanMainScreenState extends ConsumerState<AaeJeanMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double jeanMainScreenLargeBannerHeight = screenSize.height * (378 / referenceHeight); // 대배너 이미지 높이
    final double jeanMainLargeBannerViewHeight =
    ...
    final double jeanMainScreenSmallBannerHeight = screenSize.height * (90 / referenceHeight); // 소배너 이미지 높이
    final double jeanMainScreenSmallBannerViewHeight =
