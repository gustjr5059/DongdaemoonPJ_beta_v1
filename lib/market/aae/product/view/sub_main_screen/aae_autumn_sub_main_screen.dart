...
class _AaeAutumnSubMainScreenState extends ConsumerState<AaeAutumnSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaeAutumnSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaeAutumnSubMainSmall1BannerImagesProvider).value ?? [], ref),
