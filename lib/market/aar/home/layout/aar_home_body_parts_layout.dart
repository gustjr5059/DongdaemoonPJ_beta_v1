...
import '../../product/layout/aar_product_body_parts_layout.dart';
import '../../product/provider/aar_product_all_providers.dart';
import '../../product/view/main_screen/aar_blouse_main_screen.dart';
import '../../product/view/main_screen/aar_cardigan_main_screen.dart';
import '../../product/view/main_screen/aar_coat_main_screen.dart';
import '../../product/view/main_screen/aar_jean_main_screen.dart';
import '../../product/view/main_screen/aar_mtm_main_screen.dart';
import '../../product/view/main_screen/aar_neat_main_screen.dart';
import '../../product/view/main_screen/aar_onepiece_main_screen.dart';
import '../../product/view/main_screen/aar_paeding_main_screen.dart';
import '../../product/view/main_screen/aar_pants_main_screen.dart';
import '../../product/view/main_screen/aar_pola_main_screen.dart';
import '../../product/view/main_screen/aar_shirt_main_screen.dart';
import '../../product/view/main_screen/aar_skirt_main_screen.dart';
import '../provider/aar_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aarOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AarNeatMainScreen(),
    AarPolaMainScreen(),
    AarOnepieceMainScreen(),
    AarPantsMainScreen(),
    AarJeanMainScreen(),
    AarSkirtMainScreen(),
    AarPaedingMainScreen(),
    AarCoatMainScreen(),
    AarCardiganMainScreen(),
  ];
...
Widget aarBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AarProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aarNewProductRepositoryProvider); // aarNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aarBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AarProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aarBestProductRepositoryProvider); // aarBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aarBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AarProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aarSaleProductRepositoryProvider); // aarSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aarBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AarProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aarSpringProductRepositoryProvider); // aarSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aarBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AarProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aarSummerProductRepositoryProvider); // aarSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aarBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AarProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aarAutumnProductRepositoryProvider); // aarAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aarBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AarProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aarWinterProductRepositoryProvider); // aarWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AarEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AarEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AarEventPosterImgSectionList();

  @override
  _AarEventPosterImgSectionListState createState() =>
      _AarEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AarEventPosterImgSectionListState
    extends ConsumerState<AarEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aarEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aarEventPosterScrollPositionProvider.notifier).state =
...
Widget aarBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AarEventPosterImgSectionList(), // AarEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
