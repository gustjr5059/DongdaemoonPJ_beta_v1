...
// ------ AarHomeSmall1BannerRepository 클래스 시작
// 'AarHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AarHomeSmall1BannerRepository {
  ...
  AarHomeSmall1BannerRepository(this.firestore);
...
// ------ AarHomeSmall1BannerRepository 클래스 끝

// ------ AarHomeSmall2BannerRepository 클래스 시작
// 'AarHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AarHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AarHomeSmall2BannerRepository(this.firestore);
...
// ------ AarHomeSmall2BannerRepository 클래스 끝

// ------ AarHomeSmall3BannerRepository 클래스 시작
// 'AarHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AarHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AarHomeSmall3BannerRepository(this.firestore);
...
// ------ AarHomeSmall3BannerRepository 클래스 끝