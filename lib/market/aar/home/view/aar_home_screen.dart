...
// 현재 디렉토리의 부모 디렉토리에 위치한 provider 폴더에서 aar_home_all_providers.dart 파일을 가져옵니다.
...
class _AarHomeMainScreenState extends ConsumerState<AarHomeMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // ------ aar_common_body_parts_layout.dart 내 buildTopBarList, onTopBarTap 재사용하여 TopBar 구현 내용 끝
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aarHomeSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aarHomeSmall1BannerImagesProvider).value ?? [], ref),
    ...
    final small2BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aarHomeSmall2BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aarHomeSmall2BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
    ...
    final small3BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aarHomeSmall3BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aarHomeSmall3BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
