...
class _AarOnepieceMainScreenState extends ConsumerState<AarOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aarOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aarOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
