...
class AarNewProductRepository {
  ...
  List<String> collections = [
    'Aar1B1', 'Aar2B1', 'Aar3B1', 'Aar4B1', 'Aar5B1', 'Aar6B1',
    'Aar7B1', 'Aar8B1', 'Aar9B1', 'Aar10B1', 'Aar11B1', 'Aar12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_18')
          .doc(mainCollection) // 'Aar10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aar10B1', 'Aar2B1' 등)
...
class AarBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aar1B2', 'Aar2B2', 'Aar3B2', 'Aar4B2', 'Aar5B2', 'Aar6B2',
    'Aar7B2', 'Aar8B2', 'Aar9B2', 'Aar10B2', 'Aar11B2', 'Aar12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarBestProductRepository(this.firestore); // 생성자
...
class AarSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aar1B3', 'Aar2B3', 'Aar3B3', 'Aar4B3', 'Aar5B3', 'Aar6B3',
    'Aar7B3', 'Aar8B3', 'Aar9B3', 'Aar10B3', 'Aar11B3', 'Aar12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarSaleProductRepository(this.firestore); // 생성자
...
class AarSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aar1B4', 'Aar2B4', 'Aar3B4', 'Aar4B4', 'Aar5B4', 'Aar6B4',
    'Aar7B4', 'Aar8B4', 'Aar9B4', 'Aar10B4', 'Aar11B4', 'Aar12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarSpringProductRepository(this.firestore); // 생성자
...
class AarSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aar1B5', 'Aar2B5', 'Aar3B5', 'Aar4B5', 'Aar5B5', 'Aar6B5',
    'Aar7B5', 'Aar8B5', 'Aar9B5', 'Aar10B5', 'Aar11B5', 'Aar12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarSummerProductRepository(this.firestore); // 생성자
...
class AarAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aar1B6', 'Aar2B6', 'Aar3B6', 'Aar4B6', 'Aar5B6', 'Aar6B6',
    'Aar7B6', 'Aar8B6', 'Aar9B6', 'Aar10B6', 'Aar11B6', 'Aar12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarAutumnProductRepository(this.firestore); // 생성자
...
class AarWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aar1B7', 'Aar2B7', 'Aar3B7', 'Aar4B7', 'Aar5B7', 'Aar6B7',
    'Aar7B7', 'Aar8B7', 'Aar9B7', 'Aar10B7', 'Aar11B7', 'Aar12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AarMainCategoryProductsRepository 시작 부분
class AarMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_18')
        .doc(mainCollection) // 'Aar10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aar10B1', 'Aar2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AarSectionCategoryProductsRepository 시작 부분
class AarSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AarSectionCategoryProductsRepository(this.firestore);
