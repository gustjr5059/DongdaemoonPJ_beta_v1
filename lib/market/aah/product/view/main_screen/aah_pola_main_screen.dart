...
class _AahPolaMainScreenState extends ConsumerState<AahPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aahPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aahPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AahCardiganMainScreenState 클래스 끝// _AahCardiganMainScreenState 클래스 끝