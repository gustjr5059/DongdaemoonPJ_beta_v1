...
class _AahPolaMainScreenState extends ConsumerState<AahPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final double polaMainScreenLargeBannerHeight = screenSize.height * (378 / referenceHeight); // 대배너 이미지 높이
    final double polaMainLargeBannerViewHeight =
    ...
    final double polaMainScreenSmallBannerHeight = screenSize.height * (90 / referenceHeight); // 소배너 이미지 높이
    final double polaMainScreenSmallBannerViewHeight =
