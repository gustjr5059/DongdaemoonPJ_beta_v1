...
class AahNewProductRepository {
  ...
  List<String> collections = [
    'Aah1B1', 'Aah2B1', 'Aah3B1', 'Aah4B1', 'Aah5B1', 'Aah6B1',
    'Aah7B1', 'Aah8B1', 'Aah9B1', 'Aah10B1', 'Aah11B1', 'Aah12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aah10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aah10B1', 'Aah2B1' 등)
...
class AahBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aah1B2', 'Aah2B2', 'Aah3B2', 'Aah4B2', 'Aah5B2', 'Aah6B2',
    'Aah7B2', 'Aah8B2', 'Aah9B2', 'Aah10B2', 'Aah11B2', 'Aah12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahBestProductRepository(this.firestore); // 생성자
...
class AahSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aah1B3', 'Aah2B3', 'Aah3B3', 'Aah4B3', 'Aah5B3', 'Aah6B3',
    'Aah7B3', 'Aah8B3', 'Aah9B3', 'Aah10B3', 'Aah11B3', 'Aah12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahSaleProductRepository(this.firestore); // 생성자
...
class AahSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aah1B4', 'Aah2B4', 'Aah3B4', 'Aah4B4', 'Aah5B4', 'Aah6B4',
    'Aah7B4', 'Aah8B4', 'Aah9B4', 'Aah10B4', 'Aah11B4', 'Aah12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahSpringProductRepository(this.firestore); // 생성자
...
class AahSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aah1B5', 'Aah2B5', 'Aah3B5', 'Aah4B5', 'Aah5B5', 'Aah6B5',
    'Aah7B5', 'Aah8B5', 'Aah9B5', 'Aah10B5', 'Aah11B5', 'Aah12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahSummerProductRepository(this.firestore); // 생성자
...
class AahAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aah1B6', 'Aah2B6', 'Aah3B6', 'Aah4B6', 'Aah5B6', 'Aah6B6',
    'Aah7B6', 'Aah8B6', 'Aah9B6', 'Aah10B6', 'Aah11B6', 'Aah12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahAutumnProductRepository(this.firestore); // 생성자
...
class AahWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aah1B7', 'Aah2B7', 'Aah3B7', 'Aah4B7', 'Aah5B7', 'Aah6B7',
    'Aah7B7', 'Aah8B7', 'Aah9B7', 'Aah10B7', 'Aah11B7', 'Aah12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AahMainCategoryProductsRepository 시작 부분
class AahMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_8')
        .doc(mainCollection) // 'Aah10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aah10B1', 'Aah2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AahSectionCategoryProductsRepository 시작 부분
class AahSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AahSectionCategoryProductsRepository(this.firestore);
