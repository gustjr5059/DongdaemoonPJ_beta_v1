...
import '../../product/layout/aah_product_body_parts_layout.dart';
import '../../product/provider/aah_product_all_providers.dart';
import '../../product/view/main_screen/aah_blouse_main_screen.dart';
import '../../product/view/main_screen/aah_cardigan_main_screen.dart';
import '../../product/view/main_screen/aah_coat_main_screen.dart';
import '../../product/view/main_screen/aah_jean_main_screen.dart';
import '../../product/view/main_screen/aah_mtm_main_screen.dart';
import '../../product/view/main_screen/aah_neat_main_screen.dart';
import '../../product/view/main_screen/aah_onepiece_main_screen.dart';
import '../../product/view/main_screen/aah_paeding_main_screen.dart';
import '../../product/view/main_screen/aah_pants_main_screen.dart';
import '../../product/view/main_screen/aah_pola_main_screen.dart';
import '../../product/view/main_screen/aah_shirt_main_screen.dart';
import '../../product/view/main_screen/aah_skirt_main_screen.dart';
import '../provider/aah_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aahOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AahNeatMainScreen(),
    AahPolaMainScreen(),
    AahOnepieceMainScreen(),
    AahPantsMainScreen(),
    AahJeanMainScreen(),
    AahSkirtMainScreen(),
    AahPaedingMainScreen(),
    AahCoatMainScreen(),
    AahCardiganMainScreen(),
  ];
...
Widget aahBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AahProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aahNewProductRepositoryProvider); // aahNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aahBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AahProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aahBestProductRepositoryProvider); // aahBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aahBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AahProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aahSaleProductRepositoryProvider); // aahSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aahBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AahProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aahSpringProductRepositoryProvider); // aahSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aahBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AahProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aahSummerProductRepositoryProvider); // aahSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aahBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AahProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aahAutumnProductRepositoryProvider); // aahAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aahBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AahProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aahWinterProductRepositoryProvider); // aahWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AahEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AahEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AahEventPosterImgSectionList();

  @override
  _AahEventPosterImgSectionListState createState() =>
      _AahEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AahEventPosterImgSectionListState
    extends ConsumerState<AahEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aahEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aahEventPosterScrollPositionProvider.notifier).state =
...
Widget aahBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AahEventPosterImgSectionList(), // AahEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
