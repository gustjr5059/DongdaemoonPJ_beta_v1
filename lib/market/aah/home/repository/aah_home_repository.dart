...
// ------ AahHomeSmall1BannerRepository 클래스 시작
// 'AahHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AahHomeSmall1BannerRepository {
  ...
  AahHomeSmall1BannerRepository(this.firestore);
...
// ------ AahHomeSmall1BannerRepository 클래스 끝

// ------ AahHomeSmall2BannerRepository 클래스 시작
// 'AahHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AahHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AahHomeSmall2BannerRepository(this.firestore);
...
// ------ AahHomeSmall2BannerRepository 클래스 끝

// ------ AahHomeSmall3BannerRepository 클래스 시작
// 'AahHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AahHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AahHomeSmall3BannerRepository(this.firestore);
...
// ------ AahHomeSmall3BannerRepository 클래스 끝