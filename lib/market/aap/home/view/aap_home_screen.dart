...
import '../../common/layout/aap_common_body_parts_layout.dart';
...
// AapHomeMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AapHomeMainScreen extends ConsumerStatefulWidget {
  const AapHomeMainScreen({Key? key}) : super(key: key);

  @override
  _AapHomeMainScreenState createState() => _AapHomeMainScreenState();
}

// _AapHomeMainScreenState 클래스 시작
// _AapHomeMainScreenState 클래스는 AapHomeMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AapHomeMainScreenState extends ConsumerState<AapHomeMainScreen>
  ...
  void _onScroll() {
    ...
    if (newCurrentIndex != currentIndex) {
      ...
      ref.read(aapHomeCurrentTabProvider.notifier).state = currentIndex; // 상태 업데이트
    }
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aapHomeScrollPositionProvider'의 notifier를 읽어옴.
    // 읽어온 notifier의 'state' 값을 'currentScrollPosition'으로 설정함.
    // 이렇게 하면 앱의 다른 부분에서 해당 스크롤 위치 정보를 참조할 수 있게 됨.
    ref.read(aapHomeScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (homeScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = FirebaseAuth.instance.currentUser != null
            ? ref.read(aapHomeScrollPositionProvider)
            : ref.read(aapHomeLoginAndLogoutScrollPositionProvider);
        // 저장된 위치로 스크롤 이동
      ...
      currentIndex = ref.read(aapHomeCurrentTabProvider);
    ...
    _largeBannerPageController =
        PageController(initialPage: ref.read(aapHomeLargeBannerPageProvider));
    ...
    // 'aapHomeSmall1BannerPageProvider'에서 초기 페이지 인덱스를 읽어옴
    _small1BannerPageController =
        PageController(initialPage: ref.read(aapHomeSmall1BannerPageProvider));
    ...
    // 'aapHomeSmall2BannerPageProvider'에서 초기 페이지 인덱스를 읽어옴
    _small2BannerPageController =
        PageController(initialPage: ref.read(aapHomeSmall2BannerPageProvider));
    ...
    // 'aapHomeSmall3BannerPageProvider'에서 초기 페이지 인덱스를 읽어옴
    _small3BannerPageController =
        PageController(initialPage: ref.read(aapHomeSmall3BannerPageProvider));
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(aapHomeLargeBannerPageProvider.notifier).state = 0;
        ref.read(aapHomeSmall1BannerPageProvider.notifier).state = 0;
        ref.read(aapHomeSmall2BannerPageProvider.notifier).state = 0;
        ref.read(aapHomeSmall3BannerPageProvider.notifier).state = 0;
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "신상", aapBuildNewProductsSection,
                          ...
                          Container(
                            key: sectionSaleKey,
                            child: buildSectionCard(
                                context, ref, "특가 상품", aapBuildSaleProductsSection,
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "봄", aapBuildSpringProductsSection,
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "여름", aapBuildSummerProductsSection,
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "가을", aapBuildAutumnProductsSection,
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "겨울", aapBuildWinterProductsSection,
                          ...
                          Container(
                            ...
                            child: buildSectionCard(context, ref, "이벤트",
                                aapBuildEventPosterImgProductsSection,
