...
// ------ AapHomeSmall1BannerRepository 클래스 시작
// 'AapHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AapHomeSmall1BannerRepository {
  ...
  AapHomeSmall1BannerRepository(this.firestore);
...
// ------ AapHomeSmall1BannerRepository 클래스 끝

// ------ AapHomeSmall2BannerRepository 클래스 시작
// 'AapHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AapHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AapHomeSmall2BannerRepository(this.firestore);
...
// ------ AapHomeSmall2BannerRepository 클래스 끝

// ------ AapHomeSmall3BannerRepository 클래스 시작
// 'AapHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AapHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AapHomeSmall3BannerRepository(this.firestore);
...
// ------ AapHomeSmall3BannerRepository 클래스 끝