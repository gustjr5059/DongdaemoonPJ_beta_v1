...
import '../../product/layout/aap_product_body_parts_layout.dart';
import '../../product/provider/aap_product_all_providers.dart';
import '../../product/view/main_screen/aap_blouse_main_screen.dart';
import '../../product/view/main_screen/aap_cardigan_main_screen.dart';
import '../../product/view/main_screen/aap_coat_main_screen.dart';
import '../../product/view/main_screen/aap_jean_main_screen.dart';
import '../../product/view/main_screen/aap_mtm_main_screen.dart';
import '../../product/view/main_screen/aap_neat_main_screen.dart';
import '../../product/view/main_screen/aap_onepiece_main_screen.dart';
import '../../product/view/main_screen/aap_paeding_main_screen.dart';
import '../../product/view/main_screen/aap_pants_main_screen.dart';
import '../../product/view/main_screen/aap_pola_main_screen.dart';
import '../../product/view/main_screen/aap_shirt_main_screen.dart';
import '../../product/view/main_screen/aap_skirt_main_screen.dart';
import '../provider/aap_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aapOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AapNeatMainScreen(),
    AapPolaMainScreen(),
    AapOnepieceMainScreen(),
    AapPantsMainScreen(),
    AapJeanMainScreen(),
    AapSkirtMainScreen(),
    AapPaedingMainScreen(),
    AapCoatMainScreen(),
    AapCardiganMainScreen(),
  ];
...
Widget aapBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AapProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aapNewProductRepositoryProvider); // aapNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aapBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AapProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aapBestProductRepositoryProvider); // aapBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aapBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AapProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aapSaleProductRepositoryProvider); // aapSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aapBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AapProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aapSpringProductRepositoryProvider); // aapSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aapBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AapProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aapSummerProductRepositoryProvider); // aapSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aapBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AapProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aapAutumnProductRepositoryProvider); // aapAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aapBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AapProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aapWinterProductRepositoryProvider); // aapWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AapEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AapEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AapEventPosterImgSectionList();

  @override
  _AapEventPosterImgSectionListState createState() =>
      _AapEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AapEventPosterImgSectionListState
    extends ConsumerState<AapEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aapEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aapEventPosterScrollPositionProvider.notifier).state =
...
Widget aapBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
