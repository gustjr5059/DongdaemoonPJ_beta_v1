...
class AapNewProductRepository {
  ...
  List<String> collections = [
    'Aap1B1', 'Aap2B1', 'Aap3B1', 'Aap4B1', 'Aap5B1', 'Aap6B1',
    'Aap7B1', 'Aap8B1', 'Aap9B1', 'Aap10B1', 'Aap11B1', 'Aap12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_16')
          .doc(mainCollection) // 'Aap10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aap10B1', 'Aap2B1' 등)
...
class AapBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aap1B2', 'Aap2B2', 'Aap3B2', 'Aap4B2', 'Aap5B2', 'Aap6B2',
    'Aap7B2', 'Aap8B2', 'Aap9B2', 'Aap10B2', 'Aap11B2', 'Aap12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapBestProductRepository(this.firestore); // 생성자
...
class AapSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aap1B3', 'Aap2B3', 'Aap3B3', 'Aap4B3', 'Aap5B3', 'Aap6B3',
    'Aap7B3', 'Aap8B3', 'Aap9B3', 'Aap10B3', 'Aap11B3', 'Aap12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapSaleProductRepository(this.firestore); // 생성자
...
class AapSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aap1B4', 'Aap2B4', 'Aap3B4', 'Aap4B4', 'Aap5B4', 'Aap6B4',
    'Aap7B4', 'Aap8B4', 'Aap9B4', 'Aap10B4', 'Aap11B4', 'Aap12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapSpringProductRepository(this.firestore); // 생성자
...
class AapSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aap1B5', 'Aap2B5', 'Aap3B5', 'Aap4B5', 'Aap5B5', 'Aap6B5',
    'Aap7B5', 'Aap8B5', 'Aap9B5', 'Aap10B5', 'Aap11B5', 'Aap12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapSummerProductRepository(this.firestore); // 생성자
...
class AapAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aap1B6', 'Aap2B6', 'Aap3B6', 'Aap4B6', 'Aap5B6', 'Aap6B6',
    'Aap7B6', 'Aap8B6', 'Aap9B6', 'Aap10B6', 'Aap11B6', 'Aap12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapAutumnProductRepository(this.firestore); // 생성자
...
class AapWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aap1B7', 'Aap2B7', 'Aap3B7', 'Aap4B7', 'Aap5B7', 'Aap6B7',
    'Aap7B7', 'Aap8B7', 'Aap9B7', 'Aap10B7', 'Aap11B7', 'Aap12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AapMainCategoryProductsRepository 시작 부분
class AapMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_16')
        .doc(mainCollection) // 'Aap10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aap10B1', 'Aap2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AapSectionCategoryProductsRepository 시작 부분
class AapSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AapSectionCategoryProductsRepository(this.firestore);
