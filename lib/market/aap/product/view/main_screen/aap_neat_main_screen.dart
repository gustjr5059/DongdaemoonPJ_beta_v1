...
class _AapNeatMainScreenState extends ConsumerState<AapNeatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aapNeatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aapNeatMainSmall1BannerImagesProvider).value ?? [], ref),
              ...
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  background: buildCommonAppBar(
                    ...
                    titleImageFieldName: 'title_img_16',
