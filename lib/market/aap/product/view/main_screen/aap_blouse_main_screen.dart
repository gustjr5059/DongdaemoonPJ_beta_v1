...
class _AapBlouseMainScreenState extends ConsumerState<AapBlouseMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aapBlouseMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aapBlouseMainSmall1BannerImagesProvider).value ?? [], ref),
