...
class _AapPolaMainScreenState extends ConsumerState<AapPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aapPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aapPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AapCardiganMainScreenState 클래스 끝// _AapCardiganMainScreenState 클래스 끝