...
class _AayCardiganMainScreenState extends ConsumerState<AayCardiganMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aayCardiganMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aayCardiganMainSmall1BannerImagesProvider).value ?? [], ref),
