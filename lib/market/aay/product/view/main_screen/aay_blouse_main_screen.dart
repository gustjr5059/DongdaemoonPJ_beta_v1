...
class _AayBlouseMainScreenState extends ConsumerState<AayBlouseMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: blouseMainScreenLargeBannerWidth,
      height: blouseMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aayBlouseMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aayBlouseMainSmall1BannerImagesProvider).value ?? [], ref),
      width: blouseMainScreenSmallBannerWidth,
      height: blouseMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
