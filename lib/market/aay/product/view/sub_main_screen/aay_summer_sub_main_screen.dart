...
class _AaySummerSubMainScreenState extends ConsumerState<AaySummerSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaySummerSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaySummerSubMainSmall1BannerImagesProvider).value ?? [], ref),
