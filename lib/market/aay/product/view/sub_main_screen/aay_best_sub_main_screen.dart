...
class _AayBestSubMainScreenState extends ConsumerState<AayBestSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aayBestSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aayBestSubMainSmall1BannerImagesProvider).value ?? [], ref),
