...
// AayNewSubMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AayNewSubMainScreen extends ConsumerStatefulWidget {
  const AayNewSubMainScreen({Key? key}) : super(key: key);

  @override
  _AayNewSubMainScreenState createState() => _AayNewSubMainScreenState();
}

// _AayNewSubMainScreenState 클래스 시작
// _AayNewSubMainScreenState 클래스는 AayNewSubMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AayNewSubMainScreenState extends ConsumerState<AayNewSubMainScreen>
  ...
  // aayNewSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(aayNewSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // aayNewSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aayNewSubMainScrollPositionProvider'의 notifier를 읽어옴.
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (newSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = ref.read(aayNewSubMainScrollPositionProvider);
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aayNewSubMainLargeBannerPageProvider,
                                    ...
                                    aayAllLargeBannerImagesProvider,
                                    // 배너 이미지의 상태 제공자를 전달함
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aayNewSubMainSmall1BannerPageProvider,
                                    ...
                                    bannerImagesProvider:
                                        aayNewSubMainSmall1BannerImagesProvider,
                                    ...
                                    onPageTap: (context, index) =>
                                        ...
                                        aayOnSmallBannerTap(
                                            context, // 현재 화면의 컨텍스트를 전달함
                                            index, // 클릭된 배너의 인덱스를 전달함
                                            // aayNewSubMainSmall1BannerImagesProvider에서 대배너 이미지 리스트를 가져옴. 값이 없으면 빈 리스트를 사용함
                                            ref
                                                    .watch(
                                                        aayNewSubMainSmall1BannerImagesProvider)
                                                    .value ??
                            ...
                            AayPriceAndDiscountPercentSortButtons<
                                AaySectionMoreProductListNotifier>(
                              productListProvider:
                                  aayNewSubMainProductListProvider,
                              // 신상 제품 리스트 프로바이더 전달
                              sortButtonProvider:
                                  aayNewSubMainSortButtonProvider, // 신상 정렬 버튼 프로바이더 전달
                            ),
                            // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: interval1Y),
                            // AayGeneralProductList 위젯을 생성, AaySectionMoreProductListNotifier를 사용
                            AayGeneralProductList<AaySectionMoreProductListNotifier>(
