...
// ------ AayHomeSmall1BannerRepository 클래스 시작
// 'AayHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AayHomeSmall1BannerRepository {
  ...
  AayHomeSmall1BannerRepository(this.firestore);
...
// ------ AayHomeSmall1BannerRepository 클래스 끝

// ------ AayHomeSmall2BannerRepository 클래스 시작
// 'AayHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AayHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AayHomeSmall2BannerRepository(this.firestore);
...
// ------ AayHomeSmall2BannerRepository 클래스 끝

// ------ AayHomeSmall3BannerRepository 클래스 시작
// 'AayHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AayHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AayHomeSmall3BannerRepository(this.firestore);
...
// ------ AayHomeSmall3BannerRepository 클래스 끝