...
import '../../product/layout/aay_product_body_parts_layout.dart';
import '../../product/provider/aay_product_all_providers.dart';
import '../../product/view/main_screen/aay_blouse_main_screen.dart';
import '../../product/view/main_screen/aay_cardigan_main_screen.dart';
import '../../product/view/main_screen/aay_coat_main_screen.dart';
import '../../product/view/main_screen/aay_jean_main_screen.dart';
import '../../product/view/main_screen/aay_mtm_main_screen.dart';
import '../../product/view/main_screen/aay_neat_main_screen.dart';
import '../../product/view/main_screen/aay_onepiece_main_screen.dart';
import '../../product/view/main_screen/aay_paeding_main_screen.dart';
import '../../product/view/main_screen/aay_pants_main_screen.dart';
import '../../product/view/main_screen/aay_pola_main_screen.dart';
import '../../product/view/main_screen/aay_shirt_main_screen.dart';
import '../../product/view/main_screen/aay_skirt_main_screen.dart';
import '../provider/aay_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aayOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AayNeatMainScreen(),
    AayPolaMainScreen(),
    AayOnepieceMainScreen(),
    AayPantsMainScreen(),
    AayJeanMainScreen(),
    AaySkirtMainScreen(),
    AayPaedingMainScreen(),
    AayCoatMainScreen(),
    AayCardiganMainScreen(),
  ];
...
Widget aayBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AayProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aayNewProductRepositoryProvider); // aayNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aayBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AayProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aayBestProductRepositoryProvider); // aayBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aayBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AayProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaySaleProductRepositoryProvider); // aaySaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aayBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AayProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaySpringProductRepositoryProvider); // aaySpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aayBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AayProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaySummerProductRepositoryProvider); // aaySummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aayBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AayProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aayAutumnProductRepositoryProvider); // aayAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aayBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AayProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aayWinterProductRepositoryProvider); // aayWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AayEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AayEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AayEventPosterImgSectionList();

  @override
  _AayEventPosterImgSectionListState createState() =>
      _AayEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AayEventPosterImgSectionListState
    extends ConsumerState<AayEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aayEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aayEventPosterScrollPositionProvider.notifier).state =
...
Widget aayBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AayEventPosterImgSectionList(), // AayEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
