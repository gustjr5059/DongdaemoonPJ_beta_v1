...
import '../../common/layout/aay_common_body_parts_layout.dart';
import '../../common/provider/aay_common_all_provider.dart';
import '../../product/provider/aay_product_all_providers.dart';
import '../../product/view/sub_main_screen/aay_autumn_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aay_best_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aay_new_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aay_sale_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aay_spring_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aay_summer_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aay_winter_sub_main_screen.dart';
import '../layout/aay_home_body_parts_layout.dart';
...
import '../provider/aay_home_all_providers.dart';

// 홈 화면의 상태를 관리하기 위한 Provider 파일을 임포트합니다.
import '../provider/aay_home_state_provider.dart';
...
// AayHomeMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AayHomeMainScreen extends ConsumerStatefulWidget {
  const AayHomeMainScreen({Key? key}) : super(key: key);

  @override
  _AayHomeMainScreenState createState() => _AayHomeMainScreenState();
}

// _AayHomeMainScreenState 클래스 시작
// _AayHomeMainScreenState 클래스는 AayHomeMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AayHomeMainScreenState extends ConsumerState<AayHomeMainScreen>
  ...
  void _onScroll() {
    ...
    if (newCurrentIndex != currentIndex) {
      ...
      ref.read(aayHomeCurrentTabProvider.notifier).state = currentIndex; // 상태 업데이트
    }
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aayHomeScrollPositionProvider'의 notifier를 읽어옴.
    // 읽어온 notifier의 'state' 값을 'currentScrollPosition'으로 설정함.
    // 이렇게 하면 앱의 다른 부분에서 해당 스크롤 위치 정보를 참조할 수 있게 됨.
    ref.read(aayHomeScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (homeScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = FirebaseAuth.instance.currentUser != null
            ? ref.read(aayHomeScrollPositionProvider)
            : ref.read(aayHomeLoginAndLogoutScrollPositionProvider);
        // 저장된 위치로 스크롤 이동
      ...
      currentIndex = ref.read(aayHomeCurrentTabProvider);
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(aayHomeLargeBannerPageProvider.notifier).state = 0;
        ref.read(aayHomeSmall1BannerPageProvider.notifier).state = 0;
        ref.read(aayHomeSmall2BannerPageProvider.notifier).state = 0;
        ref.read(aayHomeSmall3BannerPageProvider.notifier).state = 0;
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap,
        aayHomeCurrentTabProvider, homeTopBarPointAutoScrollController);
                        ...
                        children: [
                            ...
                            content: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: buildCommonBannerPageViewSection<
                                  ...
                                  currentPageProvider:
                                  aayHomeLargeBannerPageProvider,
                          ...
                          CommonCardView(
                            ...
                            content: Container(
                              child: MidCategoryButtonList(
                                onCategoryTap: aayOnMidCategoryTap,
                              ),
                              decoration: BoxDecoration(
                                border: Border(
                                  bottom: BorderSide(color: BLACK_COLOR, width: 1.0), // 하단 테두리 색상을 설정함
                            ...
                            content: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: buildCommonBannerPageViewSection<
                                  ...
                                  // 현재 페이지를 관리하는 Provider를 전달
                                  currentPageProvider:
                                  aayHomeSmall1BannerPageProvider,
                                  ...
                                  // 배너 이미지들을 관리하는 Provider를 전달
                                  bannerImagesProvider:
                                  aayHomeSmall1BannerImagesProvider,
                                  // 배너를 탭했을 때 실행할 함수를 전달
                                  onPageTap: (context, index) =>
                                  ...
                                  aayOnSmallBannerTap(
                                      context, // 현재 화면의 컨텍스트를 전달함
                                      index, // 클릭된 배너의 인덱스를 전달함
                                      // aayHomeSmall1BannerImagesProvider에서 대배너 이미지 리스트를 가져옴. 값이 없으면 빈 리스트를 사용함
                                      ref.watch(aayHomeSmall1BannerImagesProvider).value ?? [],
                                      ref // Provider의 참조를 전달함
                                  ),
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "신상", aayBuildNewProductsSection,
                                destinationScreen: AayNewSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(context, ref, "스테디 셀러",
                                aayBuildBestProductsSection,
                                destinationScreen: AayBestSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            key: sectionSaleKey,
                            child: buildSectionCard(
                                context, ref, "특가 상품", aayBuildSaleProductsSection,
                                destinationScreen: AaySaleSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                            ...
                            content: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: buildCommonBannerPageViewSection<
                                  ...
                                  // 현재 페이지를 관리하는 Provider를 전달
                                  currentPageProvider:
                                  aayHomeSmall2BannerPageProvider,
                                  // 페이지 전환을 관리하는 페이지 컨트롤러를 전달
                                  pageController: _small2BannerPageController,
                                  // 배너 자동 스크롤 기능을 전달
                                  ...
                                  // 배너 이미지들을 관리하는 Provider를 전달
                                  bannerImagesProvider:
                                  aayHomeSmall2BannerImagesProvider,
                                  // 배너를 탭했을 때 실행할 함수를 전달
                                  onPageTap: (context, index) =>
                                  // 소배너 클릭 시 호출할 함수 aayOnSmallBannerTap 실행
                                  aayOnSmallBannerTap(
                                      context, // 현재 화면의 컨텍스트를 전달함
                                      index, // 클릭된 배너의 인덱스를 전달함
                                      // aayHomeSmall2BannerImagesProvider에서 대배너 이미지 리스트를 가져옴. 값이 없으면 빈 리스트를 사용함
                                      ref.watch(aayHomeSmall2BannerImagesProvider).value ?? [],
                                      ref // Provider의 참조를 전달함
                                  ),
                                  width: homeScreenSmallBannerWidth, // 원하는 너비
                                  height: homeScreenSmallBannerHeight, // 원하는 높이
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "봄", aayBuildSpringProductsSection,
                                destinationScreen: AaySpringSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "여름", aayBuildSummerProductsSection,
                                destinationScreen: AaySummerSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                            ...
                            content: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: buildCommonBannerPageViewSection<
                                  ...
                                  // 현재 페이지를 관리하는 Provider를 전달
                                  currentPageProvider:
                                  aayHomeSmall3BannerPageProvider,
                                  // 페이지 전환을 관리하는 페이지 컨트롤러를 전달
                                  pageController: _small3BannerPageController,
                                  // 배너 자동 스크롤 기능을 전달
                                  ...
                                  // 배너 이미지들을 관리하는 Provider를 전달
                                  bannerImagesProvider:
                                  aayHomeSmall3BannerImagesProvider,
                                  // 배너를 탭했을 때 실행할 함수를 전달
                                  onPageTap: (context, index) =>
                                  // 소배너 클릭 시 호출할 함수 aayOnSmallBannerTap 실행
                                  aayOnSmallBannerTap(
                                      context, // 현재 화면의 컨텍스트를 전달함
                                      index, // 클릭된 배너의 인덱스를 전달함
                                      // aayHomeSmall3BannerImagesProvider에서 대배너 이미지 리스트를 가져옴. 값이 없으면 빈 리스트를 사용함
                                      ref.watch(aayHomeSmall3BannerImagesProvider).value ?? [],
                                      ref // Provider의 참조를 전달함
                                  ),
                                  width: homeScreenSmallBannerWidth, // 원하는 너비
                                  height: homeScreenSmallBannerHeight, // 원하는 높이
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "가을", aayBuildAutumnProductsSection,
                                destinationScreen: AayAutumnSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "겨울", aayBuildWinterProductsSection,
                                destinationScreen: AayWinterSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(context, ref, "이벤트",
                                aayBuildEventPosterImgProductsSection,
