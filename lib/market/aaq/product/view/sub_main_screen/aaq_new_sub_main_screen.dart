...
class _AaqNewSubMainScreenState extends ConsumerState<AaqNewSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaqNewSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaqNewSubMainSmall1BannerImagesProvider).value ?? [], ref),
