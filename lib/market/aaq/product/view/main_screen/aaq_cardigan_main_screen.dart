...
class _AaqCardiganMainScreenState extends ConsumerState<AaqCardiganMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaqCardiganMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaqCardiganMainSmall1BannerImagesProvider).value ?? [], ref),
