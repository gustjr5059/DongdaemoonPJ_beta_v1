...
class _AaqPolaMainScreenState extends ConsumerState<AaqPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaqPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaqPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AaqCardiganMainScreenState 클래스 끝// _AaqCardiganMainScreenState 클래스 끝