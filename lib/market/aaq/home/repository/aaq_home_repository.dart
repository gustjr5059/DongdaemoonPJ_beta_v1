...
// ------ AaqHomeSmall1BannerRepository 클래스 시작
// 'AaqHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaqHomeSmall1BannerRepository {
  ...
  AaqHomeSmall1BannerRepository(this.firestore);
...
// ------ AaqHomeSmall1BannerRepository 클래스 끝

// ------ AaqHomeSmall2BannerRepository 클래스 시작
// 'AaqHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaqHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaqHomeSmall2BannerRepository(this.firestore);
...
// ------ AaqHomeSmall2BannerRepository 클래스 끝

// ------ AaqHomeSmall3BannerRepository 클래스 시작
// 'AaqHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaqHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaqHomeSmall3BannerRepository(this.firestore);
...
// ------ AaqHomeSmall3BannerRepository 클래스 끝