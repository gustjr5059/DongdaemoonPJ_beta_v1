...
import '../../product/layout/aaq_product_body_parts_layout.dart';
import '../../product/provider/aaq_product_all_providers.dart';
import '../../product/view/main_screen/aaq_blouse_main_screen.dart';
import '../../product/view/main_screen/aaq_cardigan_main_screen.dart';
import '../../product/view/main_screen/aaq_coat_main_screen.dart';
import '../../product/view/main_screen/aaq_jean_main_screen.dart';
import '../../product/view/main_screen/aaq_mtm_main_screen.dart';
import '../../product/view/main_screen/aaq_neat_main_screen.dart';
import '../../product/view/main_screen/aaq_onepiece_main_screen.dart';
import '../../product/view/main_screen/aaq_paeding_main_screen.dart';
import '../../product/view/main_screen/aaq_pants_main_screen.dart';
import '../../product/view/main_screen/aaq_pola_main_screen.dart';
import '../../product/view/main_screen/aaq_shirt_main_screen.dart';
import '../../product/view/main_screen/aaq_skirt_main_screen.dart';
import '../provider/aaq_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aaqOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AaqNeatMainScreen(),
    AaqPolaMainScreen(),
    AaqOnepieceMainScreen(),
    AaqPantsMainScreen(),
    AaqJeanMainScreen(),
    AaqSkirtMainScreen(),
    AaqPaedingMainScreen(),
    AaqCoatMainScreen(),
    AaqCardiganMainScreen(),
  ];
...
Widget aaqBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AaqProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aaqNewProductRepositoryProvider); // aaqNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaqBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaqProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaqBestProductRepositoryProvider); // aaqBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaqBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaqProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaqSaleProductRepositoryProvider); // aaqSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaqBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaqProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaqSpringProductRepositoryProvider); // aaqSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaqBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaqProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaqSummerProductRepositoryProvider); // aaqSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaqBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaqProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaqAutumnProductRepositoryProvider); // aaqAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaqBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaqProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaqWinterProductRepositoryProvider); // aaqWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AaqEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AaqEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AaqEventPosterImgSectionList();

  @override
  _AaqEventPosterImgSectionListState createState() =>
      _AaqEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AaqEventPosterImgSectionListState
    extends ConsumerState<AaqEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aaqEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aaqEventPosterScrollPositionProvider.notifier).state =
...
Widget aaqBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AaqEventPosterImgSectionList(), // AaqEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
