...
// 현재 디렉토리의 부모 디렉토리에 위치한 provider 폴더에서 aaq_home_all_providers.dart 파일을 가져옵니다.
...
class _AaqHomeMainScreenState extends ConsumerState<AaqHomeMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    // ------ aaq_common_body_parts_layout.dart 내 buildTopBarList, onTopBarTap 재사용하여 TopBar 구현 내용 끝
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaqHomeSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaqHomeSmall1BannerImagesProvider).value ?? [], ref),
    ...
    final small2BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaqHomeSmall2BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaqHomeSmall2BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
    ...
    final small3BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaqHomeSmall3BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaqHomeSmall3BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
