...
import '../../product/layout/aal_product_body_parts_layout.dart';
import '../../product/provider/aal_product_all_providers.dart';
import '../../product/view/main_screen/aal_blouse_main_screen.dart';
import '../../product/view/main_screen/aal_cardigan_main_screen.dart';
import '../../product/view/main_screen/aal_coat_main_screen.dart';
import '../../product/view/main_screen/aal_jean_main_screen.dart';
import '../../product/view/main_screen/aal_mtm_main_screen.dart';
import '../../product/view/main_screen/aal_neat_main_screen.dart';
import '../../product/view/main_screen/aal_onepiece_main_screen.dart';
import '../../product/view/main_screen/aal_paeding_main_screen.dart';
import '../../product/view/main_screen/aal_pants_main_screen.dart';
import '../../product/view/main_screen/aal_pola_main_screen.dart';
import '../../product/view/main_screen/aal_shirt_main_screen.dart';
import '../../product/view/main_screen/aal_skirt_main_screen.dart';
import '../provider/aal_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aalOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AalNeatMainScreen(),
    AalPolaMainScreen(),
    AalOnepieceMainScreen(),
    AalPantsMainScreen(),
    AalJeanMainScreen(),
    AalSkirtMainScreen(),
    AalPaedingMainScreen(),
    AalCoatMainScreen(),
    AalCardiganMainScreen(),
  ];
...
Widget aalBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AalProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aalNewProductRepositoryProvider); // aalNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aalBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AalProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aalBestProductRepositoryProvider); // aalBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aalBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AalProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aalSaleProductRepositoryProvider); // aalSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aalBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AalProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aalSpringProductRepositoryProvider); // aalSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aalBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AalProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aalSummerProductRepositoryProvider); // aalSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aalBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AalProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aalAutumnProductRepositoryProvider); // aalAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aalBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AalProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aalWinterProductRepositoryProvider); // aalWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AalEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AalEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AalEventPosterImgSectionList();

  @override
  _AalEventPosterImgSectionListState createState() =>
      _AalEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AalEventPosterImgSectionListState
    extends ConsumerState<AalEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aalEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aalEventPosterScrollPositionProvider.notifier).state =
...
Widget aalBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AalEventPosterImgSectionList(), // AalEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
