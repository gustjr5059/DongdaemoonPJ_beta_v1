...
// ------ AalHomeSmall1BannerRepository 클래스 시작
// 'AalHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AalHomeSmall1BannerRepository {
  ...
  AalHomeSmall1BannerRepository(this.firestore);
...
// ------ AalHomeSmall1BannerRepository 클래스 끝

// ------ AalHomeSmall2BannerRepository 클래스 시작
// 'AalHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AalHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AalHomeSmall2BannerRepository(this.firestore);
...
// ------ AalHomeSmall2BannerRepository 클래스 끝

// ------ AalHomeSmall3BannerRepository 클래스 시작
// 'AalHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AalHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AalHomeSmall3BannerRepository(this.firestore);
...
// ------ AalHomeSmall3BannerRepository 클래스 끝