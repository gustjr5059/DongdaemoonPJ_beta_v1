...
class AalNewProductRepository {
  ...
  List<String> collections = [
    'Aal1B1', 'Aal2B1', 'Aal3B1', 'Aal4B1', 'Aal5B1', 'Aal6B1',
    'Aal7B1', 'Aal8B1', 'Aal9B1', 'Aal10B1', 'Aal11B1', 'Aal12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aal10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aal10B1', 'Aal2B1' 등)
...
class AalBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aal1B2', 'Aal2B2', 'Aal3B2', 'Aal4B2', 'Aal5B2', 'Aal6B2',
    'Aal7B2', 'Aal8B2', 'Aal9B2', 'Aal10B2', 'Aal11B2', 'Aal12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalBestProductRepository(this.firestore); // 생성자
...
class AalSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aal1B3', 'Aal2B3', 'Aal3B3', 'Aal4B3', 'Aal5B3', 'Aal6B3',
    'Aal7B3', 'Aal8B3', 'Aal9B3', 'Aal10B3', 'Aal11B3', 'Aal12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalSaleProductRepository(this.firestore); // 생성자
...
class AalSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aal1B4', 'Aal2B4', 'Aal3B4', 'Aal4B4', 'Aal5B4', 'Aal6B4',
    'Aal7B4', 'Aal8B4', 'Aal9B4', 'Aal10B4', 'Aal11B4', 'Aal12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalSpringProductRepository(this.firestore); // 생성자
...
class AalSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aal1B5', 'Aal2B5', 'Aal3B5', 'Aal4B5', 'Aal5B5', 'Aal6B5',
    'Aal7B5', 'Aal8B5', 'Aal9B5', 'Aal10B5', 'Aal11B5', 'Aal12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalSummerProductRepository(this.firestore); // 생성자
...
class AalAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aal1B6', 'Aal2B6', 'Aal3B6', 'Aal4B6', 'Aal5B6', 'Aal6B6',
    'Aal7B6', 'Aal8B6', 'Aal9B6', 'Aal10B6', 'Aal11B6', 'Aal12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalAutumnProductRepository(this.firestore); // 생성자
...
class AalWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aal1B7', 'Aal2B7', 'Aal3B7', 'Aal4B7', 'Aal5B7', 'Aal6B7',
    'Aal7B7', 'Aal8B7', 'Aal9B7', 'Aal10B7', 'Aal11B7', 'Aal12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AalMainCategoryProductsRepository 시작 부분
class AalMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_12')
        .doc(mainCollection) // 'Aal10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aal10B1', 'Aal2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AalSectionCategoryProductsRepository 시작 부분
class AalSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AalSectionCategoryProductsRepository(this.firestore);
