...
class _AalJeanMainScreenState extends ConsumerState<AalJeanMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: jeanMainScreenLargeBannerWidth,
      height: jeanMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aalJeanMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aalJeanMainSmall1BannerImagesProvider).value ?? [], ref),
      width: jeanMainScreenSmallBannerWidth,
      height: jeanMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
