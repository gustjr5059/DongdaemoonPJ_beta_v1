...
class _AalPaedingMainScreenState extends ConsumerState<AalPaedingMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: paedingMainScreenLargeBannerWidth,
      height: paedingMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aalPaedingMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aalPaedingMainSmall1BannerImagesProvider).value ?? [], ref),
      width: paedingMainScreenSmallBannerWidth,
      height: paedingMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
