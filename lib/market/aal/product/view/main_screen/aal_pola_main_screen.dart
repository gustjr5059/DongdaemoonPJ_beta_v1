...
class _AalPolaMainScreenState extends ConsumerState<AalPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: polaMainScreenLargeBannerWidth,
      height: polaMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aalPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aalPolaMainSmall1BannerImagesProvider).value ?? [], ref),
      width: polaMainScreenSmallBannerWidth,
      height: polaMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
...
// _AalCardiganMainScreenState 클래스 끝// _AalCardiganMainScreenState 클래스 끝