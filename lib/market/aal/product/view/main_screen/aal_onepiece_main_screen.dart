...
class _AalOnepieceMainScreenState extends ConsumerState<AalOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: onepieceMainScreenLargeBannerWidth,
      height: onepieceMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aalOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aalOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
      width: onepieceMainScreenSmallBannerWidth,
      height: onepieceMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
