...
class _AalBestSubMainScreenState extends ConsumerState<AalBestSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aalBestSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aalBestSubMainSmall1BannerImagesProvider).value ?? [], ref),
                            ...
                            if (small1BannerWidget is! SizedBox) ...[
                              ...
                              CommonCardView(
                                content: Container(
                                  ...
                                  child: SizedBox(
                                    height: bestSubMainScreenSmallBannerViewHeight,
