...
class _AalAutumnSubMainScreenState extends ConsumerState<AalAutumnSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aalAutumnSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aalAutumnSubMainSmall1BannerImagesProvider).value ?? [], ref),
