...
// ------ AbaHomeSmall1BannerRepository 클래스 시작
// 'AbaHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbaHomeSmall1BannerRepository {
  ...
  AbaHomeSmall1BannerRepository(this.firestore);
...
// ------ AbaHomeSmall1BannerRepository 클래스 끝

// ------ AbaHomeSmall2BannerRepository 클래스 시작
// 'AbaHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbaHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AbaHomeSmall2BannerRepository(this.firestore);
...
// ------ AbaHomeSmall2BannerRepository 클래스 끝

// ------ AbaHomeSmall3BannerRepository 클래스 시작
// 'AbaHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbaHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AbaHomeSmall3BannerRepository(this.firestore);
...
// ------ AbaHomeSmall3BannerRepository 클래스 끝