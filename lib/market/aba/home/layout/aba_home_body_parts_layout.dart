...
import '../../product/layout/aba_product_body_parts_layout.dart';
import '../../product/provider/aba_product_all_providers.dart';
import '../../product/view/main_screen/aba_blouse_main_screen.dart';
import '../../product/view/main_screen/aba_cardigan_main_screen.dart';
import '../../product/view/main_screen/aba_coat_main_screen.dart';
import '../../product/view/main_screen/aba_jean_main_screen.dart';
import '../../product/view/main_screen/aba_mtm_main_screen.dart';
import '../../product/view/main_screen/aba_neat_main_screen.dart';
import '../../product/view/main_screen/aba_onepiece_main_screen.dart';
import '../../product/view/main_screen/aba_paeding_main_screen.dart';
import '../../product/view/main_screen/aba_pants_main_screen.dart';
import '../../product/view/main_screen/aba_pola_main_screen.dart';
import '../../product/view/main_screen/aba_shirt_main_screen.dart';
import '../../product/view/main_screen/aba_skirt_main_screen.dart';
import '../provider/aba_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void abaOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AbaNeatMainScreen(),
    AbaPolaMainScreen(),
    AbaOnepieceMainScreen(),
    AbaPantsMainScreen(),
    AbaJeanMainScreen(),
    AbaSkirtMainScreen(),
    AbaPaedingMainScreen(),
    AbaCoatMainScreen(),
    AbaCardiganMainScreen(),
  ];
...
Widget abaBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbaProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    abaNewProductRepositoryProvider); // abaNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abaBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbaProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abaBestProductRepositoryProvider); // abaBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abaBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbaProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abaSaleProductRepositoryProvider); // abaSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abaBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbaProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abaSpringProductRepositoryProvider); // abaSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abaBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbaProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abaSummerProductRepositoryProvider); // abaSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abaBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbaProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abaAutumnProductRepositoryProvider); // abaAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abaBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbaProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abaWinterProductRepositoryProvider); // abaWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AbaEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AbaEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AbaEventPosterImgSectionList();

  @override
  _AbaEventPosterImgSectionListState createState() =>
      _AbaEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AbaEventPosterImgSectionListState
    extends ConsumerState<AbaEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(abaEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(abaEventPosterScrollPositionProvider.notifier).state =
...
Widget abaBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbaEventPosterImgSectionList(), // AbaEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
