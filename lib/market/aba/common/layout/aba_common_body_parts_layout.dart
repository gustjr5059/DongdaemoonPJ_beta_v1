...
import '../../product/provider/aba_product_state_provider.dart';
...
void abaOnLargeBannerTap(BuildContext context, int index,
...
void abaOnSmallBannerTap(BuildContext context, int index,
...
class AbaStoreInitializer {
  final WidgetRef ref;

  AbaStoreInitializer(this.ref);
