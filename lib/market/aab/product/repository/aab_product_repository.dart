...
class AabNewProductRepository {
  ...
  List<String> collections = [
    'Aab1B1', 'Aab2B1', 'Aab3B1', 'Aab4B1', 'Aab5B1', 'Aab6B1',
    'Aab7B1', 'Aab8B1', 'Aab9B1', 'Aab10B1', 'Aab11B1', 'Aab12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          ...
          .doc(mainCollection) // 'Aab10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aab10B1', 'Aab2B1' 등)
...
class AabBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aab1B2', 'Aab2B2', 'Aab3B2', 'Aab4B2', 'Aab5B2', 'Aab6B2',
    'Aab7B2', 'Aab8B2', 'Aab9B2', 'Aab10B2', 'Aab11B2', 'Aab12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabBestProductRepository(this.firestore); // 생성자
...
class AabSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aab1B3', 'Aab2B3', 'Aab3B3', 'Aab4B3', 'Aab5B3', 'Aab6B3',
    'Aab7B3', 'Aab8B3', 'Aab9B3', 'Aab10B3', 'Aab11B3', 'Aab12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabSaleProductRepository(this.firestore); // 생성자
...
class AabSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aab1B4', 'Aab2B4', 'Aab3B4', 'Aab4B4', 'Aab5B4', 'Aab6B4',
    'Aab7B4', 'Aab8B4', 'Aab9B4', 'Aab10B4', 'Aab11B4', 'Aab12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabSpringProductRepository(this.firestore); // 생성자
...
class AabSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aab1B5', 'Aab2B5', 'Aab3B5', 'Aab4B5', 'Aab5B5', 'Aab6B5',
    'Aab7B5', 'Aab8B5', 'Aab9B5', 'Aab10B5', 'Aab11B5', 'Aab12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabSummerProductRepository(this.firestore); // 생성자
...
class AabAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aab1B6', 'Aab2B6', 'Aab3B6', 'Aab4B6', 'Aab5B6', 'Aab6B6',
    'Aab7B6', 'Aab8B6', 'Aab9B6', 'Aab10B6', 'Aab11B6', 'Aab12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabAutumnProductRepository(this.firestore); // 생성자
...
class AabWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aab1B7', 'Aab2B7', 'Aab3B7', 'Aab4B7', 'Aab5B7', 'Aab6B7',
    'Aab7B7', 'Aab8B7', 'Aab9B7', 'Aab10B7', 'Aab11B7', 'Aab12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AabMainCategoryProductsRepository 시작 부분
class AabMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_2')
        .doc(mainCollection) // 'Aab10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aab10B1', 'Aab2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AabSectionCategoryProductsRepository 시작 부분
class AabSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AabSectionCategoryProductsRepository(this.firestore);
