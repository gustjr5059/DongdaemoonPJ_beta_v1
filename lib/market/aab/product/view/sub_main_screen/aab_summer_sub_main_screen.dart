...
class _AabSummerSubMainScreenState extends ConsumerState<AabSummerSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aabSummerSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aabSummerSubMainSmall1BannerImagesProvider).value ?? [], ref),
