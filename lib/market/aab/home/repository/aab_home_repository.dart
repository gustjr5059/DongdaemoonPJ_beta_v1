...
// ------ AabHomeSmall1BannerRepository 클래스 시작
// 'AabHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AabHomeSmall1BannerRepository {
  ...
  AabHomeSmall1BannerRepository(this.firestore);
...
// ------ AabHomeSmall1BannerRepository 클래스 끝

// ------ AabHomeSmall2BannerRepository 클래스 시작
// 'AabHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AabHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AabHomeSmall2BannerRepository(this.firestore);
...
// ------ AabHomeSmall2BannerRepository 클래스 끝

// ------ AabHomeSmall3BannerRepository 클래스 시작
// 'AabHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AabHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AabHomeSmall3BannerRepository(this.firestore);
...
// ------ AabHomeSmall3BannerRepository 클래스 끝