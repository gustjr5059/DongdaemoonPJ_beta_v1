...
class AatNewProductRepository {
  ...
  List<String> collections = [
    'Aat1B1', 'Aat2B1', 'Aat3B1', 'Aat4B1', 'Aat5B1', 'Aat6B1',
    'Aat7B1', 'Aat8B1', 'Aat9B1', 'Aat10B1', 'Aat11B1', 'Aat12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_20')
          .doc(mainCollection) // 'Aat10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aat10B1', 'Aat2B1' 등)
...
class AatBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aat1B2', 'Aat2B2', 'Aat3B2', 'Aat4B2', 'Aat5B2', 'Aat6B2',
    'Aat7B2', 'Aat8B2', 'Aat9B2', 'Aat10B2', 'Aat11B2', 'Aat12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatBestProductRepository(this.firestore); // 생성자
...
class AatSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aat1B3', 'Aat2B3', 'Aat3B3', 'Aat4B3', 'Aat5B3', 'Aat6B3',
    'Aat7B3', 'Aat8B3', 'Aat9B3', 'Aat10B3', 'Aat11B3', 'Aat12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatSaleProductRepository(this.firestore); // 생성자
...
class AatSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aat1B4', 'Aat2B4', 'Aat3B4', 'Aat4B4', 'Aat5B4', 'Aat6B4',
    'Aat7B4', 'Aat8B4', 'Aat9B4', 'Aat10B4', 'Aat11B4', 'Aat12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatSpringProductRepository(this.firestore); // 생성자
...
class AatSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aat1B5', 'Aat2B5', 'Aat3B5', 'Aat4B5', 'Aat5B5', 'Aat6B5',
    'Aat7B5', 'Aat8B5', 'Aat9B5', 'Aat10B5', 'Aat11B5', 'Aat12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatSummerProductRepository(this.firestore); // 생성자
...
class AatAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aat1B6', 'Aat2B6', 'Aat3B6', 'Aat4B6', 'Aat5B6', 'Aat6B6',
    'Aat7B6', 'Aat8B6', 'Aat9B6', 'Aat10B6', 'Aat11B6', 'Aat12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatAutumnProductRepository(this.firestore); // 생성자
...
class AatWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aat1B7', 'Aat2B7', 'Aat3B7', 'Aat4B7', 'Aat5B7', 'Aat6B7',
    'Aat7B7', 'Aat8B7', 'Aat9B7', 'Aat10B7', 'Aat11B7', 'Aat12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AatMainCategoryProductsRepository 시작 부분
class AatMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_20')
        .doc(mainCollection) // 'Aat10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aat10B1', 'Aat2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AatSectionCategoryProductsRepository 시작 부분
class AatSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AatSectionCategoryProductsRepository(this.firestore);
