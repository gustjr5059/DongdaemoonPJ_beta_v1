...
class _AatJeanMainScreenState extends ConsumerState<AatJeanMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aatJeanMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aatJeanMainSmall1BannerImagesProvider).value ?? [], ref),
