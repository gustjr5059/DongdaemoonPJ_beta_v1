...
class _AatAutumnSubMainScreenState extends ConsumerState<AatAutumnSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aatAutumnSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aatAutumnSubMainSmall1BannerImagesProvider).value ?? [], ref),
