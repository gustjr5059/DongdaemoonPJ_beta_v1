...
// AatSummerSubMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AatSummerSubMainScreen extends ConsumerStatefulWidget {
  const AatSummerSubMainScreen({Key? key}) : super(key: key);

  @override
  _AatSummerSubMainScreenState createState() => _AatSummerSubMainScreenState();
}

// _AatSummerSubMainScreenState 클래스 시작
// _AatSummerSubMainScreenState 클래스는 AatSummerSubMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AatSummerSubMainScreenState extends ConsumerState<AatSummerSubMainScreen>
  ...
  // aatSummerSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(aatSummerSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // aatSummerSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aatSummerSubMainScrollPositionProvider'의 notifier를 읽어옴.
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (summerSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(aatSummerSubMainScrollPositionProvider);
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aatSummerSubMainLargeBannerPageProvider,
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aatSummerSubMainSmall1BannerPageProvider,
                                    ...
                                    bannerImagesProvider:
                                        aatSummerSubMainSmall1BannerImagesProvider,
                                    ...
                                    onPageTap: (context, index) =>
                                        ...
                                        aatOnSmallBannerTap(
                                            context, // 현재 화면의 컨텍스트를 전달함
                                            index, // 클릭된 배너의 인덱스를 전달함
                                            // aatSummerSubMainSmall1BannerImagesProvider에서 대배너 이미지 리스트를 가져옴. 값이 없으면 빈 리스트를 사용함
                                            ref
                                                    .watch(
                                                        aatSummerSubMainSmall1BannerImagesProvider)
                                                    .value ??
                            ...
                            AatPriceAndDiscountPercentSortButtons<
                              ...
                              productListProvider:
                                  aatSummerSubMainProductListProvider,
                              // 여름 제품 리스트 프로바이더 전달
                              sortButtonProvider:
                                  aatSummerSubMainSortButtonProvider, // 여름 정렬 버튼 프로바이더 전달
                            ),
                            // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: interval1Y),
...
// _AatSummerSubMainScreenState 클래스 끝
