...
import '../../product/layout/aat_product_body_parts_layout.dart';
import '../../product/provider/aat_product_all_providers.dart';
import '../../product/view/main_screen/aat_blouse_main_screen.dart';
import '../../product/view/main_screen/aat_cardigan_main_screen.dart';
import '../../product/view/main_screen/aat_coat_main_screen.dart';
import '../../product/view/main_screen/aat_jean_main_screen.dart';
import '../../product/view/main_screen/aat_mtm_main_screen.dart';
import '../../product/view/main_screen/aat_neat_main_screen.dart';
import '../../product/view/main_screen/aat_onepiece_main_screen.dart';
import '../../product/view/main_screen/aat_paeding_main_screen.dart';
import '../../product/view/main_screen/aat_pants_main_screen.dart';
import '../../product/view/main_screen/aat_pola_main_screen.dart';
import '../../product/view/main_screen/aat_shirt_main_screen.dart';
import '../../product/view/main_screen/aat_skirt_main_screen.dart';
import '../provider/aat_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aatOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AatNeatMainScreen(),
    AatPolaMainScreen(),
    AatOnepieceMainScreen(),
    AatPantsMainScreen(),
    AatJeanMainScreen(),
    AatSkirtMainScreen(),
    AatPaedingMainScreen(),
    AatCoatMainScreen(),
    AatCardiganMainScreen(),
  ];
...
Widget aatBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AatProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aatNewProductRepositoryProvider); // aatNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aatBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AatProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aatBestProductRepositoryProvider); // aatBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aatBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AatProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aatSaleProductRepositoryProvider); // aatSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aatBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AatProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aatSpringProductRepositoryProvider); // aatSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aatBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AatProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aatSummerProductRepositoryProvider); // aatSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aatBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AatProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aatAutumnProductRepositoryProvider); // aatAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aatBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AatProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aatWinterProductRepositoryProvider); // aatWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AatEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AatEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AatEventPosterImgSectionList();

  @override
  _AatEventPosterImgSectionListState createState() =>
      _AatEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AatEventPosterImgSectionListState
    extends ConsumerState<AatEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aatEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aatEventPosterScrollPositionProvider.notifier).state =
...
Widget aatBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AatEventPosterImgSectionList(), // AatEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
