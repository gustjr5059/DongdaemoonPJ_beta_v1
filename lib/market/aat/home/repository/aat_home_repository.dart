...
// ------ AatHomeSmall1BannerRepository 클래스 시작
// 'AatHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AatHomeSmall1BannerRepository {
  ...
  AatHomeSmall1BannerRepository(this.firestore);
...
// ------ AatHomeSmall1BannerRepository 클래스 끝

// ------ AatHomeSmall2BannerRepository 클래스 시작
// 'AatHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AatHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AatHomeSmall2BannerRepository(this.firestore);
...
// ------ AatHomeSmall2BannerRepository 클래스 끝

// ------ AatHomeSmall3BannerRepository 클래스 시작
// 'AatHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AatHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AatHomeSmall3BannerRepository(this.firestore);
...
// ------ AatHomeSmall3BannerRepository 클래스 끝