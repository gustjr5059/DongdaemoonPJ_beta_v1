...
// ------ AaiHomeSmall1BannerRepository 클래스 시작
// 'AaiHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaiHomeSmall1BannerRepository {
  ...
  AaiHomeSmall1BannerRepository(this.firestore);
...
// ------ AaiHomeSmall1BannerRepository 클래스 끝

// ------ AaiHomeSmall2BannerRepository 클래스 시작
// 'AaiHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaiHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaiHomeSmall2BannerRepository(this.firestore);
...
// ------ AaiHomeSmall2BannerRepository 클래스 끝

// ------ AaiHomeSmall3BannerRepository 클래스 시작
// 'AaiHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaiHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaiHomeSmall3BannerRepository(this.firestore);
...
// ------ AaiHomeSmall3BannerRepository 클래스 끝