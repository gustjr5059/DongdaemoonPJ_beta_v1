...
import '../../product/layout/aai_product_body_parts_layout.dart';
import '../../product/provider/aai_product_all_providers.dart';
import '../../product/view/main_screen/aai_blouse_main_screen.dart';
import '../../product/view/main_screen/aai_cardigan_main_screen.dart';
import '../../product/view/main_screen/aai_coat_main_screen.dart';
import '../../product/view/main_screen/aai_jean_main_screen.dart';
import '../../product/view/main_screen/aai_mtm_main_screen.dart';
import '../../product/view/main_screen/aai_neat_main_screen.dart';
import '../../product/view/main_screen/aai_onepiece_main_screen.dart';
import '../../product/view/main_screen/aai_paeding_main_screen.dart';
import '../../product/view/main_screen/aai_pants_main_screen.dart';
import '../../product/view/main_screen/aai_pola_main_screen.dart';
import '../../product/view/main_screen/aai_shirt_main_screen.dart';
import '../../product/view/main_screen/aai_skirt_main_screen.dart';
import '../provider/aai_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aaiOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AaiNeatMainScreen(),
    AaiPolaMainScreen(),
    AaiOnepieceMainScreen(),
    AaiPantsMainScreen(),
    AaiJeanMainScreen(),
    AaiSkirtMainScreen(),
    AaiPaedingMainScreen(),
    AaiCoatMainScreen(),
    AaiCardiganMainScreen(),
  ];
...
Widget aaiBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AaiProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aaiNewProductRepositoryProvider); // aaiNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaiBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaiProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaiBestProductRepositoryProvider); // aaiBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaiBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaiProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaiSaleProductRepositoryProvider); // aaiSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaiBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaiProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaiSpringProductRepositoryProvider); // aaiSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaiBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaiProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaiSummerProductRepositoryProvider); // aaiSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaiBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaiProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaiAutumnProductRepositoryProvider); // aaiAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaiBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaiProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaiWinterProductRepositoryProvider); // aaiWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AaiEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AaiEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AaiEventPosterImgSectionList();

  @override
  _AaiEventPosterImgSectionListState createState() =>
      _AaiEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AaiEventPosterImgSectionListState
    extends ConsumerState<AaiEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aaiEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aaiEventPosterScrollPositionProvider.notifier).state =
...
Widget aaiBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AaiEventPosterImgSectionList(), // AaiEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
