...
class _AaiBestSubMainScreenState extends ConsumerState<AaiBestSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaiBestSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaiBestSubMainSmall1BannerImagesProvider).value ?? [], ref),
