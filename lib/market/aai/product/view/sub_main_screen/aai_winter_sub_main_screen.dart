...
class _AaiWinterSubMainScreenState extends ConsumerState<AaiWinterSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaiWinterSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaiWinterSubMainSmall1BannerImagesProvider).value ?? [], ref),
