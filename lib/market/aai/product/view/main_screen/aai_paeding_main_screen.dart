...
class _AaiPaedingMainScreenState extends ConsumerState<AaiPaedingMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaiPaedingMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaiPaedingMainSmall1BannerImagesProvider).value ?? [], ref),
