...
class _AaiPolaMainScreenState extends ConsumerState<AaiPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaiPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaiPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AaiCardiganMainScreenState 클래스 끝// _AaiCardiganMainScreenState 클래스 끝