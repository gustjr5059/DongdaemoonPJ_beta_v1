...
import '../../common/layout/aav_common_body_parts_layout.dart';
import '../../common/provider/aav_common_all_provider.dart';
import '../../product/provider/aav_product_all_providers.dart';
import '../../product/view/sub_main_screen/aav_autumn_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aav_best_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aav_new_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aav_sale_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aav_spring_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aav_summer_sub_main_screen.dart';
import '../../product/view/sub_main_screen/aav_winter_sub_main_screen.dart';
import '../layout/aav_home_body_parts_layout.dart';

// 현재 디렉토리의 부모 디렉토리에 위치한 provider 폴더에서 aav_home_all_providers.dart 파일을 가져옵니다.
// 이 파일은 홈 화면과 관련된 Future Provider 기능을 제공합니다.
// 이를 통해 홈 화면에서 비동기 데이터를 호출하고 상태를 관리할 수 있습니다.
import '../provider/aav_home_all_providers.dart';

// 홈 화면의 상태를 관리하기 위한 Provider 파일을 임포트합니다.
import '../provider/aav_home_state_provider.dart';
...
// AavHomeMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AavHomeMainScreen extends ConsumerStatefulWidget {
  const AavHomeMainScreen({Key? key}) : super(key: key);

  @override
  _AavHomeMainScreenState createState() => _AavHomeMainScreenState();
}

// _AavHomeMainScreenState 클래스 시작
// _AavHomeMainScreenState 클래스는 AavHomeMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AavHomeMainScreenState extends ConsumerState<AavHomeMainScreen>
  ...
  void _onScroll() {
    ...
    if (newCurrentIndex != currentIndex) {
      ...
      ref.read(aavHomeCurrentTabProvider.notifier).state = currentIndex; // 상태 업데이트
    }
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aavHomeScrollPositionProvider'의 notifier를 읽어옴.
    // 읽어온 notifier의 'state' 값을 'currentScrollPosition'으로 설정함.
    // 이렇게 하면 앱의 다른 부분에서 해당 스크롤 위치 정보를 참조할 수 있게 됨.
    ref.read(aavHomeScrollPositionProvider.notifier).state = currentScrollPosition;
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (homeScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition = FirebaseAuth.instance.currentUser != null
            ? ref.read(aavHomeScrollPositionProvider)
            : ref.read(aavHomeLoginAndLogoutScrollPositionProvider);
        // 저장된 위치로 스크롤 이동
      ...
      currentIndex = ref.read(aavHomeCurrentTabProvider);
    ...
    FirebaseAuth.instance.authStateChanges().listen((user) {
      ...
      if (user == null) {
        ...
        ref.read(aavHomeLargeBannerPageProvider.notifier).state = 0;
        ref.read(aavHomeSmall1BannerPageProvider.notifier).state = 0;
        ref.read(aavHomeSmall2BannerPageProvider.notifier).state = 0;
        ref.read(aavHomeSmall3BannerPageProvider.notifier).state = 0;
  ...
  Widget build(BuildContext context) {
    ...
    Widget topBarList = buildTopBarList(context, onTopBarTap,
        aavHomeCurrentTabProvider, homeTopBarPointAutoScrollController);
    // ------ aav_common_body_parts_layout.dart 내 buildTopBarList, onTopBarTap 재사용하여 TopBar 구현 내용 끝
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aavHomeSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aavHomeSmall1BannerImagesProvider).value ?? [], ref),
    ...
    final small2BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aavHomeSmall2BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aavHomeSmall2BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
    ...
    final small3BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aavHomeSmall3BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aavHomeSmall3BannerImagesProvider).value ?? [], ref),
      width: homeScreenSmallBannerWidth,
      height: homeScreenSmallBannerHeight,
      borderRadius: 5,
    );
                        ...
                        children: [
                          ...
                          CommonCardView(
                            ...
                            content: Container(
                              child: MidCategoryButtonList(
                                onCategoryTap: aavOnMidCategoryTap,
                              ),
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "신상", aavBuildNewProductsSection,
                                destinationScreen: AavNewSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(context, ref, "스테디 셀러",
                                aavBuildBestProductsSection,
                                destinationScreen: AavBestSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            key: sectionSaleKey,
                            child: buildSectionCard(
                                context, ref, "특가 상품", aavBuildSaleProductsSection,
                                destinationScreen: AavSaleSubMainScreen(),
                                showPlusButton: true),
                          ),
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "봄", aavBuildSpringProductsSection,
                                destinationScreen: AavSpringSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "여름", aavBuildSummerProductsSection,
                                destinationScreen: AavSummerSubMainScreen(),
                                showPlusButton: true),
                          ),
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "가을", aavBuildAutumnProductsSection,
                                destinationScreen: AavAutumnSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(
                                context, ref, "겨울", aavBuildWinterProductsSection,
                                destinationScreen: AavWinterSubMainScreen(),
                                showPlusButton: true),
                          ),
                          Container(
                            decoration: BoxDecoration(
                          ...
                          Container(
                            ...
                            child: buildSectionCard(context, ref, "이벤트",
                                aavBuildEventPosterImgProductsSection,
