...
// ------ AavHomeSmall1BannerRepository 클래스 시작
// 'AavHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AavHomeSmall1BannerRepository {
  ...
  AavHomeSmall1BannerRepository(this.firestore);
...
// ------ AavHomeSmall1BannerRepository 클래스 끝

// ------ AavHomeSmall2BannerRepository 클래스 시작
// 'AavHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AavHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AavHomeSmall2BannerRepository(this.firestore);
...
// ------ AavHomeSmall2BannerRepository 클래스 끝

// ------ AavHomeSmall3BannerRepository 클래스 시작
// 'AavHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AavHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AavHomeSmall3BannerRepository(this.firestore);
...
// ------ AavHomeSmall3BannerRepository 클래스 끝