...
import '../../product/layout/aav_product_body_parts_layout.dart';
import '../../product/provider/aav_product_all_providers.dart';
import '../../product/view/main_screen/aav_blouse_main_screen.dart';
import '../../product/view/main_screen/aav_cardigan_main_screen.dart';
import '../../product/view/main_screen/aav_coat_main_screen.dart';
import '../../product/view/main_screen/aav_jean_main_screen.dart';
import '../../product/view/main_screen/aav_mtm_main_screen.dart';
import '../../product/view/main_screen/aav_neat_main_screen.dart';
import '../../product/view/main_screen/aav_onepiece_main_screen.dart';
import '../../product/view/main_screen/aav_paeding_main_screen.dart';
import '../../product/view/main_screen/aav_pants_main_screen.dart';
import '../../product/view/main_screen/aav_pola_main_screen.dart';
import '../../product/view/main_screen/aav_shirt_main_screen.dart';
import '../../product/view/main_screen/aav_skirt_main_screen.dart';
import '../provider/aav_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aavOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AavNeatMainScreen(),
    AavPolaMainScreen(),
    AavOnepieceMainScreen(),
    AavPantsMainScreen(),
    AavJeanMainScreen(),
    AavSkirtMainScreen(),
    AavPaedingMainScreen(),
    AavCoatMainScreen(),
    AavCardiganMainScreen(),
  ];
...
Widget aavBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AavProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aavNewProductRepositoryProvider); // aavNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aavBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AavProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aavBestProductRepositoryProvider); // aavBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aavBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AavProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aavSaleProductRepositoryProvider); // aavSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aavBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AavProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aavSpringProductRepositoryProvider); // aavSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aavBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AavProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aavSummerProductRepositoryProvider); // aavSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aavBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AavProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aavAutumnProductRepositoryProvider); // aavAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aavBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AavProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aavWinterProductRepositoryProvider); // aavWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AavEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AavEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AavEventPosterImgSectionList();

  @override
  _AavEventPosterImgSectionListState createState() =>
      _AavEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AavEventPosterImgSectionListState
    extends ConsumerState<AavEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aavEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aavEventPosterScrollPositionProvider.notifier).state =
...
Widget aavBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AavEventPosterImgSectionList(), // AavEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
