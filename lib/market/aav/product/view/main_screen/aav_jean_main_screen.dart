...
class _AavJeanMainScreenState extends ConsumerState<AavJeanMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aavJeanMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aavJeanMainSmall1BannerImagesProvider).value ?? [], ref),
