...
class _AavOnepieceMainScreenState extends ConsumerState<AavOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aavOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aavOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
