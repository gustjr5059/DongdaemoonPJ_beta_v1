...
class AavNewProductRepository {
  ...
  List<String> collections = [
    'Aav1B1', 'Aav2B1', 'Aav3B1', 'Aav4B1', 'Aav5B1', 'Aav6B1',
    'Aav7B1', 'Aav8B1', 'Aav9B1', 'Aav10B1', 'Aav11B1', 'Aav12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_22')
          .doc(mainCollection) // 'Aav10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aav10B1', 'Aav2B1' 등)
...
class AavBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aav1B2', 'Aav2B2', 'Aav3B2', 'Aav4B2', 'Aav5B2', 'Aav6B2',
    'Aav7B2', 'Aav8B2', 'Aav9B2', 'Aav10B2', 'Aav11B2', 'Aav12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavBestProductRepository(this.firestore); // 생성자
...
class AavSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aav1B3', 'Aav2B3', 'Aav3B3', 'Aav4B3', 'Aav5B3', 'Aav6B3',
    'Aav7B3', 'Aav8B3', 'Aav9B3', 'Aav10B3', 'Aav11B3', 'Aav12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavSaleProductRepository(this.firestore); // 생성자
...
class AavSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aav1B4', 'Aav2B4', 'Aav3B4', 'Aav4B4', 'Aav5B4', 'Aav6B4',
    'Aav7B4', 'Aav8B4', 'Aav9B4', 'Aav10B4', 'Aav11B4', 'Aav12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavSpringProductRepository(this.firestore); // 생성자
...
class AavSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aav1B5', 'Aav2B5', 'Aav3B5', 'Aav4B5', 'Aav5B5', 'Aav6B5',
    'Aav7B5', 'Aav8B5', 'Aav9B5', 'Aav10B5', 'Aav11B5', 'Aav12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavSummerProductRepository(this.firestore); // 생성자
...
class AavAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aav1B6', 'Aav2B6', 'Aav3B6', 'Aav4B6', 'Aav5B6', 'Aav6B6',
    'Aav7B6', 'Aav8B6', 'Aav9B6', 'Aav10B6', 'Aav11B6', 'Aav12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavAutumnProductRepository(this.firestore); // 생성자
...
class AavWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aav1B7', 'Aav2B7', 'Aav3B7', 'Aav4B7', 'Aav5B7', 'Aav6B7',
    'Aav7B7', 'Aav8B7', 'Aav9B7', 'Aav10B7', 'Aav11B7', 'Aav12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AavMainCategoryProductsRepository 시작 부분
class AavMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_22')
        .doc(mainCollection) // 'Aav10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aav10B1', 'Aav2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AavSectionCategoryProductsRepository 시작 부분
class AavSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AavSectionCategoryProductsRepository(this.firestore);
