...
class _AbdSaleSubMainScreenState extends ConsumerState<AbdSaleSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abdSaleSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abdSaleSubMainSmall1BannerImagesProvider).value ?? [], ref),
