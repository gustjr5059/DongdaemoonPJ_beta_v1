...
class _AbdAutumnSubMainScreenState extends ConsumerState<AbdAutumnSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abdAutumnSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abdAutumnSubMainSmall1BannerImagesProvider).value ?? [], ref),
