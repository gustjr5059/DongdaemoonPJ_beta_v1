...
class _AbdShirtMainScreenState extends ConsumerState<AbdShirtMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: shirtMainScreenLargeBannerWidth,
      height: shirtMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abdShirtMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abdShirtMainSmall1BannerImagesProvider).value ?? [], ref),
      width: shirtMainScreenSmallBannerWidth,
      height: shirtMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
