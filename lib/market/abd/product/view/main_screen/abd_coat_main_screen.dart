...
class _AbdCoatMainScreenState extends ConsumerState<AbdCoatMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final largeBannerWidget = buildCommonBannerPageViewSection<AllLargeBannerImage>(
      ...
      width: coatMainScreenLargeBannerWidth,
      height: coatMainScreenLargeBannerHeight,
      borderRadius: 0,
    );
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abdCoatMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abdCoatMainSmall1BannerImagesProvider).value ?? [], ref),
      width: coatMainScreenSmallBannerWidth,
      height: coatMainScreenSmallBannerHeight,
      borderRadius: 5,
    );
