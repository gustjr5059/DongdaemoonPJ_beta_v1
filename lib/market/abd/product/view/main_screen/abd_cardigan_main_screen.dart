...
class _AbdCardiganMainScreenState extends ConsumerState<AbdCardiganMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abdCardiganMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abdCardiganMainSmall1BannerImagesProvider).value ?? [], ref),
