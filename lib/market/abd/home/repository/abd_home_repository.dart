...
// ------ AbdHomeSmall1BannerRepository 클래스 시작
// 'AbdHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbdHomeSmall1BannerRepository {
  ...
  AbdHomeSmall1BannerRepository(this.firestore);
...
// ------ AbdHomeSmall1BannerRepository 클래스 끝

// ------ AbdHomeSmall2BannerRepository 클래스 시작
// 'AbdHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbdHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AbdHomeSmall2BannerRepository(this.firestore);
...
// ------ AbdHomeSmall2BannerRepository 클래스 끝

// ------ AbdHomeSmall3BannerRepository 클래스 시작
// 'AbdHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbdHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AbdHomeSmall3BannerRepository(this.firestore);
...
// ------ AbdHomeSmall3BannerRepository 클래스 끝