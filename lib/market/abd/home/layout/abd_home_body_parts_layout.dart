...
import '../../product/layout/abd_product_body_parts_layout.dart';
import '../../product/provider/abd_product_all_providers.dart';
import '../../product/view/main_screen/abd_blouse_main_screen.dart';
import '../../product/view/main_screen/abd_cardigan_main_screen.dart';
import '../../product/view/main_screen/abd_coat_main_screen.dart';
import '../../product/view/main_screen/abd_jean_main_screen.dart';
import '../../product/view/main_screen/abd_mtm_main_screen.dart';
import '../../product/view/main_screen/abd_neat_main_screen.dart';
import '../../product/view/main_screen/abd_onepiece_main_screen.dart';
import '../../product/view/main_screen/abd_paeding_main_screen.dart';
import '../../product/view/main_screen/abd_pants_main_screen.dart';
import '../../product/view/main_screen/abd_pola_main_screen.dart';
import '../../product/view/main_screen/abd_shirt_main_screen.dart';
import '../../product/view/main_screen/abd_skirt_main_screen.dart';
import '../provider/abd_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void abdOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AbdNeatMainScreen(),
    AbdPolaMainScreen(),
    AbdOnepieceMainScreen(),
    AbdPantsMainScreen(),
    AbdJeanMainScreen(),
    AbdSkirtMainScreen(),
    AbdPaedingMainScreen(),
    AbdCoatMainScreen(),
    AbdCardiganMainScreen(),
  ];
...
Widget abdBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbdProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    abdNewProductRepositoryProvider); // abdNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abdBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbdProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abdBestProductRepositoryProvider); // abdBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abdBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbdProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abdSaleProductRepositoryProvider); // abdSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abdBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbdProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abdSpringProductRepositoryProvider); // abdSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abdBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbdProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abdSummerProductRepositoryProvider); // abdSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abdBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbdProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abdAutumnProductRepositoryProvider); // abdAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abdBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbdProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abdWinterProductRepositoryProvider); // abdWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AbdEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AbdEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AbdEventPosterImgSectionList();

  @override
  _AbdEventPosterImgSectionListState createState() =>
      _AbdEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AbdEventPosterImgSectionListState
    extends ConsumerState<AbdEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(abdEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(abdEventPosterScrollPositionProvider.notifier).state =
...
Widget abdBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbdEventPosterImgSectionList(), // AbdEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
