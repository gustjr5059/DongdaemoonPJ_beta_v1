...
class _AaoNewSubMainScreenState extends ConsumerState<AaoNewSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaoNewSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaoNewSubMainSmall1BannerImagesProvider).value ?? [], ref),
