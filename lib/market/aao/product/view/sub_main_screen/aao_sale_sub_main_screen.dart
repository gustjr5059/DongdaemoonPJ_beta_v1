...
class _AaoSaleSubMainScreenState extends ConsumerState<AaoSaleSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaoSaleSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaoSaleSubMainSmall1BannerImagesProvider).value ?? [], ref),
