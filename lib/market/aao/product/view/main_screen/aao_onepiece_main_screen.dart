...
class _AaoOnepieceMainScreenState extends ConsumerState<AaoOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aaoOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aaoOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
