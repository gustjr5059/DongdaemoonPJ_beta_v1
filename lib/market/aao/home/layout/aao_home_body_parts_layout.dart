...
import '../../product/layout/aao_product_body_parts_layout.dart';
import '../../product/provider/aao_product_all_providers.dart';
import '../../product/view/main_screen/aao_blouse_main_screen.dart';
import '../../product/view/main_screen/aao_cardigan_main_screen.dart';
import '../../product/view/main_screen/aao_coat_main_screen.dart';
import '../../product/view/main_screen/aao_jean_main_screen.dart';
import '../../product/view/main_screen/aao_mtm_main_screen.dart';
import '../../product/view/main_screen/aao_neat_main_screen.dart';
import '../../product/view/main_screen/aao_onepiece_main_screen.dart';
import '../../product/view/main_screen/aao_paeding_main_screen.dart';
import '../../product/view/main_screen/aao_pants_main_screen.dart';
import '../../product/view/main_screen/aao_pola_main_screen.dart';
import '../../product/view/main_screen/aao_shirt_main_screen.dart';
import '../../product/view/main_screen/aao_skirt_main_screen.dart';
import '../provider/aao_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aaoOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AaoNeatMainScreen(),
    AaoPolaMainScreen(),
    AaoOnepieceMainScreen(),
    AaoPantsMainScreen(),
    AaoJeanMainScreen(),
    AaoSkirtMainScreen(),
    AaoPaedingMainScreen(),
    AaoCoatMainScreen(),
    AaoCardiganMainScreen(),
  ];
...
Widget aaoBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AaoProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aaoNewProductRepositoryProvider); // aaoNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaoBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaoProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaoBestProductRepositoryProvider); // aaoBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaoBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaoProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaoSaleProductRepositoryProvider); // aaoSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaoBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaoProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaoSpringProductRepositoryProvider); // aaoSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaoBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaoProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaoSummerProductRepositoryProvider); // aaoSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaoBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaoProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaoAutumnProductRepositoryProvider); // aaoAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aaoBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AaoProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aaoWinterProductRepositoryProvider); // aaoWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AaoEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AaoEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AaoEventPosterImgSectionList();

  @override
  _AaoEventPosterImgSectionListState createState() =>
      _AaoEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AaoEventPosterImgSectionListState
    extends ConsumerState<AaoEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aaoEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aaoEventPosterScrollPositionProvider.notifier).state =
...
Widget aaoBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AaoEventPosterImgSectionList(), // AaoEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
