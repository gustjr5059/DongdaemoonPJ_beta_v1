...
// ------ AaoHomeSmall1BannerRepository 클래스 시작
// 'AaoHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaoHomeSmall1BannerRepository {
  ...
  AaoHomeSmall1BannerRepository(this.firestore);
...
// ------ AaoHomeSmall1BannerRepository 클래스 끝

// ------ AaoHomeSmall2BannerRepository 클래스 시작
// 'AaoHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaoHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaoHomeSmall2BannerRepository(this.firestore);
...
// ------ AaoHomeSmall2BannerRepository 클래스 끝

// ------ AaoHomeSmall3BannerRepository 클래스 시작
// 'AaoHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AaoHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AaoHomeSmall3BannerRepository(this.firestore);
...
// ------ AaoHomeSmall3BannerRepository 클래스 끝