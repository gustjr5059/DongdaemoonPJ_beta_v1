...
class AbcNewProductRepository {
  ...
  List<String> collections = [
    'Abc1B1', 'Abc2B1', 'Abc3B1', 'Abc4B1', 'Abc5B1', 'Abc6B1',
    'Abc7B1', 'Abc8B1', 'Abc9B1', 'Abc10B1', 'Abc11B1', 'Abc12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_29')
          .doc(mainCollection) // 'Abc10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Abc10B1', 'Abc2B1' 등)
...
class AbcBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abc1B2', 'Abc2B2', 'Abc3B2', 'Abc4B2', 'Abc5B2', 'Abc6B2',
    'Abc7B2', 'Abc8B2', 'Abc9B2', 'Abc10B2', 'Abc11B2', 'Abc12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcBestProductRepository(this.firestore); // 생성자
...
class AbcSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abc1B3', 'Abc2B3', 'Abc3B3', 'Abc4B3', 'Abc5B3', 'Abc6B3',
    'Abc7B3', 'Abc8B3', 'Abc9B3', 'Abc10B3', 'Abc11B3', 'Abc12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcSaleProductRepository(this.firestore); // 생성자
...
class AbcSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abc1B4', 'Abc2B4', 'Abc3B4', 'Abc4B4', 'Abc5B4', 'Abc6B4',
    'Abc7B4', 'Abc8B4', 'Abc9B4', 'Abc10B4', 'Abc11B4', 'Abc12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcSpringProductRepository(this.firestore); // 생성자
...
class AbcSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abc1B5', 'Abc2B5', 'Abc3B5', 'Abc4B5', 'Abc5B5', 'Abc6B5',
    'Abc7B5', 'Abc8B5', 'Abc9B5', 'Abc10B5', 'Abc11B5', 'Abc12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcSummerProductRepository(this.firestore); // 생성자
...
class AbcAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abc1B6', 'Abc2B6', 'Abc3B6', 'Abc4B6', 'Abc5B6', 'Abc6B6',
    'Abc7B6', 'Abc8B6', 'Abc9B6', 'Abc10B6', 'Abc11B6', 'Abc12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcAutumnProductRepository(this.firestore); // 생성자
...
class AbcWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Abc1B7', 'Abc2B7', 'Abc3B7', 'Abc4B7', 'Abc5B7', 'Abc6B7',
    'Abc7B7', 'Abc8B7', 'Abc9B7', 'Abc10B7', 'Abc11B7', 'Abc12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AbcMainCategoryProductsRepository 시작 부분
class AbcMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_29')
        .doc(mainCollection) // 'Abc10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Abc10B1', 'Abc2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AbcSectionCategoryProductsRepository 시작 부분
class AbcSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AbcSectionCategoryProductsRepository(this.firestore);
