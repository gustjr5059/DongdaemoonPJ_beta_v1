...
class _AbcSaleSubMainScreenState extends ConsumerState<AbcSaleSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abcSaleSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abcSaleSubMainSmall1BannerImagesProvider).value ?? [], ref),
