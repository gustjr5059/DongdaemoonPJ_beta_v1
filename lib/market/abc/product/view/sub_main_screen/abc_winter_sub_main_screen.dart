...
// AbcWinterSubMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AbcWinterSubMainScreen extends ConsumerStatefulWidget {
  const AbcWinterSubMainScreen({Key? key}) : super(key: key);

  @override
  _AbcWinterSubMainScreenState createState() => _AbcWinterSubMainScreenState();
}

// _AbcWinterSubMainScreenState 클래스 시작
// _AbcWinterSubMainScreenState 클래스는 AbcWinterSubMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AbcWinterSubMainScreenState extends ConsumerState<AbcWinterSubMainScreen>
  ...
  // abcWinterSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(abcWinterSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // abcWinterSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'abcWinterSubMainScrollPositionProvider'의 notifier를 읽어옴.
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (winterSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(abcWinterSubMainScrollPositionProvider);
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        abcWinterSubMainLargeBannerPageProvider,
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        abcWinterSubMainSmall1BannerPageProvider,
                                    ...
                                    bannerImagesProvider:
                                        abcWinterSubMainSmall1BannerImagesProvider,
                            ...
                            AbcPriceAndDiscountPercentSortButtons<
                              ...
                              productListProvider:
                                  abcWinterSubMainProductListProvider,
                              // 겨울 제품 리스트 프로바이더 전달
                              sortButtonProvider:
                                  abcWinterSubMainSortButtonProvider, // 겨울 정렬 버튼 프로바이더 전달
                            ),
                            // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: interval1Y),
...
// _AbcWinterSubMainScreenState 클래스 끝
