...
class _AbcWinterSubMainScreenState extends ConsumerState<AbcWinterSubMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abcWinterSubMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abcWinterSubMainSmall1BannerImagesProvider).value ?? [], ref),
