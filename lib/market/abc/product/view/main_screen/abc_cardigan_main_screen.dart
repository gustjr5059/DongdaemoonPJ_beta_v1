...
class _AbcCardiganMainScreenState extends ConsumerState<AbcCardiganMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abcCardiganMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abcCardiganMainSmall1BannerImagesProvider).value ?? [], ref),
