...
class _AbcOnepieceMainScreenState extends ConsumerState<AbcOnepieceMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: abcOnepieceMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(abcOnepieceMainSmall1BannerImagesProvider).value ?? [], ref),
