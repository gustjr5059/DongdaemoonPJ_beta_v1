...
import '../../product/layout/abc_product_body_parts_layout.dart';
import '../../product/provider/abc_product_all_providers.dart';
import '../../product/view/main_screen/abc_blouse_main_screen.dart';
import '../../product/view/main_screen/abc_cardigan_main_screen.dart';
import '../../product/view/main_screen/abc_coat_main_screen.dart';
import '../../product/view/main_screen/abc_jean_main_screen.dart';
import '../../product/view/main_screen/abc_mtm_main_screen.dart';
import '../../product/view/main_screen/abc_neat_main_screen.dart';
import '../../product/view/main_screen/abc_onepiece_main_screen.dart';
import '../../product/view/main_screen/abc_paeding_main_screen.dart';
import '../../product/view/main_screen/abc_pants_main_screen.dart';
import '../../product/view/main_screen/abc_pola_main_screen.dart';
import '../../product/view/main_screen/abc_shirt_main_screen.dart';
import '../../product/view/main_screen/abc_skirt_main_screen.dart';
import '../provider/abc_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void abcOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AbcNeatMainScreen(),
    AbcPolaMainScreen(),
    AbcOnepieceMainScreen(),
    AbcPantsMainScreen(),
    AbcJeanMainScreen(),
    AbcSkirtMainScreen(),
    AbcPaedingMainScreen(),
    AbcCoatMainScreen(),
    AbcCardiganMainScreen(),
  ];
...
Widget abcBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbcProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    abcNewProductRepositoryProvider); // abcNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abcBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbcProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abcBestProductRepositoryProvider); // abcBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abcBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbcProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abcSaleProductRepositoryProvider); // abcSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abcBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbcProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abcSpringProductRepositoryProvider); // abcSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abcBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbcProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abcSummerProductRepositoryProvider); // abcSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abcBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbcProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abcAutumnProductRepositoryProvider); // abcAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget abcBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AbcProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    abcWinterProductRepositoryProvider); // abcWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AbcEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AbcEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AbcEventPosterImgSectionList();

  @override
  _AbcEventPosterImgSectionListState createState() =>
      _AbcEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AbcEventPosterImgSectionListState
    extends ConsumerState<AbcEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(abcEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(abcEventPosterScrollPositionProvider.notifier).state =
...
Widget abcBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AbcEventPosterImgSectionList(), // AbcEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
