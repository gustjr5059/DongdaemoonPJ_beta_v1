...
// ------ AbcHomeSmall1BannerRepository 클래스 시작
// 'AbcHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbcHomeSmall1BannerRepository {
  ...
  AbcHomeSmall1BannerRepository(this.firestore);
...
// ------ AbcHomeSmall1BannerRepository 클래스 끝

// ------ AbcHomeSmall2BannerRepository 클래스 시작
// 'AbcHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbcHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AbcHomeSmall2BannerRepository(this.firestore);
...
// ------ AbcHomeSmall2BannerRepository 클래스 끝

// ------ AbcHomeSmall3BannerRepository 클래스 시작
// 'AbcHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AbcHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AbcHomeSmall3BannerRepository(this.firestore);
...
// ------ AbcHomeSmall3BannerRepository 클래스 끝