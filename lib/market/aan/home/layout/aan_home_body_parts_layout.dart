...
import '../../product/layout/aan_product_body_parts_layout.dart';
import '../../product/provider/aan_product_all_providers.dart';
import '../../product/view/main_screen/aan_blouse_main_screen.dart';
import '../../product/view/main_screen/aan_cardigan_main_screen.dart';
import '../../product/view/main_screen/aan_coat_main_screen.dart';
import '../../product/view/main_screen/aan_jean_main_screen.dart';
import '../../product/view/main_screen/aan_mtm_main_screen.dart';
import '../../product/view/main_screen/aan_neat_main_screen.dart';
import '../../product/view/main_screen/aan_onepiece_main_screen.dart';
import '../../product/view/main_screen/aan_paeding_main_screen.dart';
import '../../product/view/main_screen/aan_pants_main_screen.dart';
import '../../product/view/main_screen/aan_pola_main_screen.dart';
import '../../product/view/main_screen/aan_shirt_main_screen.dart';
import '../../product/view/main_screen/aan_skirt_main_screen.dart';
import '../provider/aan_home_state_provider.dart';


// 홈 카테고리 버튼이 탭되었을 때 호출되는 함수
void aanOnMidCategoryTap(BuildContext context, WidgetRef ref, int index) {
  final List<Widget> midcategoryPages = [
    ...
    AanNeatMainScreen(),
    AanPolaMainScreen(),
    AanOnepieceMainScreen(),
    AanPantsMainScreen(),
    AanJeanMainScreen(),
    AanSkirtMainScreen(),
    AanPaedingMainScreen(),
    AanCoatMainScreen(),
    AanCardiganMainScreen(),
  ];
...
Widget aanBuildNewProductsSection(WidgetRef ref, BuildContext context) {
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AanProductsSectionList(
              category: '신상', // '신상' 카테고리를 설정
              fetchProducts: (limit, startAfter) async {
                // 신상품 데이터를 가져오는 비동기 함수를 설정
                final repository = ref.watch(
                    aanNewProductRepositoryProvider); // aanNewProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aanBuildBestProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AanProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aanBestProductRepositoryProvider); // aanBestProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aanBuildSaleProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AanProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aanSaleProductRepositoryProvider); // aanSaleProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aanBuildSpringProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AanProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aanSpringProductRepositoryProvider); // aanSpringProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aanBuildSummerProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AanProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aanSummerProductRepositoryProvider); // aanSummerProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aanBuildAutumnProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AanProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aanAutumnProductRepositoryProvider); // aanAutumnProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
Widget aanBuildWinterProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
          ...
          child: Container(
            ...
            child: AanProductsSectionList(
              ...
              fetchProducts: (limit, startAfter) async {
                ...
                final repository = ref.watch(
                    aanWinterProductRepositoryProvider); // aanWinterProductRepositoryProvider를 사용하여 레포지토리를 가져옴
...
// ------- AanEventPosterImgSectionList 클래스 내용 구현 시작
// 홈 화면 내 이벤트 포스터 이미지 섹션에서 데이터를 4개 단위로 표시하며 스크롤 가능한 UI 구현 관련 클래스
class AanEventPosterImgSectionList extends ConsumerStatefulWidget {
  // 생성자 선언
  AanEventPosterImgSectionList();

  @override
  _AanEventPosterImgSectionListState createState() =>
      _AanEventPosterImgSectionListState(); // 상태 객체 생성 함수 호출
}

class _AanEventPosterImgSectionListState
    extends ConsumerState<AanEventPosterImgSectionList> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final savedOffset = ref.read(aanEventPosterScrollPositionProvider);
    ...
    _scrollController.addListener(() {
      ...
      ref.read(aanEventPosterScrollPositionProvider.notifier).state =
...
Widget aanBuildEventPosterImgProductsSection(WidgetRef ref, BuildContext context) {
  // MediaQuery로 기기의 화면 크기를 동적으로 가져옴
  final Size screenSize = MediaQuery.of(context).size;
      ...
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: AanEventPosterImgSectionList(), // AanEventPosterImgSectionList 위젯 사용하여 이벤트 이미지 리스트 표시
          ),
        ),
      ),
    ],
