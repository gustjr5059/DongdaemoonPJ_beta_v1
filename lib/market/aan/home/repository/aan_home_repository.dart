...
// ------ AanHomeSmall1BannerRepository 클래스 시작
// 'AanHomeSmall1BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AanHomeSmall1BannerRepository {
  ...
  AanHomeSmall1BannerRepository(this.firestore);
...
// ------ AanHomeSmall1BannerRepository 클래스 끝

// ------ AanHomeSmall2BannerRepository 클래스 시작
// 'AanHomeSmall2BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AanHomeSmall2BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AanHomeSmall2BannerRepository(this.firestore);
...
// ------ AanHomeSmall2BannerRepository 클래스 끝

// ------ AanHomeSmall3BannerRepository 클래스 시작
// 'AanHomeSmall3BannerRepository' 클래스는 Firestore 데이터베이스에서 배너 이미지 데이터를 가져오는 기능을 제공함.
class AanHomeSmall3BannerRepository {
  // 'firestore' 변수는 FirebaseFirestore의 인스턴스를 저장함.
  // 이 인스턴스를 통해 Firestore 데이터베이스에 접근함.
  final FirebaseFirestore firestore;

  // 생성자에서는 FirebaseFirestore의 인스턴스를 받아 'firestore' 변수에 할당함.
  AanHomeSmall3BannerRepository(this.firestore);
...
// ------ AanHomeSmall3BannerRepository 클래스 끝