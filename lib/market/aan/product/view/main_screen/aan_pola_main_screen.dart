...
class _AanPolaMainScreenState extends ConsumerState<AanPolaMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aanPolaMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aanPolaMainSmall1BannerImagesProvider).value ?? [], ref),
...
// _AanCardiganMainScreenState 클래스 끝/ _AanCardiganMainScreenState 클래스 끝