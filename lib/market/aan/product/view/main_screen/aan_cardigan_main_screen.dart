...
class _AanCardiganMainScreenState extends ConsumerState<AanCardiganMainScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final small1BannerWidget = buildCommonBannerPageViewSection<AllSmallBannerImage>(
      ...
      bannerImagesProvider: aanCardiganMainSmall1BannerImagesProvider,
      onPageTap: (context, index) =>
          onSmallBannerTap(context, index, ref.watch(aanCardiganMainSmall1BannerImagesProvider).value ?? [], ref),
