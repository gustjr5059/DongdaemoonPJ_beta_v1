...
// AanSaleSubMainScreen 클래스는 ConsumerWidget 상속, Riverpod를 통한 상태 관리 지원
class AanSaleSubMainScreen extends ConsumerStatefulWidget {
  const AanSaleSubMainScreen({Key? key}) : super(key: key);

  @override
  _AanSaleSubMainScreenState createState() => _AanSaleSubMainScreenState();
}

// _AanSaleSubMainScreenState 클래스 시작
// _AanSaleSubMainScreenState 클래스는 AanSaleSubMainScreen 위젯의 상태를 관리함.
// WidgetsBindingObserver 믹스인을 통해 앱 생명주기 상태 변화를 감시함.
class _AanSaleSubMainScreenState extends ConsumerState<AanSaleSubMainScreen>
  ...
  // aanSaleSubMainScrollControllerProvider에서 ScrollController를 읽어와서 scrollController에 할당
  // ref.read(aanSaleSubMainScrollControllerProvider)는 provider를 이용해 상태를 읽는 방식.
  ...
  // aanSaleSubMainScrollControllerProvider : 여러 위젯에서 동일한 ScrollController를 공유하고,
  ...
  void _updateScrollPosition() {
    ...
    // 'ref'를 사용하여 'aanSaleSubMainScrollPositionProvider'의 notifier를 읽어옴.
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (saleSubMainScreenPointScrollController.hasClients) {
        ...
        double savedScrollPosition =
            ref.read(aanSaleSubMainScrollPositionProvider);
                        ...
                        child: Column(
                          children: [
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aanSaleSubMainLargeBannerPageProvider,
                              ...
                              content: Container(
                                ...
                                child: SizedBox(
                                  ...
                                  child: buildCommonBannerPageViewSection<
                                    ...
                                    // 상태 관리를 위한 참조 전달함
                                    currentPageProvider:
                                        aanSaleSubMainSmall1BannerPageProvider,
                                    ...
                                    bannerImagesProvider:
                                        aanSaleSubMainSmall1BannerImagesProvider,
                                    ...
                                    onPageTap: (context, index) =>
                                        ...
                                        aanOnSmallBannerTap(
                                            ...
                                            ref
                                                    .watch(
                                                        aanCardiganMainSmall1BannerImagesProvider)
                                                    .value ??
                                                [],
                                            ref // Provider의 참조를 전달함
                                            ),
                            ...
                            AanPriceAndDiscountPercentSortButtons<
                              ...
                              productListProvider:
                                  aanSaleSubMainProductListProvider,
                              // 특가 상품 제품 리스트 프로바이더 전달
                              sortButtonProvider:
                                  aanSaleSubMainSortButtonProvider, // 할인 정렬 버튼 프로바이더 전달
                            ),
                            // 가격 및 할인 정렬 버튼 추가
                            SizedBox(height: interval1Y),
