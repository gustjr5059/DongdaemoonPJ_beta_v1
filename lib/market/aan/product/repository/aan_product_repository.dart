...
class AanNewProductRepository {
  ...
  List<String> collections = [
    'Aan1B1', 'Aan2B1', 'Aan3B1', 'Aan4B1', 'Aan5B1', 'Aan6B1',
    'Aan7B1', 'Aan8B1', 'Aan9B1', 'Aan10B1', 'Aan11B1', 'Aan12B1'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanNewProductRepository(this.firestore); // 생성자
  ...
  Future<List<ProductContent>> fetchNewProductContents({int limit = 4}) async {
    ...
    while (products.length < limit &&
      ...
      Query query = firestore
          .collection('products')
          .doc('wearcano')
          .collection('product_14')
          .doc(mainCollection) // 'Aan10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
          .collection(currentCollection) // 세부 컬렉션 (예: 'Aan10B1', 'Aan2B1' 등)
...
class AanBestProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aan1B2', 'Aan2B2', 'Aan3B2', 'Aan4B2', 'Aan5B2', 'Aan6B2',
    'Aan7B2', 'Aan8B2', 'Aan9B2', 'Aan10B2', 'Aan11B2', 'Aan12B2'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanBestProductRepository(this.firestore); // 생성자
...
class AanSaleProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aan1B3', 'Aan2B3', 'Aan3B3', 'Aan4B3', 'Aan5B3', 'Aan6B3',
    'Aan7B3', 'Aan8B3', 'Aan9B3', 'Aan10B3', 'Aan11B3', 'Aan12B3'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanSaleProductRepository(this.firestore); // 생성자
...
class AanSpringProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aan1B4', 'Aan2B4', 'Aan3B4', 'Aan4B4', 'Aan5B4', 'Aan6B4',
    'Aan7B4', 'Aan8B4', 'Aan9B4', 'Aan10B4', 'Aan11B4', 'Aan12B4'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanSpringProductRepository(this.firestore); // 생성자
...
class AanSummerProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aan1B5', 'Aan2B5', 'Aan3B5', 'Aan4B5', 'Aan5B5', 'Aan6B5',
    'Aan7B5', 'Aan8B5', 'Aan9B5', 'Aan10B5', 'Aan11B5', 'Aan12B5'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanSummerProductRepository(this.firestore); // 생성자
...
class AanAutumnProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aan1B6', 'Aan2B6', 'Aan3B6', 'Aan4B6', 'Aan5B6', 'Aan6B6',
    'Aan7B6', 'Aan8B6', 'Aan9B6', 'Aan10B6', 'Aan11B6', 'Aan12B6'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanAutumnProductRepository(this.firestore); // 생성자
...
class AanWinterProductRepository {
  final FirebaseFirestore firestore; // Firestore 인스턴스
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷
  int currentCollectionIndex = 0; // 현재 컬렉션 인덱스
  List<String> collections = [
    'Aan1B7', 'Aan2B7', 'Aan3B7', 'Aan4B7', 'Aan5B7', 'Aan6B7',
    'Aan7B7', 'Aan8B7', 'Aan9B7', 'Aan10B7', 'Aan11B7', 'Aan12B7'
  ];
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanWinterProductRepository(this.firestore); // 생성자
...
// -------- 1차 카테고리 관련 데이터를 불러오는 로직인 AanMainCategoryProductsRepository 시작 부분
class AanMainCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanMainCategoryProductsRepository(this.firestore);
  ...
  Future<List<ProductContent>> fetchProductContents({
    ...
    Query query = firestore
        ...
        .collection('product_14')
        .doc(mainCollection) // 'Aan10', 'Aa2' 등 메인 컬렉션에 해당하는 문서 접근
        .collection(subCollection) // 세부 컬렉션 (예: 'Aan10B1', 'Aan2B1' 등)
...
// -------- 2차 카테고리 관련 데이터를 불러오는 로직인 AanSectionCategoryProductsRepository 시작 부분
class AanSectionCategoryProductsRepository implements CategoryProductsRepository {
  final FirebaseFirestore firestore;
  DocumentSnapshot? lastDocument; // 마지막으로 가져온 문서 스냅샷을 저장
  final Map<String, bool> noMoreDataPerCollection = {}; // 각 컬렉션별 데이터 없음 상태 저장

  AanSectionCategoryProductsRepository(this.firestore);
